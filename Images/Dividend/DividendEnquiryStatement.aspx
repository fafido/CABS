<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="DividendEnquiryStatement.aspx.vb" Inherits="Enquiries_AccountEnquiryStatement" title="Account Details Enquiry" %>
            ...
            <tr>
                <td style="width: 870px" align="center">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="Dividend Accounts  Enquiry Statement" width="848px"></asp:Label></td>
            </tr>
            <tr>
                    <td valign="top">
                        &nbsp;</td>
                ...
                <tr>
                    <td style="width: 146px">
                        <asp:Label id="Label2" runat="server" font-names="Verdana" font-size="Small" 
                            Text="Divinded Number" width="144px"></asp:Label>
                    </td>
                    <td style="width: 3px">
                        <asp:DropDownList id="cmbDividend" runat="server" width="160px">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 3px">
                        &nbsp;</td>
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 148px">
                        <asp:ListBox id="lstNames" runat="server" Height="52px" width="328px"></asp:ListBox></td>
                </tr>
                <tr>
                    <td></td>
                    <td align="right">
