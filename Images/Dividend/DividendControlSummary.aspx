<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="DividendControlSummary.aspx.vb" Inherits="Dividend_DividendControlSummary" title="Dividend EFT File Generation" %>
            ...
            <tr>
                <td style="width: 870px" align="center">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="Dividend Control Summary" width="848px"></asp:Label></td>
            </tr>
                <tr>
