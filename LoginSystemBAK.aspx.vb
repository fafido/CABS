...
Partial Class _LoginSystemBak
    ...
    Public Sub PasswordValidation()
        ...
        End Try
    End Sub
    Public Sub auditlog(ByVal participantcode As String, ByVal username As String, ByVal activity As String, ByVal affected As String, ByVal receiptid As String)
        ' Try
    ...
    Private Function getPassword(ByVal emailID As String) As Boolean
        ...
        End If
    End Function
    Public Sub insertpasswordreset(ByVal email As String)
    ...
    End Sub
    Public Function fullname(ByVal mail As String) As String
        Dim ds2 As New DataSet
        ...
        End If
    End Function
    Public Function uid(ByVal mail As String) As String
        Dim ds2 As New DataSet
    ...
    Protected Sub btnSignIn0_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSignIn0.Click
