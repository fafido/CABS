...
Partial Class Reporting_createdaccountsreport
    ...
    Protected Sub Page_Unload(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Unload
        ...
        End Try
    End Sub
    Public Sub regulatorytrans()
        Try


            Dim dateto As String = Request.QueryString("As_at")
            Dim datefrom As String = Request.QueryString("From")
            Dim top As String = Request.QueryString("Top")


            myReport = New CrystalDecisions.CrystalReports.Engine.ReportDocument()
            myReport.Load(Server.MapPath("../Reporting/RegulatoryTrans.rpt"))
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ElseIf cat = "Regulatory" Then
            regulatory()
        ElseIf cat = "RegulatoryPort" Then
            regulatoryPort()
        ElseIf cat = "RegulatoryTrans" Then
            regulatoryTrans()
    ...
    Public Sub regulatoryPORT()
        Try
            ...
            myReport = New CrystalDecisions.CrystalReports.Engine.ReportDocument()
            myReport.Load(Server.MapPath("../Reporting/RegulatoryPort.rpt"))
