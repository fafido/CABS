    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If status = "All" Then
                strSQL = strSQL & ""
            Else
                strSQL = strSQL & " and w.status='" & status & "'"
            End If
            If commodity = "All" Then
                strSQL = strSQL & ""
            Else
                strSQL = strSQL & " and w.Commodity='" & commodity & "'"
            End If
            If ewr = "All" Then
                strSQL = strSQL & ""
            Else
                strSQL = strSQL & " and w.ReceiptNo='" & ewr & "'"
            End If
            If Participantcode = "All" Then
                strSQL = strSQL & ""
            Else
                strSQL = strSQL & " and w.Warehouse ='" & Participantcode & "'"
            End If

            myReport.Load(Server.MapPath("..\Reporting\rptewr.rpt"))
