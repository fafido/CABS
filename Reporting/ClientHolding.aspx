        ...
        <table width="810px">
            <tr>
                ...
                <td colspan ="1">
                    &nbsp;</td>
                <td colspan ="1">
                    <dx:ASPxButton ID="btnSearch" CausesValidation="False" runat="server" Text="&gt;&gt;" Theme="BlackGlass" Width="80px">
                    </dx:ASPxButton>
                </td>
                <td colspan ="1"></td>
            ...
            <tr>
                ...
                <td colspan ="1">
                    ...
                    &nbsp;<dx:ASPxButton ID="btnPrint0" runat="server" Text="Clear" CausesValidation="False"  Theme="BlackGlass" Width="150px">
                    </dx:ASPxButton>
                </td>
            </tr>
