...
Partial Class Reporting_ClientMoneyReport_ADMIN
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Request.QueryString("Summarized") = "1" Then
                myReport.Load(Server.MapPath("..\Reporting\ClientMoneyReport_adminSUMM.rpt"))

            Else
                myReport.Load(Server.MapPath("..\Reporting\ClientMoneyReport_admin.rpt"))
