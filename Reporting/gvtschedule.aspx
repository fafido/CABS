<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="gvtschedule.aspx.vb" Inherits="Reporting_gvtschedule" title="Schedule" %>
        ...
        <td style="width: 712px; height: 226px" valign="top">
            ...
            <tr>
                <td style="width: 870px" align="center">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="Company Schedule Report" width="848px"></asp:Label></td>
            </tr>
                <tr>
            ...
            <table>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <asp:CheckBox ID="CheckBox1" runat="server" text="Show Monetary Value" />
                    </td>
                </tr>
                <tr>
                    <td>
