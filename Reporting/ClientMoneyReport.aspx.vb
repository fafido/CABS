...
Partial Class Reporting_ClientMoneyReport
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If cdsno = "ALL" Then
                myReport.Load(Server.MapPath("..\Reporting\ClientMoneyReportcons.rpt"))
            ...
            Else
                ...
                myReport.Load(Server.MapPath("..\Reporting\ClientMoneyReport.rpt"))
