    ...
    <tr>
        <td style="width: 712px; height: 226px" valign="top">
            <table>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label1" runat="server" font-names="Verdana" font-size="Small" Text="Series/Fund" width="144px"></asp:Label>
                    </td>
                    <td>
                        <asp:DropDownList ID="cmbCompany" runat="server" autopostback="True" width="192px">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
