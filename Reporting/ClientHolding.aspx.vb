...
Partial Class Reporting_ClientHolding
    ...
    Protected Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        ...
        If lstSearchAcc.SelectedIndex = -1 Then
            strscript += "window.open('" + rep + ".aspx?Datefrom=" & txtDateFrom.Text & "&Dateto=" & txtDateTo.Text & "&AssetManager=" + cmbassetmanager.SelectedItem.Value.ToString + "&Name=ALL&Add=ALL');"
        Else
