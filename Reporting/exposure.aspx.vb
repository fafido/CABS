Partial Class Reporting_exposure
    ...
    Protected Sub btnSelect_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSelect.Click
        Try
            ...
            If (cmbCompany.Text <> "" And ClassType <> "" And txtTargetDate.Text <> "" And txtTop.Text <> "") Then
                ...
                strscript += "window.open('exposurereport.aspx?Classfication=" & ClassType & "&company=" & cmbCompany.SelectedItem.Text & "&RepDate=" & txtTargetDate.Text & "&Top=" & txtTop.Text & "&zero=" + moneyt + "');"
                strscript += "</script>"
