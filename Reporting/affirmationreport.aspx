<%@ Page Title="" Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="affirmationreport.aspx.vb" Inherits="Reporting_affirmationreport" %>
        ...
        <table width ="810px">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Reporting&gt;&gt;Affirmation" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
        ...
        <table width="810px">
            <tr>
                <td colspan ="1" style="width: 109px; height: 26px">
                    <dx:ASPxLabel ID="ASPxLabel13" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Type" Theme="Glass">
                    </dx:ASPxLabel>
                </td>
                <td colspan ="1" width="301" style="height: 26px">
                    <asp:DropDownList ID="DropDownList1" runat="server" Height="21px" Width="169px">
                        ...
                        <asp:ListItem Value="BUY">BUYS</asp:ListItem>
                        <asp:ListItem Value="SELL">SELLS</asp:ListItem>
            ...
            <tr>
                ...
                <td colspan="1" style="height: 26px" width="301">
                    <asp:RadioButtonList ID="RadioButtonList1" runat="server" Height="27px" RepeatDirection="Horizontal" Width="471px">
                        <asp:ListItem Value="Pending">Pending Affirmation</asp:ListItem>
                        <asp:ListItem Value="Rejected">Rejected Affirmation</asp:ListItem>
                        <asp:ListItem>Affirmed</asp:ListItem>
                    </asp:RadioButtonList>
                </td>
                <td colspan="1" style="height: 26px">&nbsp;</td>
                <td colspan="1" style="height: 26px">&nbsp;</td>
