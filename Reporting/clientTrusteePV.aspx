<%@ Page Title="" Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="clientTrusteePV.aspx.vb" Inherits="Reporting_ClientPV" %>
            ...
            <tr>
             ...
             <tr>
                <td colspan ="1" align="right">
                    &nbsp;</td>
                <td colspan ="1" width="301">
                    <dx:ASPxListBox ID="lstSearchAcc" runat="server" AutoPostBack="False" Theme="Glass" ValueType="System.String" Width="400px">
                 <ValidationSettings>
