...
Partial Class Reporting_ClientBillReport
        ...
        Try
            ...
            Else
                If Request.QueryString("Group") = "1" Then
                    myReport.Load(Server.MapPath("..\Reporting\ClientBillReportGroup.rpt"))
                Else
                    myReport.Load(Server.MapPath("..\Reporting\ClientBillReport.rpt"))
                End If
