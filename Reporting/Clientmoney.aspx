<%@ Page Title="" Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="Clientmoney.aspx.vb" Inherits="Reporting_Clientmoney" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel id="Panel1" runat="server" Width="840px" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width ="810px">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Reporting&gt;&gt;Client Money Statement" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
        ...
        <table width="810px">
            ...
            <tr>
                <td colspan="1">
                    <dx:ASPxLabel ID="ASPxLabel15" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Bank Account" Theme="Glass">
                    </dx:ASPxLabel>
                </td>
                <td colspan="2">
                    <dx:ASPxComboBox ID="cmbbank" runat="server" DropDownStyle="DropDown" DropDownWidth="550" IncrementalFilteringMode="StartsWith" Theme="BlackGlass">
                        <ValidationSettings>
                            <RequiredField IsRequired="True" />
                        </ValidationSettings>
                    </dx:ASPxComboBox>
            ...
            <tr>
                <td colspan="1">&nbsp;</td>
                <td width="301">
                    <asp:CheckBox ID="CheckBox1" runat="server" Text="View Reconciled Entries" Visible="False" />
                </td>
                <td colspan="1">&nbsp;</td>
                <td colspan="1">&nbsp;</td>
                <td colspan="1">&nbsp;</td>
