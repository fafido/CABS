<%@ Page Title="" Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="systemusers.aspx.vb" Inherits="Reporting_systemusers" %>
        ...
        <table width ="810px">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Reporting&gt;&gt;Users Report" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
            ...
            <tr>
                ...
                <td colspan ="1" width="301" style="height: 26px">
                    <asp:DropDownList ID="DropDownList1" runat="server" Height="21px" Width="169px">
                        ...
                        <asp:ListItem Value="CDS">Administrators</asp:ListItem>
                    </asp:DropDownList>
                </td>
