...
Partial Class Reporting_rptwarehouse
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            Dim tt As String = Request.QueryString("type")
            ...
            myReport.Load(Server.MapPath("..\Reporting\rptwarehouse.rpt"))
            ...
            myParameterField.ParameterFieldName = "tt"
            myDiscreteValue.Value = tt
