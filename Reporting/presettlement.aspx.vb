            ...
            Try
                ...
                Dim dateto As String = ddateTo.SelectedValue.ToString()
                    ...
                    If CheckBox1.Checked = True Then
                        myreport.Load(Server.MapPath("../Reporting/presettlement.rpt"))
                    Else
                        myreport.Load(Server.MapPath("../Reporting/presettlementnotgrouped.rpt"))
                    End If
                    If CheckBox2.Checked = True Then
                        myreport.Load(Server.MapPath("../Reporting/presettlementfailed.rpt"))
                    End If
        ...
        Else
            Try
                ...
                Dim dateto As String = ddateTo.SelectedValue.ToString()
                    ...
                    myreport = New CrystalDecisions.CrystalReports.Engine.ReportDocument()
                    If CheckBox1.Checked = True Then
                        myreport.Load(Server.MapPath("../Reporting/presettlementsells.rpt"))
                    Else
                        myreport.Load(Server.MapPath("../Reporting/presettlementsellsnotgrouped.rpt"))
                    End If
                    If CheckBox2.Checked = True Then
                        myreport.Load(Server.MapPath("../Reporting/presettlementsellsfailed.rpt"))
                    End If
