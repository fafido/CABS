Partial Class Reporting_gvtschedule
    ...
    Protected Sub btnSelect_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSelect.Click
        Try
            ...
            If (rdAll.Checked = True) Then
                ClassType = "5"
            End If
            If (cmbCompany.Text <> "" And ClassType <> "" And txtTargetDate.Text <> "" And txtTop.Text <> "") Then
                Dim moneyt As String
                ...
                strscript += "window.open('gvtschedulereport.aspx?Classfication=" & ClassType & "&company=" & cmbCompany.SelectedItem.Text & "&RepDate=" & txtTargetDate.Text & "&Top=" & txtTop.Text & "&moneyt=" + moneyt + "');"
                strscript += "</script>"
