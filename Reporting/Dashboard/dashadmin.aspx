<%@ Page Language="VB" AutoEventWireup="false" CodeFile="dashadmin.aspx.vb" Inherits="Reporting_Dashboard_dashadmin" %>
...
<head runat="server">
    ...
    <meta http-equiv="refresh" content="10;url=dashadmin.aspx"/>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-lg-3">
                                    <div class="panel text-center">
                                        ...
                                        <div class="panel-body p-t-10">
                                            ...
                                            <p class="text-muted m-b-0 m-t-20"><b></b>Cumulative Registrations</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="panel text-center">
                                        ...
                                        <div class="panel-body p-t-10">
                                            ...
                                            <p class="text-muted m-b-0 m-t-20"><b></b> Cumulative Funds</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="panel text-center">
                                        <div class="panel-heading">
                                            <h4 class="panel-title text-muted font-light">Registrations Today</h4>
                                        </div>
                                        <div class="panel-body p-t-10">
                                            <h2 class="m-t-0 m-b-15"><i class="mdi mdi-arrow-up text-success m-r-10"></i><b runat="server" id="lbltotal_holdings"></b></h2>
                                            <p class="text-muted m-b-0 m-t-20"><b></b>Total Registrations today</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-lg-3">
                                    <div class="panel text-center">
                                        <div class="panel-heading">
                                            <h4 class="panel-title text-muted font-light">Incoming Sells Today</h4>
                                        </div>
                                        <div class="panel-body p-t-10">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="panel text-center">
                                        <div class="panel-heading">
                                            <h4 class="panel-title text-muted font-light">Incoming Buys Today</h4>
                                        </div>
                                        <div class="panel-body p-t-10">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="panel text-center">
                                        <div class="panel-heading">
                                            <h4 class="panel-title text-muted font-light">Matched Cumulative</h4>
                                        </div>
                                        <div class="panel-body p-t-10">
                                            <h2 class="m-t-0 m-b-15"><i class="mdi mdi-arrow-up text-success m-r-10"></i><b runat="server" id="lblpendingsettlement"></b></h2>
                                            <!--<p class="text-muted m-b-0 m-t-20"><b>10%</b>Cumulative Value of Matched Trades</p>-->
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="panel text-center">
                                        <div class="panel-heading">
                                            <h4 class="panel-title text-muted font-light">Matched Today</h4>
                                        </div>
                                        <div class="panel-body p-t-10">
                        ...
                        <!--end-->
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="panel panel-primary">
                                        <div class="panel-body">
                                            <h4 class="m-t-0">Cumulative Orders</h4>

                                            <ul class="list-inline widget-chart m-t-20 text-center">
                                                <li>
                                                    <h4 class=""><b runat="server" id="lblbuysall">10</b></h4>
                                                    <p class="text-muted m-b-0">Cumulative Buy Orders</p>
                                                </li>
                                                <li>
                                                    <h4 class=""><b></b></h4>
                                                ...
                                                <li>
                                                    <h4 class=""><b runat="server" id="lblsellsall">10</b></h4>
                                                    <p class="text-muted m-b-0">Cumulative Sell Orders</p>
                                                </li>
                                            </ul>
