<%@ Page Language="VB" AutoEventWireup="false" CodeFile="dashbroker.aspx.vb" Inherits="Reporting_Dashboard_dashbroker" %>
...
<head runat="server">
    ...
    <meta http-equiv="refresh" content="10;url=dashbroker.aspx"/>
                    ...
                    <div class="container">
                        <div class="">
                            <div class="pull-left">
                              ...
                              <img src="ctrad.png" style="width:15%"/>
<%--                            <form class="navbar-form pull-left" role="search">
            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="" style="padding-top:10px;">
                        <div class="page-header-title">
                            <h4 class="page-title">Broker Dashboard</h4>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="panel text-center">
                                        <div class="panel-heading">
                                            <h4 class="panel-title text-muted font-light">Nominee Aggregate</h4>
                                        </div>
                                        <div class="panel-body p-t-10">
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="panel-body">
                                            ...
                                            <ul class="list-inline widget-chart m-t-20 text-center">
                                                <li>
                                                    <h4 class=""><b>0</b></h4>
                                                    <p class="text-muted m-b-0">Telecel</p>
                                                </li>
                                                <li>
                                                    <h4 class=""><b>0</b></h4>
                                                    <p class="text-muted m-b-0">Econet</p>
                                                </li>
                                                <li>
                                                    <h4 class=""><b>0</b></h4>
                                                    <p class="text-muted m-b-0">CBZ Touch</p>
                                                </li>
                                            </ul>
                                    ...
                                    <div class="panel panel-primary">
                                        <div class="panel-body">
                                            ...
                                            <ul class="list-inline widget-chart m-t-20 text-center">
                                                ...
                                                <li>
                                                    <h4 class=""><b>$0</b></h4>
                                                    <p class="text-muted m-b-0">CBZ</p>
                                                </li>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <ul class="list-inline widget-chart m-t-20 text-center">
                                                <li>
                                                    ...
                                                    <p class="text-muted m-b-0">FINSEC</p>
                                                </li>
                                                <li>
                                                    <h4 class=""><b></b></h4>
                                                ...
                                                <li>
                                                    <h4 class=""><b>0</b></h4>
                                                    <p class="text-muted m-b-0">ZSE</p>
                                                </li>
                                            </ul>
                                ...
                                <div class="col-md-5">
                                    <div class="panel">
                                        <div class="panel-body">
                                            ...
                                            <p class="font-600 m-b-5">Local Registrations <span class="text-primary pull-right"><b>80%</b></span></p>
                                            <div class="progress  m-b-20">
                                                <div class="progress-bar progress-bar-primary " role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%;">
                                                </div><!-- /.progress-bar .progress-bar-danger -->
                                            </div><!-- /.progress .no-rounded -->

                                            <p class="font-600 m-b-5">Failed Registrations <span class="text-primary pull-right"><b>50%</b></span></p>
                                            <div class="progress  m-b-20">
                                                <div class="progress-bar progress-bar-primary " role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 50%;">
                                                </div><!-- /.progress-bar .progress-bar-pink -->
                                            </div><!-- /.progress .no-rounded -->

                                            <p class="font-600 m-b-5">Accounts with Holdings<span class="text-primary pull-right"><b>70%</b></span></p>
                                            <div class="progress  m-b-20">
                                            ...
                                            <p class="font-600 m-b-5">Telecel Registrations <span class="text-primary pull-right"><b>65%</b></span></p>
                                            <div class="progress  m-b-20">
                                            ...
                                            <p class="font-600 m-b-5">Econet Registrations <span class="text-primary pull-right"><b>25%</b></span></p>
                                            <div class="progress  m-b-20">
                                            ...
                                            <p class="font-600 m-b-5">CBZ Touch Registrations<span class="text-primary pull-right"><b>40%</b></span></p>
                                            <div class="progress  m-b-0">
                                                <div id="prog1" runat="server" class="progress-bar progress-bar-primary " role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%;">
                ...
                <footer class="footer">
                     ©2017 Escrow Systems - All Rights Reserved.
                </footer>
