...
Partial Class Reporting_BrokerAuditReport2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.QueryString("type") = "settlement" Then
            myReport.Load(Server.MapPath("..\Reporting\BrokerAudit2.rpt"))
        ElseIf Request.QueryString("type") = "useraudit" Then

            myReport.Load(Server.MapPath("..\Reporting\audit.rpt"))
        ElseIf Request.QueryString("type") = "pledges" Then
            myReport.Load(Server.MapPath("..\Reporting\pledges.rpt"))
        ElseIf Request.QueryString("type") = "settlementnew" Then
            myReport.Load(Server.MapPath("..\Reporting\settlementnew.rpt"))
        ElseIf Request.QueryString("type") = "settlementbroker" Then
            myReport.Load(Server.MapPath("..\Reporting\settlementCDA.rpt"))
        ElseIf Request.QueryString("type") = "settlementDelivery" Then
            myReport.Load(Server.MapPath("..\Reporting\settlementDelivery.rpt"))
        ElseIf Request.QueryString("type") = "settlementCDAsumm" Then
            myReport.Load(Server.MapPath("..\Reporting\settlementCDAsumm.rpt"))
        ElseIf Request.QueryString("type") = "settlementgroupedcda" Then
            myReport.Load(Server.MapPath("..\Reporting\settlementgroupedcda.rpt"))
        Else
            myReport.Load(Server.MapPath("..\Reporting\tradesumm.rpt"))
        End If
