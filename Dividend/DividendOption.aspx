<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="DividendOption.aspx.vb" Inherits="Corp_DivOption" title="Dividend Option" %>
    ...
    <asp:Panel id="Panel1" runat="server" Width="90%" Font-Names="Cambria" BackColor="White" GroupingText="Dividend Option">
       <table>
           ...
           <tr id="Tr2" runat="server">
                    <td colspan="6">
                    <dx:ASPxGridView ID="grdPaymentsOption" Width="100%" runat="server" KeyFieldName="SEQ" Settings-ShowTitlePanel="true" Theme="Glass" Visible="false">                            <SettingsBehavior AllowSelectByRowClick="True" AllowSelectSingleRowOnly="True" ProcessSelectionChangedOnServer="True" />                            <SettingsPager PageSizeItemSettings-ShowAllItem="true" Visible="True">                            </SettingsPager>                            <SettingsPopup>                                <EditForm AllowResize="True" Modal="True" />                            </SettingsPopup>                            <SettingsCommandButton>                                <SelectButton Text="Select">                                </SelectButton>                            </SettingsCommandButton>                            <%--<Settings ShowFilterRow="true" ShowFilterBar="Auto" />--%>                            <Columns>                                  <dx:GridViewDataColumn Caption="Select" FieldName="Selec"  VisibleIndex="0">                                    <DataItemTemplate>                                        <dx:aspxcheckbox ID="chk1" runat="server" >                                                              </dx:aspxcheckbox>                                    </DataItemTemplate>                                </dx:GridViewDataColumn>                                <dx:GridViewDataColumn FieldName="shareholderc" Caption="Holder No.">                                    <DataItemTemplate>                                        <dx:ASPxLabel ID="lblshareholder" runat="server" Text='<%# Eval("shareholder") %>'>                                        </dx:ASPxLabel>                                    </DataItemTemplate>                                </dx:GridViewDataColumn>                                <dx:GridViewDataColumn Caption="Names">                                    <DataItemTemplate>                                        <dx:ASPxLabel runat="server" Text='<%# Eval("Holder") %>'>                                        </dx:ASPxLabel>                                    </DataItemTemplate>                                </dx:GridViewDataColumn>                                <dx:GridViewDataColumn FieldName="AssetManagerc" Caption="Asset Manager">                                    <DataItemTemplate>                                        <dx:ASPxLabel ID="lblAssetManager" runat="server" Text='<%# Eval("AssetManager") %>'>                                        </dx:ASPxLabel>                                    </DataItemTemplate>                                </dx:GridViewDataColumn>                                <dx:GridViewDataColumn Caption="Shares_held">                                    <DataItemTemplate>                                        <dx:ASPxLabel runat="server" Text='<%# Eval("Shares_held") %>'>                                        </dx:ASPxLabel>                                    </DataItemTemplate>                                </dx:GridViewDataColumn>                                <dx:GridViewDataColumn Caption="Gross">                                    <DataItemTemplate>                                        <dx:ASPxLabel runat="server" Text='<%# Eval("actual_gross") %>'>                                        </dx:ASPxLabel>                                    </DataItemTemplate>                                </dx:GridViewDataColumn>                                <dx:GridViewDataColumn Caption="Tax">                                    <DataItemTemplate>                                        <dx:ASPxLabel runat="server" Text='<%# Eval("actual_tax") %>'>                                        </dx:ASPxLabel>                                    </DataItemTemplate>                                </dx:GridViewDataColumn>                                <dx:GridViewDataColumn FieldName="offerSharesc" Caption="Offered Shares">                                    <DataItemTemplate>                                        <dx:ASPxLabel ID="lblofferShares" runat="server" Text='<%# Eval("offer_shares") %>'>                                        </dx:ASPxLabel>                                    </DataItemTemplate>                                </dx:GridViewDataColumn>                                <dx:GridViewDataColumn FieldName="offerCashc" Caption="Offered Net Amount">                                    <DataItemTemplate>                                        <dx:ASPxLabel ID="lblofferCash" runat="server" Text='<%# Eval("actual_nett") %>'>                                        </dx:ASPxLabel>                                    </DataItemTemplate>                                </dx:GridViewDataColumn>                                <dx:GridViewDataColumn FieldName="AcceptedCashc" Caption="Accepted Cash">                                    <DataItemTemplate>                                        <dx:ASPxTextBox ID="txtAcceptedCash" Width="100px" Text='<%# Eval("offer_cash") %>' runat="server" BackColor="White" Theme="Glass">
                                            </dx:ASPxTextBox>                                    </DataItemTemplate>                                </dx:GridViewDataColumn>                                <dx:GridViewDataColumn FieldName="AcceptedSharesc" Caption="Accepted Shares">                                    <DataItemTemplate>                                        <dx:ASPxTextBox ID="txtAcceptedShares" Width="100px" Text='<%# Eval("Actual_shares") %>' runat="server" BackColor="White" Theme="Glass">
                                            </dx:ASPxTextBox>                                    </DataItemTemplate>                                </dx:GridViewDataColumn>                            </Columns>                        </dx:ASPxGridView>
                    </td>
                  </tr>
