<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="dividendPaymentAuth.aspx.vb" Inherits="Corp_divPayment" title="Dividend Payment" %>
       ...
       <table>
           ...
           <tr id="Tr11a" runat="server">
                <td colspan="6">
                    ...
                    <dx:ASPxGridView ID="grdPaymentsOption" Width="100%" runat="server" KeyFieldName="ID" Settings-ShowTitlePanel="true" Theme="Glass" Visible="false">
                            <SettingsBehavior AllowSelectByRowClick="True" AllowSelectSingleRowOnly="True" ProcessSelectionChangedOnServer="True" />
                            <SettingsPager PageSizeItemSettings-ShowAllItem="true" Visible="True">
                            </SettingsPager>
                            <SettingsPopup>
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataColumn Caption="Offered Net Amount">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel runat="server" Text='<%# Eval("actual_nett") %>'>
                                        </dx:ASPxLabel>
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
                                <dx:GridViewDataColumn Caption="Accepted Amount">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel runat="server" Text='<%# Eval("offer_cash") %>'>
                                        </dx:ASPxLabel>
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
                                <dx:GridViewDataColumn Caption="Offered Shares">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel runat="server" Text='<%# Eval("offer_shares") %>'>
                                        </dx:ASPxLabel>
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
                                <dx:GridViewDataColumn FieldName="ScripSharesc" Caption="Accepted Scrip Shares">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel ID="lblScripShares" runat="server" Text='<%# Eval("Actual_shares") %>'>
                                        </dx:ASPxLabel>
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
                                <dx:GridViewDataColumn FieldName="Amountc" Caption="Amount">
                                ...
                                <dx:GridViewDataColumn FieldName="Sharesc" Caption="Shares">
                                    <DataItemTemplate>
                    ...
                    <dx:ASPxGridView ID="grdPaymentsScrip" Width="100%" runat="server" KeyFieldName="ID" Settings-ShowTitlePanel="true" Theme="Glass" Visible="false">
                            <SettingsBehavior AllowSelectByRowClick="True" AllowSelectSingleRowOnly="True" ProcessSelectionChangedOnServer="True" />
                            <SettingsPager PageSizeItemSettings-ShowAllItem="true" Visible="True">
                            </SettingsPager>
                            <SettingsPopup>
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataColumn Caption="Total Scrip Shares">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel runat="server" Text='<%# Eval("offer_shares") %>'>
                                        </dx:ASPxLabel>
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
                                <dx:GridViewDataColumn FieldName="Sharesc" Caption="Post Shares">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel ID="lblShares" runat="server" Text='<%# Eval("PaidShares") %>'>
                                        </dx:ASPxLabel>
                                    </DataItemTemplate>
                    ...
                    <dx:ASPxGridView ID="grdPaymentsSpecie" Width="100%" runat="server" KeyFieldName="ID" Settings-ShowTitlePanel="true" Theme="Glass" Visible="false">
                            <SettingsBehavior AllowSelectByRowClick="True" AllowSelectSingleRowOnly="True" ProcessSelectionChangedOnServer="True" />
                            <SettingsPager PageSizeItemSettings-ShowAllItem="true" Visible="True">
                            </SettingsPager>
                            <SettingsPopup>
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataColumn Caption="Total Specie Shares">
                                    <DataItemTemplate>
