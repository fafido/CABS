<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="dividendReports.aspx.vb" Inherits="Corp_divReports" title="Dividend Reports" %>

<%@ Register Assembly="DevExpress.Web.v13.2, Version=13.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxEditors" TagPrefix="dx" %>

<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel id="Panel1" runat="server" Width="90%" Font-Names="Cambria" BackColor="White" GroupingText="Dividend Reports">
       <table>
           ...
           <tr id="PanelSAVE2" runat="server" visible="false">
                        ...
                        <td style="width:212px">
                           <asp:HyperLink ID="HyperLink2" runat="server"
                                            NavigateUrl="#" Target="_blank">Dividend Schedule</asp:HyperLink>
                        </td>
                </tr>
        </table> 
      </asp:Panel>
