<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="clients.aspx.vb" Inherits="clients" title="Clients" %>
    ...
    <tr>
        <td style="width: 712px; height: 226px" valign="top">
            ...
            <tr>
             ...
             <asp:Panel runat="server" ID="panel4" GroupingText="Reporting&gt;&gt;Clients">
                 <asp:Panel runat="server" GroupingText="Clients">
<table>
            <tr>
                <td colspan ="8">
                        ...
                        <tr>
                            <td>
                                <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" RepeatDirection="Horizontal">
                                    ...
                                    <asp:ListItem>RECEIPT HOLDERS</asp:ListItem>
                                    <asp:ListItem>DEPOSITORS</asp:ListItem>
