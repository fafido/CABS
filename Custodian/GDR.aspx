<%@ Page Language="VB"  MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="GDR.aspx.vb" Inherits="CDSMode_GDR" title="GDR" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <asp:panel runat="server" scrollbars="Auto" font-names="Cambria" font-size="Medium" groupingtext="Parameters&gt;&gt;Global Depository Receipts" backcolor="White">
        <asp:Panel runat="server" ID="panel2" Font-Names="Cambria" GroupingText="Globa Depository Receipts">
            ...
            <table>
                ...
                <tr>
                        <td align="center" colspan ="6">
                            <dx:ASPxButton ID="btnSaveCompany" runat="server" Text="Save GDR">
                            </dx:ASPxButton>
                        </td>
