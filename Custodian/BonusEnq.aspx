<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="BonusEnq.aspx.vb" Inherits="Custodian_BonusEnq" title="Bonus Enquiry" %>
                ...
                <tr>
                    <td style="width: 146px">
                        <asp:Label id="Label6" runat="server" font-names="Verdana" font-size="Small" 
                            Text="Bonus Issue Number"></asp:Label>
                    </td>
