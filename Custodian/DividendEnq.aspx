<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="DividendEnq.aspx.vb" Inherits="Custodian_DividendEnq" title="Dividend Enquiry" %>
            ...
            <tr>
                    <td colspan ="4" valign="top">
                        <asp:RadioButton id="RadioButton1" runat="server" autopostback="True" 
                            ...
                            Text="Dividend Instructions" />
                        <asp:RadioButton id="RadioButton2" runat="server" autopostback="True" 
                            font-names="Arial" font-size="Small" GroupName="ShareholdersSched" 
                            Text="Dividend Schedule" />
                        <asp:RadioButton id="RadioButton3" runat="server" autopostback="True" 
                            font-names="Arial" font-size="Small" GroupName="ShareholdersSched" 
                            Text="Shareholder Dividend Statement" />
                    </td>
                </tr>
                ...
                <tr>
                    <td style="width: 146px">
                        <asp:Label id="Label6" runat="server" font-names="Verdana" font-size="Small" 
                            Text="Dividend Number"></asp:Label>
                    </td>
