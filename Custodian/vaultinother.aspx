<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="Vaultinother.aspx.vb" Inherits="TransferSec_vaultinother" title="Vault-In Other" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel id="Panel1" runat="server" Width="100%" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width ="100%">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Certificate Management&gt;&gt;Vault-In Other" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
            ...
            <table width="100%">
                ...
                <tr>
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxLabel ID="ASPxLabel27" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Item" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxComboBox ID="cmbparaCompany" runat="server" AutoPostBack="true"  Theme="Glass" Width="250px">
                ...
                <tr>
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxLabel ID="ASPxLabel66" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Unit of Measure" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxComboBox ID="cmbunitofmeasure" runat="server" AutoPostBack="true" CallbackPageSize="1000" DropDownStyle="DropDownList" DropDownWidth="550" EnableCallbackMode="true" IncrementalFilteringMode="StartsWith" TextFormatString="{0}" Theme="Glass" ValueField="ReceiptNo" ValueType="System.String" Width="250px">
                            <Columns>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxLabel ID="ASPxLabel67" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Description/Notes" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtnotes" runat="server" Height="19px" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                    <td colspan="1" style="height: 26px">&nbsp;</td>
                    <td colspan="1" style="height: 26px">&nbsp;</td>
                ...
                <tr>
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxLabel ID="ASPxLabel36" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Current Unit Price" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1" style="height: 26px">
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxLabel ID="ASPxLabel65" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Serial No./Reference" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtserialno" runat="server" Height="19px" ReadOnly="False" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                    <td colspan="1" style="height: 26px">&nbsp;</td>
                    <td colspan="1" style="height: 26px">&nbsp;</td>
                ...
                <tr>
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxLabel ID="ASPxLabel62" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Vault-In Charges" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1" style="height: 26px">
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtdocumentname" runat="server" Height="19px" ReadOnly="True" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px" Text="Item Document">
                        </dx:ASPxTextBox>
                    </td>
                    <td colspan="1" style="height: 26px">
        ...
        <asp:Panel ID="Panel9" runat="server" Enabled="true" Font-Names="Cambria" Font-Size="Medium" GroupingText="All Pending Certificates">
            <table width="100%">
                <tr>
                    <td align="center">
                        <dx:ASPxGridView ID="ASPxGridView3" runat="server" KeyFieldName="id" Settings-ShowTitlePanel="true"  Theme="Glass" Width="100%">
                            ...
                            <Columns>
                                  ...
                                  <dx:GridViewDataColumn Caption="Account No.">
                                      ...
                                      <dx:GridViewDataColumn Caption="Serial No.">
                                                         <DataItemTemplate>
                                 ...
                                 <dx:GridViewDataColumn Caption="Product">
                                                         <DataItemTemplate>
                                ...
                                <dx:GridViewDataColumn Caption="Price">
                                  ...
                                  <dx:GridViewDataColumn Caption="Value">
                                     ...
                                     <dx:GridViewDataColumn Caption="Charge">
                                                         <DataItemTemplate>
                                                              <dx:ASPxLabel Text='<%# Eval("Charge") %>' runat="server"></dx:ASPxLabel>
                                                         </DataItemTemplate>
                                                    </dx:GridViewDataColumn>
        ...
        <asp:Panel ID="Panel10" runat="server" Enabled="true" Font-Names="Cambria" Font-Size="Medium" GroupingText="Rejected Certificates">
            <table width="100%">
                <tr>
                    <td align="center">
                        <dx:ASPxGridView ID="ASPxGridView4" runat="server" KeyFieldName="id" Settings-ShowTitlePanel="true" Theme="Glass" Width="100%">
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataColumn Caption="Date Submitted">
                                    <DataItemTemplate>
                                ...
                                <dx:GridViewDataColumn Caption="Rejected By">
                                    <DataItemTemplate>
