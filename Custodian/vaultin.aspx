<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="Vaultin.aspx.vb" Inherits="TransferSec_vaultin" title="Vault-In" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel id="Panel1" runat="server" Width="100%" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width ="100%">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Certificate Management&gt;&gt;Vault-In" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
        ...
        <asp:Panel ID="Panel3" runat="server" Font-Names="Cambria" Font-Size="Medium" GroupingText="Search Client">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <dx:ASPxTextBox ID="txtewrholder" runat="server" ValidationSettings-RequiredField-IsRequired="true"  Height="19px" ReadOnly="True" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                    <td colspan="1">
                    ...
                    <td colspan="1">
                        <dx:ASPxTextBox ID="txtewraccountno" runat="server" ValidationSettings-RequiredField-IsRequired="true" Height="19px" ReadOnly="True" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                    <td colspan="1">&nbsp;</td>
                    <td colspan="1">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxComboBox ID="cmbparaCompany" runat="server" IncrementalFilteringMode="StartsWith" ValidationSettings-RequiredField-IsRequired="true" AutoPostBack="True" 
        Width="250px" Theme="Glass">
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtavailableshares" DisplayFormatString="n" ValidationSettings-RequiredField-IsRequired="true" runat="server" Height="19px" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                ...
                <tr>
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxLabel ID="lblunitprice" runat="server" Font-Names="Cambria" ValidationSettings-RequiredField-IsRequired="true" Font-Size="Small" Text="Current Unit Price" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtprice" runat="server" Height="19px" ReadOnly="False" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                    <td colspan="1" style="height: 26px">
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtcertno" runat="server" Height="19px" ValidationSettings-RequiredField-IsRequired="true" ReadOnly="False" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                    <td colspan="1" style="height: 26px">&nbsp;</td>
                    <td colspan="1" style="height: 26px">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxDateEdit ID="dtissue" Width="250px" ValidationSettings-RequiredField-IsRequired="true" runat="server">
                                            </dx:ASPxDateEdit>
                    </td>
                    <td colspan="1" style="height: 26px">
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxDateEdit ID="dtmaturity" runat="server" Width="250px">
                        </dx:ASPxDateEdit>
                    </td>
                    <td colspan="1" style="height: 26px">&nbsp;</td>
                    <td colspan="1" style="height: 26px">&nbsp;</td>
                ...
                <tr>
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxLabel ID="lblissuedate0" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Counterpart Bank" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxComboBox ID="cmbcounterpart" ValidationSettings-RequiredField-IsRequired="true" runat="server" AutoPostBack="True" Theme="Glass" Width="250px">
                        </dx:ASPxComboBox>
                    </td>
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxLabel ID="lblissuedate1" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Counterpart Account" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1" style="height: 26px">
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtdocumentname" runat="server" Height="19px" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px" Text="Certificate">
                        </dx:ASPxTextBox>
                    </td>
                    <td colspan="1" style="height: 26px">
                ...
                <tr>
                    <td align="center" colspan="7">
                        ...
                        &nbsp;<dx:ASPxButton ID="ASPxButton15" runat="server" style="height: 23px" Text="Cancel Transaction" Theme="BlackGlass" Visible="False">
                        </dx:ASPxButton>
                        &nbsp;<dx:ASPxButton ID="ASPxButton16" runat="server" style="height: 23px" CausesValidation="False" Text="Refresh" Theme="BlackGlass">
                        </dx:ASPxButton>
                    </td>
                </tr>
            </table>
        ...
        <asp:Panel ID="Panel9" runat="server" Enabled="true" Font-Names="Cambria" Font-Size="Medium" GroupingText="All  Vault-Ins">
            <table width="100%">
                <tr>
                    <td align="center">
        ...
        <asp:Panel ID="Panel10" runat="server" Enabled="true" Font-Names="Cambria" Font-Size="Medium" GroupingText="Rejected Vault-Ins">
            <table width="100%">
                <tr>
                    <td align="center">
