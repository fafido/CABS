<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="expiry.aspx.vb" Inherits="Expiry" title="Expiry" %>
...
<table style="width:100%">
    ...
    <tr>
        <td >
             ...
             <dx:ASPxLabel ID="ASPxLabel1" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Reporting&gt;&gt;EWR Expiry" Theme="PlasticBlue">
             </dx:ASPxLabel>
        </td>
    </tr>
    ...
    <tr>
        <td style="width: 100%;">
            <asp:Panel ID="panel4" runat="server" GroupingText="EWR Expiry Tracker">
                        ...
                        <tr>
                            <td>
                                <table>
                                    <tr>
                                        <td>
                                            <dx:ASPxLabel ID="ASPxLabel4" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Expiration From" Theme="Glass">
                                            </dx:ASPxLabel>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <dx:ASPxLabel ID="ASPxLabel5" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Expiration To" Theme="Glass">
                                            </dx:ASPxLabel>
                                        </td>
                                        <td>
