<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="AccountApproval.aspx.vb" Inherits="Custodian_AccountApproval" title="Account Creation" %>
            ...
            <tr>
                <td style="width: 870px" align="center">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="Accounts Created Approval Form" width="848px"></asp:Label></td>
            </tr>
                <tr>
                    <td valign="top">
            ...
            <table>
                <tr>
                    <td style="width: 850px" align="center">
                        <asp:Button id="btnSave" runat="server" Text="Approve Account Creation" width="200px" /></td>                
                </tr>
            </table>
        </td>
    </tr>
