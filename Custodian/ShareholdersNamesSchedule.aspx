<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="ShareholdersNamesSchedule.aspx.vb" Inherits="Custodian_ShareholdersNamesSchedule" title="Account Details Enquiry" %>
            ...
            <tr>
                <td style="width: 870px" align="center">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="Shareholders Accounts Schedule" width="851px"></asp:Label></td>
            </tr>
            <tr>
