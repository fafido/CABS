<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="transfer_UT.aspx.vb" Inherits="TransferSec_transfer_UT" title="Transfer" %>
...
<tr>
    ...
    <td colspan ="8" align="center">
        ...
        &nbsp;</td>
         ...
         <asp:Panel runat="server" ID="Panel5" Font-Names="Cambria" GroupingText="Transfer Fund (Unit Trust)" Font-Size="Medium">
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td colspan ="6"></td>
                            ...
                            <td colspan ="1" style="width: 244px">
                                <dx:ASPxLabel ID="ASPxLabel27" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Select Fund" Theme="Glass">
                                </dx:ASPxLabel>
                            </td>
                       ...
                       <tr>
                        ...
                        <td colspan ="1" style="width: 183px">
                            <dx:ASPxTextBox ID="txtavailableshares" DisplayFormatString="n" runat="server"  Height="19px" Theme="Glass" Width="250px">
                            </dx:ASPxTextBox>
                            </td>
                        <td colspan ="1">
                            &nbsp;</td>
                    ...
                    <tr>
                        <td colspan="1" style="width: 244px">
                            <dx:ASPxLabel ID="ASPxLabel8" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Quantity to transfer" Theme="Glass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan="1" style="width: 183px">
                            <dx:ASPxTextBox ID="txtshares" runat="server"  DisplayFormatString="n"   Height="19px" Theme="Glass" Width="250px">
                            </dx:ASPxTextBox>
                        </td>
                        <td colspan="1">
                            &nbsp;</td>
                    ...
                    <tr>
                        <td colspan="1" style="width: 244px">
                            <dx:ASPxLabel ID="ASPxLabel37" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Transfer Date" Theme="Glass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan="1" style="width: 183px">
                            <dx:ASPxDateEdit ID="dttransfer" runat="server" Theme="Aqua" Width="250px">
                            </dx:ASPxDateEdit>
                        </td>
                        <td colspan="1">&nbsp;</td>
                        <td colspan="1">&nbsp;</td>
                    ...
                    <tr>
                        <td colspan="1" style="width: 244px; height: 86px;"></td>
                        <td colspan="1" style="width: 183px; height: 86px;">
