<%@ Page Language="VB"  MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="Reits.aspx.vb" Inherits="CDSMode_Reits" title="Reits" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <asp:panel runat="server" scrollbars="Auto" font-names="Cambria" font-size="Medium" groupingtext="Parameters&gt;&gt;Reits" backcolor="White">
        <asp:Panel runat="server" ID="panel2" Font-Names="Cambria" GroupingText="Reits">
            ...
            <table>
                ...
                <tr>
                        ...
                        <td colspan ="1">
                            <dx:ASPxLabel ID="ASPxLabel57" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Type">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan ="1">
                            <dx:ASPxComboBox ID="cmbtype" runat="server" Width="200px">
                                <Items>
                                    <dx:ListEditItem Text="I-Reit" Value="I-Reit" />
                                    <dx:ListEditItem Text="D-Reit" Value="D-Reit" />
                                                                  </Items>
                                <ValidationSettings>
                                    <RequiredField IsRequired="True" />
                                </ValidationSettings>
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <dx:ASPxLabel ID="ASPxLabel58" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Initial Price">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1">
                ...
                <tr>
                        <td align="center" colspan ="6">
                            <dx:ASPxButton ID="btnSaveCompany" runat="server" Text="Save Reit">
                            </dx:ASPxButton>
                        </td>
