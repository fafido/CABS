<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="wrupdate.aspx.vb" Inherits="wrupdate" title="Warehouse Receipt Update" %>
        ...
        <table width ="810px">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Securities&gt;&gt;Warehouse Receipt Update" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
    ...
    <td>
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    <dx:ASPxTextBox ID="txtreceiptno" runat="server" BackColor="#E4E4E4" Height="19px" Theme="BlackGlass" Width="250px">
                    </dx:ASPxTextBox>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td>
                    <dx:ASPxTextBox ID="txtwarehouse" runat="server" BackColor="#E4E4E4" Height="19px" Theme="BlackGlass" Width="250px">
                    </dx:ASPxTextBox>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td>
                    <dx:ASPxTextBox ID="txtwarehousephysical" runat="server" BackColor="#E4E4E4" Height="19px" Theme="BlackGlass" Width="250px">
                    </dx:ASPxTextBox>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td>
                    <dx:ASPxTextBox ID="txtgrade" runat="server" BackColor="#E4E4E4" Height="19px" Theme="BlackGlass" Width="250px" ReadOnly="True">
                    </dx:ASPxTextBox>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                <td style="width: 167px">
                    <dx:ASPxLabel ID="ASPxLabel40" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Insurance Details" Theme="Glass">
                    </dx:ASPxLabel>
                </td>
                <td>
            ...
            <tr>
                <td style="width: 167px">
                    <dx:ASPxLabel ID="ASPxLabel41" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Insurance Expiry" Theme="Glass">
                    </dx:ASPxLabel>
                </td>
                <td>
                    <dx:ASPxTextBox ID="txtinsuranceexpiry" runat="server" BackColor="#E4E4E4" Height="19px" Theme="BlackGlass" Width="250px">
                    </dx:ASPxTextBox>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                <td style="width: 167px">
                    <dx:ASPxLabel ID="ASPxLabel43" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Moisture" Theme="Glass">
                    </dx:ASPxLabel>
                </td>
                <td>
            ...
            <tr>
                <td style="width: 167px">
                    <dx:ASPxLabel ID="ASPxLabel44" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Damaged" Theme="Glass">
                    </dx:ASPxLabel>
                </td>
                <td>
            ...
            <tr>
                <td style="width: 167px">
                    <dx:ASPxLabel ID="ASPxLabel45" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Foreign Matters" Theme="Glass">
                    </dx:ASPxLabel>
                </td>
                <td>
            ...
            <tr>
                <td style="width: 167px">
                    <dx:ASPxLabel ID="ASPxLabel49" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Details" Theme="Glass">
                    </dx:ASPxLabel>
                </td>
                <td>
                    <dx:ASPxTextBox ID="txtdetails" runat="server" BackColor="#E4E4E4" Height="19px" Theme="BlackGlass" Width="250px">
                    </dx:ASPxTextBox>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td>
                    <dx:ASPxTextBox ID="txtharvestdate" runat="server" BackColor="#E4E4E4" Height="19px" Theme="BlackGlass" Width="250px" Visible="False">
                    </dx:ASPxTextBox>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
        ...
        <table class="auto-style1">
            <tr>
                <td align="center">
                    <dx:ASPxButton ID="btnView" runat="server" Text="Update" Theme="BlackGlass">
                    </dx:ASPxButton>
                </td>
            </tr>
        </table>
...
<tr>
    ...
    <td align="center">
        <dx:ASPxGridView ID="ASPxGridView3" runat="server" KeyFieldName="Contract No." Settings-ShowTitlePanel="true" SettingsText-Title="Receipts" Theme="Glass" Width="100%">
