<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="moneymarketcallback.aspx.vb" Inherits="TransferSec_moneymarketcallback" title="Money Market Callback" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel id="Panel1" runat="server" Width="100%" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width ="100%">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Fixed Income Investment Settlements&gt;&gt;Money Market Callback" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
        ...
        <asp:Panel ID="Panel3" runat="server" Font-Names="Cambria" Font-Size="Medium" GroupingText="Search Client">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtamount" runat="server" Height="19px" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                       <ValidationSettings>
                                <RequiredField IsRequired="True" />
                            </ValidationSettings>
                             </dx:ASPxTextBox>
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtsettlementamount" runat="server" Height="19px" ReadOnly="False" Theme="BlackGlass" Width="250px">
                       <ValidationSettings>
                                <RequiredField IsRequired="True" />
                            </ValidationSettings>
                             </dx:ASPxTextBox>
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtfixedrate" runat="server" Height="19px" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                       <ValidationSettings>
                                <RequiredField IsRequired="True" />
                            </ValidationSettings>
                             </dx:ASPxTextBox>
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtexchangerate" runat="server" Height="19px" ReadOnly="False" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                            <ValidationSettings>
                                <RequiredField IsRequired="True" />
                            </ValidationSettings>
                        </dx:ASPxTextBox>
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txttax" runat="server" Height="19px" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                      <ValidationSettings>
                                <RequiredField IsRequired="True" />
                            </ValidationSettings>
                              </dx:ASPxTextBox>
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtmaturityvalue" runat="server" Height="19px" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                    <td colspan="1" style="height: 26px">&nbsp;</td>
                    <td colspan="1" style="height: 26px">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxLabel ID="ASPxLabel82" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Current Value" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtcurrentvalue" runat="server" ReadOnly="True" Height="19px" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                    <td colspan="1" style="height: 26px">&nbsp;</td>
                    <td colspan="1" style="height: 26px">&nbsp;</td>
        ...
        <asp:Panel ID="Panel10" runat="server" Enabled="true" Font-Names="Cambria" Font-Size="Medium" GroupingText="Pending Money Market Callbacks">
            <table width="100%">
                <tr>
                    <td align="center">
                        <dx:ASPxGridView ID="AspxGridview4" runat="server" KeyFieldName="id" Settings-ShowTitlePanel="true" Theme="Glass" Width="100%">
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataColumn Caption="Amount">
                                   ...
                                   <dx:GridViewDataColumn Caption="Callback Amount">
                                    <DataItemTemplate>
        ...
        <asp:Panel ID="Panel12" runat="server" Enabled="true" Font-Names="Cambria" Font-Size="Medium" GroupingText="Rejected Money Market Callbacks">
            <table width="100%">
                <tr>
                    <td align="center">
        ...
        <asp:Panel ID="Panel11" runat="server" Enabled="true" Font-Names="Cambria" Font-Size="Medium" GroupingText="Committed Money Market Callbacks">
            <table width="100%">
                <tr>
                    <td align="center">
