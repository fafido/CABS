Partial Class Custodian_RightsEnq
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If (Not IsPostBack) Then
                checkSessionState()
                lblsitemap.Text = "Reporting >> Rights Issue Enquiries"
            End If
        Catch ex As Exception
            msgbox(ex.Message)
        End Try
    ...
    Protected Sub btnPrintStatement_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPrintStatement.Click
        Try
            If (RadioButton1.Checked = True) Then
                ...
                strscript += "window.open('ShareholderScheduleRep.aspx?nominee=" & Session("BrokerCode").ToString & "'&Company='FALSE');"
                strscript += "</script>"
            ...
            If (RadioButton2.Checked = True) Then
                Dim strscript As String
                strscript = "<script langauage=JavaScript>"
                strscript += "window.open('ShareholderScheduleRep.aspx?nominee=" & Session("BrokerCode").ToString & "&Company=" & DropDownList1.Text & "');"
                strscript += "</script>"
                ClientScript.RegisterStartupScript(Me.GetType(), "newwin", strscript)
