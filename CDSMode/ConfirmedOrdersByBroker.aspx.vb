...
Partial Class CDSMode_ConfirmedOrdersByBroker
    ...
    Public Sub GetOTCTrades()
        Try
            ...
            cmd = New SqlCommand("select Company, sum(order_quantity) as [Order Quantity], OrderType, PurchasingBroker,OrderDate,'CONFIRMED' AS STATUS   from OrdersSummary group by Company,OrderType,PurchasingBroker,OrderDate  order by OrderDate desc", cn)
    ...
    Protected Sub ASPxButton1_Click(sender As Object, e As EventArgs) Handles ASPxButton1.Click
        Response.Redirect("~/cdsmode/wsdlatsconfirmation.aspx")
    End Sub
