<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="BatchAuthorizations.aspx.vb" Inherits="CDSMode_BatchAuthorizations" title="Batch Processing" %>
        ...
        <asp:Panel ID="Panel3" runat="server" Font-Names="Cambria" GroupingText="Batch Details">
            <table width="810px">
                <tr>
                    ...
                    <td colspan="1">
                        <dx:ASPxTextBox ID="txtbatchno" runat="server" BackColor="#E4E4E4" ReadOnly="True" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                    <td colspan="1">
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <dx:ASPxTextBox ID="txtbroker" runat="server" BackColor="#E4E4E4" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                    <td colspan="1">
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <dx:ASPxLabel ID="ASPxLabel28" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Price" Theme="Glass" Visible="False">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1">
         ...
         <asp:Panel runat="server" ID="Panel5" Font-Names="Cambria" GroupingText="Primary Batch Details" Font-Size="Medium">
                ...
                <table width="810px">
                    ...
                    <tr>
                            ...
                            <td colspan ="1" style="width: 81px; height: 18px;">
                                </td>
