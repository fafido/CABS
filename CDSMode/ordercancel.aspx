<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="ordercancel.aspx.vb" Inherits="TransferSec_ordercancel" title="Cancel Orders" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel id="Panel1" runat="server" Width="840px" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width ="810px">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Orders&gt;&gt;Order Cancel" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
        ...
        <asp:Panel runat="server" ID="Panel3" Font-Names="Cambria" GroupingText="Orders">
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="grdApps" runat="server" AllowPaging="True" CellPadding="4"  CssClass="table table-bordered table-striped tablestyle success" EmptyDataRowStyle-CssClass="text-warning text-center" EmptyDataText="No Orders Found!" ForeColor="#333333" GridLines="None" HorizontalAlign="Left">
                                ...
                                <Columns>
                                    <asp:CommandField ItemStyle-Width="12.5%" SelectText="Cancel" ShowSelectButton="True">
