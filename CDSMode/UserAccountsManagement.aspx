...
<asp:Panel runat="server" ID="Companies" Font-Names="Cambria" GroupingText="Participant" Visible="False">
    <table>
        ...
        <table width="100%">
            ...
            <tr>
                <td colspan="8">Search From Active Directory
                    <hr />
                </td>
                <td>
                </td>
            ...
            <tr>
                <td colspan="1" style="width:150px">
                    <dx:ASPxLabel ID="ASPxLabel2" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Search Name" Theme="Glass">
                    </dx:ASPxLabel>
                </td>
                <td colspan="1" style="width:150px">
                    <dx:ASPxTextBox ID="txtSearchAD" runat="server" Theme="BlackGlass" Width="250px">
                    </dx:ASPxTextBox>
                    </td>
                <td colspan="1" style="width:150px">
                    <dx:ASPxButton ID="btnSearchAD" runat="server" Text=">>" ValidationGroup="AD" Theme="BlackGlass">
                    </dx:ASPxButton>
                </td>
                <td>
                    <dx:ASPxComboBox ID="lstADNameSearch" runat="server" Theme="BlackGlass" ValueType="System.String" AnimationType="Slide" IncrementalFilteringMode="Contains" AutoPostBack="True" Width="250px">
                    </dx:ASPxComboBox>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="1" style="width:150px">
                    <dx:ASPxTextBox ID="txtUsername" ReadOnly="true" runat="server" Theme="BlackGlass" Width="250px">
                        <ValidationSettings SetFocusOnError="true">
                            <RequiredField IsRequired="True" />
                        </ValidationSettings>
                    </dx:ASPxTextBox>
                    ...
                    <td colspan="1">
                        <dx:ASPxTextBox ID="txtSurname" ReadOnly="false" runat="server" Theme="BlackGlass" Width="250px">
                            <ValidationSettings SetFocusOnError="true">
                                <RequiredField IsRequired="True" />
                            </ValidationSettings>
                        </dx:ASPxTextBox>
            ...
            <tr>
                ...
                <td colspan="1" style="width:150px">
                    <dx:ASPxTextBox ID="txtOthernames" ReadOnly="false" runat="server" Theme="BlackGlass" Width="250px">
                        <ValidationSettings SetFocusOnError="true">
                            <RequiredField IsRequired="True" />
                        </ValidationSettings>
                    </dx:ASPxTextBox>
                    ...
                    <td colspan="1">
                        <dx:ASPxTextBox ID="txtDepartment" ReadOnly="true" runat="server" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                    <td colspan="1">
                    ...
                    <td colspan ="8" align ="center">
                      ...
                      <Columns>
                                                   ...
                                                   <dx:GridViewDataColumn VisibleIndex="0" Caption="">
                                                         <DataItemTemplate>
                                                              <asp:LinkButton ID="ResetID" Visible="false" Text="Reset Password"  CommandName="PasswordReset" CommandArgument='<%# Eval("ID") %>' runat="server">
                                                              </asp:LinkButton>
                                                         </DataItemTemplate>
