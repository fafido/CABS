...
Partial Class CDSMode_ATSDataImportReport
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            If (txtDateFrom.Text <> "" And txtDateTo.Text <> "") Then
                ...
                strscript += "window.open('ATSSummaryImportReportCall.aspx?datefrom=" & txtDateFrom.SelectedDate.ToString & "&dateto=" & txtDateTo.SelectedDate.ToString & "');"
                strscript += "</script>"
