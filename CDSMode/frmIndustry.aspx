<%@ Page Language="VB" MasterPageFile="~/CDSMain.master" AutoEventWireup="false" CodeFile="frmIndustry.aspx.vb" Inherits="CDSMode_frmIndustry" title="Untitled Page" %>
            ...
            <td style="width: 712px; height: 226px" valign="top" __designer:mapid="221">
                <table __designer:mapid="222">
                    <tr __designer:mapid="223">
                        ...
                        Text="Industries" width="848px"></asp:Label>
                        </td>
                    </tr>
                </table>
