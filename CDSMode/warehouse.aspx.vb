...
Partial Class CDSMode_warehouse
    ...
    Protected Sub btnSaveCompany_Click(sender As Object, e As EventArgs) Handles btnSaveCompany.Click
        ...
        Else
            ...
            If cmd.ExecuteNonQuery Then
                ...
                clearAll()
            Else
                msgbox("Error saving warehouse details")
            End If
        End If
        'Catch ex As Exception
    ...
    Protected Sub btnSearchSecName_Click(sender As Object, e As EventArgs) Handles btnSearchSecName.Click
        clearAll()
        cmd = New SqlCommand("select * from para_warehouse where company='" & txtSearchSecName.Text & "'", con)
        Dim ds As New DataSet
        adp = New SqlDataAdapter(cmd)
        adp.Fill(ds, "pc")
        If ds.Tables(0).Rows.Count > 0 Then
    ...
    Public Function Issuecodeexists(ByVal code As String) As String
        cmd = New SqlCommand("select * from para_warehouse where issuer_code='" + code + "'", con)
        Dim ds As New DataSet
        adp = New SqlDataAdapter(cmd)
        adp.Fill(ds, "pc")
        If ds.Tables(0).Rows.Count > 0 Then
