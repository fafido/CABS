<%@ Page Language="VB"  MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="InstrumentsSetUp.aspx.vb" Inherits="CDSMode_InstrumentsSetUp" title="Instruments Setup" %>
        ...
        <asp:Panel runat="server" ID="panel2" Font-Names="Cambria" GroupingText="Basic Details">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td colspan="1" style="display:inline; height: 23px;">
