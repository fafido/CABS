<%@ Page Language="VB" MasterPageFile="~/CDSMain.master" AutoEventWireup="false" CodeFile="frmCompany.aspx.vb" Inherits="CDSMode_frmCompany" title="Untitled Page" %>
            ...
            <td style="width: 712px; height: 226px" valign="top" __designer:mapid="184">
                <table __designer:mapid="185">
                    <tr __designer:mapid="186">
                        ...
                        Text="Companies" width="841px"></asp:Label>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr __designer:mapid="1b7">
                        <td style="width: 850px" align="center" __designer:mapid="1b8">
                            <asp:GridView id="GridView1" runat="server" backcolor="White" 
                                ...
                                GridLines="Horizontal" width="418px">
