Partial Class TransferSec_deletematched
    ...
    Protected Sub ASPxButton4_Click(sender As Object, e As EventArgs) Handles ASPxButton4.Click
        ...
        cmd = New SqlCommand("update  tblmatchedorders set where id='" + ASPxTextBox1.Text + "'", cn)
