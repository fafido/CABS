...
Partial Class CDSMode_TradesExportFile
    ...
    Public Sub GetOrdersLoad()
        Try
            ...
            'cmd = New SqlCommand("select * from ordersSummary where PurchasingBroker='" & Session("BrokerCode").ToString & "' and status='C' and ApprovalFlag=0", cn)
            cmd = New SqlCommand("select * from ordersSummary where  status='C' and ApprovalFlag=0", cn)
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        cmd = New SqlCommand("Update OrdersSummary set ApprovalFlag= 1, updated=1 where ApprovalFlag=0 ", cn)
        If (cn.State = ConnectionState.Open) Then
            cn.Close()
        End If
        cn.Open()
    ...
    Public Sub Csv1()
        Try
            ...
            Response.AddHeader("content-disposition", "attachment;filename=" & Now.Date & "Orders.csv")
            Response.Charset = ""
            Response.ContentType = "application/text"
