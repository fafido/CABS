<%@ Page Language="VB" MasterPageFile="~/CDSuser.master" AutoEventWireup="false" CodeFile="TransfersVerifications2.aspx.vb" Inherits="CDSMode_TransfersVerifications2" title="Batch Verification" %>
            ...
            <tr>
                <td style="width: 870px" align="center" colspan="2">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="Batch Verification" width="853px"></asp:Label></td>
            </tr>
            <tr>
