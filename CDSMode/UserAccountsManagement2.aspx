<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="UserAccountsManagement2.aspx.vb" Inherits="CDSMode_UserAccountsManagement2" title="Account Details Enquiry" %>
        ...
        <table style="width: 787px">
            ...
            <tr>
                ...
                <td colspan ="1" style="height: 24px">
                    <dx:ASPxTextBox ID="txtMobile" runat="server" BackColor="#E4E4E4" Theme="BlackGlass" Width="174px" Height="16px">
            ...
            <tr>
                <td colspan ="1" style="height: 23px; width: 76px;">
                ...
                <td colspan ="1" style="height: 23px; width: 250px;">
                ...
                <td colspan ="1" style="height: 23px; width: 135px;">
                ...
                <td colspan ="1" style="height: 23px">
                    <dx:ASPxTextBox ID="txtDepartment" runat="server" BackColor="#E4E4E4" Theme="BlackGlass" Width="174px" Height="19px">
                    </dx:ASPxTextBox>
                </td>
            </tr>
             <tr>
                ...
                <td colspan ="1">
                    ...
                    <asp:RadioButton ID="rdControlled1" runat="server" enabled="false" checked="true" AutoPostBack="True" GroupName="AccType" Text="User" />
                 </td>
            </tr>
            <tr>
                <td colspan ="1" style="width: 76px">
        ...
        <table width="810px">
            ...
            <tr>
                ...
                <td colspan ="8" align="center">
                    <asp:RadioButton ID="rdunLocked" runat="server" AutoPostBack="True" GroupName="AccLockStatus" Text="Unlocked" Checked="True" />
