<%@ Page Language="VB"  MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="WSDLATSConfirmation.aspx.vb" Inherits="CDSMode_WSDLATSConfirmation" title="Name Enquiry" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:panel runat="server" ScrollBars="Auto">
        ...
        <table style="background-color:ivory ; border-style:solid ;">
                <tr>
                        <td colspan ="8" align="center"><dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Orders Verification" Theme="iOS" Font-Names="Cambria" Font-Size="Medium"></dx:ASPxLabel></td>
            ...
            <tr>
                <td colspan ="4">
                    <dx1:ASPxButton ID="ASPxButton2" runat="server" Text="Receive ATS Orders" Theme="BlackGlass">
                    </dx1:ASPxButton>
                </td>
