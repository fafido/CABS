<%@ Page Language="VB" MasterPageFile="~/CDSMain.master" AutoEventWireup="false" CodeFile="CDSUserAccountsAuthorization.aspx.vb" Inherits="CDSUserAccountsAuthorization" %>
                    ...
                    <td valign="top">
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td colspan ="2"><asp:TextBox width="130px" runat="server" id="txtMobile2"></asp:TextBox>
                                    </td>
                            </tr>
                            <tr>
                                <td colspan ="2">
                            ...
                            <tr>
                                <td colspan ="2">
                                    ...
                                    <td colspan ="2">
                                        &nbsp;</td>
                                    <td colspan ="2">
                                        <asp:Button runat="server" onclick="Unnamed16_Click" Text="Authorize Account" />
                                </td>
                                    <td colspan ="2">
