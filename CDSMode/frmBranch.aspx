<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="frmBranch.aspx.vb" Inherits="CDSMode_frmBranch" title="Untitled Page" %>
            ...
            <td style="width: 712px; height: 226px" valign="top" __designer:mapid="221">
                <table __designer:mapid="222">
                    <tr __designer:mapid="223">
                        ...
                        Text="Bank Branches" width="848px"></asp:Label>
                        </td>
                    </tr>
                </table>
                <table __designer:mapid="226" style="width: 511px">
                    <tr>
                        ...
                        <td __designer:mapid="22a">
                            <asp:DropDownList id="cmbBank" runat="server" Height="20px" width="173px">
                            </asp:DropDownList>
                    ...
                    <tr __designer:mapid="227">
                        <td align="left" __designer:mapid="228" style="width: 225px">
                            <asp:Label id="Label1" runat="server" Text="Branch Code" font-names="Arial" 
                            font-size="Small"></asp:Label>
                        </td>
                    ...
                    <tr __designer:mapid="22c">
                        <td align="left" __designer:mapid="22d" style="width: 225px">
                            <asp:Label id="Label2" runat="server" Text="Branch" font-names="Arial" 
                            font-size="Small"></asp:Label>
                        </td>
