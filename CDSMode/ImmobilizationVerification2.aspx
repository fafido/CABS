<%@ Page Language="VB" MasterPageFile="~/CDSuser.master" AutoEventWireup="false" CodeFile="ImmobilizationVerification2.aspx.vb" Inherits="CDSMode_ImmobilizationVerification2" title="Batch Verification" %>
            ...
            <tr>
                <td style="width: 870px" align="center" colspan="2">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="Immobilization Batch Verification" width="852px"></asp:Label></td>
            </tr>
            <tr>
