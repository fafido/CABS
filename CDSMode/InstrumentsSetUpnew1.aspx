<%@ Page Language="VB"  MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="InstrumentsSetUpnew1.aspx.vb" Inherits="CDSMode_InstrumentsSetUpnew1" title="Instruments Setup" %>
        ...
        <asp:Panel runat="server" ID="panel2" Font-Names="Cambria" GroupingText="Basic Details">
            ...
            <table style="width:100%">
                ...
                <tr>
                        ...
                        <td colspan ="1">
                            <dx:ASPxLabel ID="ASPxLabel3" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Category" >
                            </dx:ASPxLabel>
                        </td>
                        <td colspan ="1">
                            <dx:ASPxComboBox ID="txtboard" runat="server" Width="200px">
                                <Items>
                                    <dx:ListEditItem Text="Listed - ZSE" Value="Listed - ZSE" />
                                    <dx:ListEditItem Text="Listed - Finsec" Value="Listed - Finsec" />
                                    <dx:ListEditItem Text="Un-listed - Private" Value="Un-listed - Private" />
                                </Items>
                                <ValidationSettings>
                                    <RequiredField IsRequired="True" />
                                </ValidationSettings>
                ...
                <tr>
                    <td colspan="1">
                        <dx:ASPxLabel ID="ASPxLabel59" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Industry">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1">
                        <dx:ASPxComboBox ID="cmbIndexType" runat="server" AutoPostBack="True" Theme="BlackGlass" Width="200px">
                            <ValidationSettings>
                                <RequiredField IsRequired="True" />
                            </ValidationSettings>
                        </dx:ASPxComboBox>
                ...
                <tr>
                    <td colspan="6">
                        <dx1:ASPxGridView ID="grdpendingsettlement" runat="server" KeyFieldName="id" Settings-ShowTitlePanel="true" Theme="Glass" Width="100%" Visible="False">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <dx1:GridViewDataTextColumn FieldName="ClientNo" Name="Client No" Settings-AutoFilterCondition="Contains">
                                </dx1:GridViewDataTextColumn>
                                <dx1:GridViewDataTextColumn FieldName="Names" Name="Client Name" Settings-AutoFilterCondition="Contains">
                                </dx1:GridViewDataTextColumn>
                                <dx1:GridViewDataTextColumn FieldName="TradeType" Name="Trade Type" Settings-AutoFilterCondition="Contains">
                                </dx1:GridViewDataTextColumn>
                                <dx1:GridViewDataTextColumn FieldName="Company" Name="Company" Settings-AutoFilterCondition="Contains">
                                </dx1:GridViewDataTextColumn>
                                <dx1:GridViewDataColumn Caption="Units">
                                    <dataitemtemplate>
                                        <dx:aspxlabel runat="server" Text='<%# String.Format("{0:#,##0.00}", Eval("Units")) %>'>
                                        </dx:aspxlabel>
                                    </dataitemtemplate>
                                </dx1:GridViewDataColumn>
                                <dx1:GridViewDataColumn Caption="Price">
                                    <dataitemtemplate>
                                        <dx:aspxlabel runat="server" Text='<%# Eval("Price") %>'>
                                        </dx:aspxlabel>
                                    </dataitemtemplate>
                                </dx1:GridViewDataColumn>
                                <dx1:GridViewDataColumn Caption="Charges">
                                    <dataitemtemplate>
                                        <dx:aspxlabel runat="server" Text='<%# String.Format("{0:#,##0.00}", Eval("TradeCharge")) %>'>
                                        </dx:aspxlabel>
                                    </dataitemtemplate>
                                </dx1:GridViewDataColumn>
                                <dx1:GridViewDataTextColumn FieldName="AssetManager" Name="AssetManager" Settings-AutoFilterCondition="Contains">
                                </dx1:GridViewDataTextColumn>
                                <dx1:GridViewDataTextColumn FieldName="TradeStatus" Name="Status" Settings-AutoFilterCondition="Contains">
                                </dx1:GridViewDataTextColumn>
                                <dx1:GridViewDataTextColumn FieldName="CapturedBy" Name="Captured By" Settings-AutoFilterCondition="Contains">
                                </dx1:GridViewDataTextColumn>
                            </Columns>
