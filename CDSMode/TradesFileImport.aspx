<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="TradesFileImport.aspx.vb" Inherits="CDSMode_TradesFileImport" title="Name Enquiry" %>
            ...
            <table>
                    <tr>
                        <td colspan ="1" align="center">
                            <dx:ASPxRadioButton ID="RDSWIFT" runat="server" Text="SWIFT" Theme="Glass">
                            </dx:ASPxRadioButton>
                        </td>
            ...
            <tr>
                <td style="width: 870px" align="center">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="Trades Import &amp; Settlement File" width="853px"></asp:Label></td>
            </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan ="1" align="center">
                        <dx:ASPxGridView ID="ASPxGridView1" runat="server" Theme="Office2003Blue" Width="609px">
                        </dx:ASPxGridView>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan ="1" align="center">
                        <asp:RadioButton ID="rdSwit" runat="server" AutoPostBack="True" GroupName="msging" Text="SWIFT" />
                        <asp:RadioButton ID="rdSwit0" runat="server" AutoPostBack="True" GroupName="msging" Text="POSTILLION" />
                        <asp:RadioButton ID="rdSwit1" runat="server" AutoPostBack="True" GroupName="msging" Text="WEB SERVICES" />
                    </td>
