<%@ Page Language="VB"  MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="useraccountsreport.aspx.vb" Inherits="CDSMode_useraccountsreport" title="User Accounts Report" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:panel runat="server" ScrollBars="Auto">
        ...
        <table style="background-color:ivory ; border-style:solid ;">
            <tr>
                        <td align="center"><dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="Access Report" Theme="iOS" Font-Names="Cambria" Font-Size="Medium"></dx:ASPxLabel></td>
