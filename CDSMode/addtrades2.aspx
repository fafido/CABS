<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="addtrades2.aspx.vb" Inherits="TransferSec_addtrades2" title="Add Trades" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
    <asp:Panel id="Panel1" runat="server" Width="1150px" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <td>
            <table class="auto-style1" style="width: 32%">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <asp:CheckBox ID="CheckBox1" runat="server" Text="Show all orders" />
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                                        ...
                                        <table class="dxflInternalEditorTable_Moderno">
                                            <tr>
                                                ...
                                                <td style="height: 43px">
                                                    <dx:ASPxTextBox ID="txtbrokerref" THEME="iOS" runat="server" Width="100%" ReadOnly="True">
                                                    </dx:ASPxTextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 109px; height: 43px;">
                                                    <dx:ASPxLabel ID="ASPxLabel13" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Order Status" Theme="iOS">
                                                    </dx:ASPxLabel>
                                                </td>
                                                <td style="height: 43px">
                                                    <dx:ASPxTextBox ID="txtorderstatus" runat="server" Theme="iOS" Width="100%" ReadOnly="True">
                                                    </dx:ASPxTextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 109px; height: 43px;">
                                                    <dx:ASPxLabel ID="ASPxLabel14" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Order Type" Theme="iOS">
                                                    </dx:ASPxLabel>
                                                </td>
                                                <td style="height: 43px">
                                                    <dx:ASPxTextBox ID="txtordertype" runat="server" ReadOnly="True" Theme="iOS" Width="100%">
                                                    </dx:ASPxTextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 109px; height: 43px;">
                                                    <dx:ASPxLabel ID="ASPxLabel15" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Available" Theme="iOS">
                                                    </dx:ASPxLabel>
                                                </td>
                                                <td style="height: 43px">
                                                    <dx:ASPxTextBox ID="txtav" runat="server" ReadOnly="True" Theme="iOS" Width="100%">
                                                    </dx:ASPxTextBox>
                                                </td>
                                            </tr>
                                            <tr>
