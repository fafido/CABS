<%@ Page Language="VB"  MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="issuersetup.aspx.vb" Inherits="CDSMode_issuersetup" title="Issuer Setup" %>
...
<%@ Register assembly="DevExpress.Web.v13.2, Version=13.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web.ASPxPopupControl" tagprefix="dx1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <asp:panel runat="server" scrollbars="Auto" font-names="Cambria" font-size="Medium" groupingtext="Parameters&gt;&gt;Issuer Setup" backcolor="White">
        <asp:Panel runat="server" ID="panel2" Font-Names="Cambria" GroupingText="Basic Details">
            ...
            <table>
                ...
                <tr>
                        <td colspan ="1">
                            <dx:ASPxLabel ID="ASPxLabel1" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Issuer Name" Theme="BlackGlass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan ="1">
                        ...
                        <td colspan ="1">
                            <dx:ASPxLabel ID="ASPxLabel59" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Issuer Code" Theme="BlackGlass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan ="1">
                ...
                <tr>
                        <td colspan ="1" style="height: 32px">
                            <dx:ASPxLabel ID="ASPxLabel4" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Industry Type" Theme="BlackGlass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan ="1" style="height: 32px">
                            <dx:ASPxComboBox ID="cmbIndexType" runat="server" Theme="BlackGlass" Width="200px" AutoPostBack="True">
                                <ValidationSettings>
                            <RequiredField IsRequired="True" />
                        </ValidationSettings>
                            </dx:ASPxComboBox>
                        ...
                        <td colspan ="1" style="height: 32px">
                            <dx:ASPxLabel ID="ASPxLabel7" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Incorporation Date" Theme="BlackGlass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan ="1" style="height: 32px">
                ...
                <tr>
                    <td colspan ="1">
                        <dx:ASPxLabel ID="ASPxLabel10" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Transfer Secretary" Theme="BlackGlass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan ="5">
                ...
                <tr>
                        <td colspan ="6">
                            <dx1:ASPxPopupControl ID="ASPxPopupControl1" runat="server" BackColor="#DDECFE" CloseAction="CloseButton" EnableCallbackAnimation="True" HeaderText="Industry Types" Modal="true" ShowCollapseButton="False" ShowMaximizeButton="False" ShowPageScrollbarWhenModal="True" ShowPinButton="False" ShowRefreshButton="False" Theme="Glass">
            <contentcollection>
          <dx1:popupcontrolcontentcontrol runat="server" SupportsDisabledAttribute="True">
         
                        <dx:ASPxRoundPanel ID="ASPxRoundPanel7" runat="server" ShowHeader="False" Theme="Glass" Width="100%">
                            <PanelCollection>
                                <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                    <table class="dxflInternalEditorTable_Moderno" style="width: 100%">
                                        <tr>
                                            <td style="width:208px">
                                                <dx:ASPxLabel ID="ASPxLabel61" runat="server" Text="Industry Code" Theme="Glass">
                                                </dx:ASPxLabel>
                                            </td>
                                            <td style="width:212px">
                                                <dx:ASPxTextBox ID="txtindustrycode" runat="server" Theme="Glass" Width="250px">
                                                </dx:ASPxTextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width:208px; height: 36px;">
                                                <dx:ASPxLabel ID="ASPxLabel62" runat="server" Text="Industry Name" Theme="Glass">
                                                </dx:ASPxLabel>
                                            </td>
                                            <td style="width:212px; height: 36px;">
                                                <dx:ASPxTextBox ID="txtindustryname" runat="server" Theme="Glass" Width="250px">
                                                </dx:ASPxTextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="width:212px">
                                                <dx:ASPxButton ID="btnSaveCompany0" CausesValidation="False" runat="server" Text="Add">
                                                </dx:ASPxButton>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                <dx:ASPxGridView ID="grdactivecharges" runat="server" AutoGenerateColumns="False" KeyFieldName="code" Theme="Glass" Width="100%">
                                                    <Columns>
                                                
                                                        <dx:GridViewDataColumn ShowInCustomizationForm="True" VisibleIndex="0">
                                                            <DataItemTemplate>
                                                                <asp:LinkButton ID="SelectID1" runat="server" CommandArgument='<%# Eval("code") %>' CommandName="Delete" OnClientClick="if ( !confirm('Are you sure you want to delete ? ')) return false;" Text="Delete">
                                        </asp:LinkButton>
                                                            </DataItemTemplate>
                                                        </dx:GridViewDataColumn>
                                                        <dx:GridViewDataColumn Caption="Code" ShowInCustomizationForm="True" VisibleIndex="1">
                                                            <DataItemTemplate>
                                                                <dx:ASPxLabel runat="server" Text='<%# Eval("code") %>'>
                                                                </dx:ASPxLabel>
                                                            </DataItemTemplate>
                                                            <HeaderStyle Font-Bold="True" />
                                                        </dx:GridViewDataColumn>
                                                        <dx:GridViewDataColumn Caption="Industry Name" ShowInCustomizationForm="True" VisibleIndex="2">
                                                            <DataItemTemplate>
                                                                <dx:ASPxLabel runat="server" Text='<%# Eval("fname") %>'>
                                                                </dx:ASPxLabel>
                                                            </DataItemTemplate>
                                                            <HeaderStyle Font-Bold="True" />
                                                        </dx:GridViewDataColumn>
