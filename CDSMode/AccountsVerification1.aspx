<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="AccountsVerification1.aspx.vb" Inherits="CDSMode_AccountsVerification1" title="Account Details Enquiry" %>
        ...
        <asp:Panel runat="server" ID="Search" Font-Names="Cambria" GroupingText="Pending Verication Accounts">
            <table>
                    <tr>
                        ...
                        <td colspan ="7">
                            <dx:ASPxComboBox ID="cmbNationality0" runat="server" Theme="BlackGlass" ValueType="System.String" Width="710px">
                            </dx:ASPxComboBox>
                            </td>
                ...
                <tr>
                        ...
                        <td colspan ="7">
                            <dx:ASPxLabel ID="ASPxLabel58" runat="server" Text="Account Update / New Account">
                            </dx:ASPxLabel>
                            </td>
