...
Partial Class CDSMode_AllotmentsVerifications
    ...
    Public Sub getBatch()
        Try
            ...
            If (ds.Tables(0).Rows.Count > 0) Then
                ...
                cmd = New SqlCommand("Select Company as [Company],Batch_Type as [Batch Type],Shareholder as [Old Holder Number],Shares,Certificate,CD,CDS_Number as [CDS Number],HolderNames from broker_Batch_Ref where batch_ref=" & lblbatchref.Text & " AND status='B'", cn)
                adp = New SqlDataAdapter(cmd)
