<%@ Page Language="VB"  MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="ETFSetup.aspx.vb" Inherits="CDSMode_ETFSetup" title="ETF Setup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <asp:panel runat="server" scrollbars="Auto" font-names="Cambria" font-size="Medium" groupingtext="Parameters>>ETF Setup" backcolor="White">
        <asp:Panel runat="server" ID="panel2" Font-Names="Cambria" GroupingText="Basic Details" Height="900px">
            ...
            <table>
                ...
                <tr>
                        ...
                        <td colspan ="1" style="height: 32px">
                            <dx:ASPxTextBox ID="txtTicker" runat="server"  Width="200px" Text="0" Visible="False" >
                            </dx:ASPxTextBox>
                ...
                <tr>
                        ...
                        <td colspan ="1">
                            <dx:ASPxTextBox ID="txtBoard" runat="server"   Width="200px" Text="0" Visible="False">
                            </dx:ASPxTextBox>
                            <dx:ASPxComboBox ID="cmbCountryListed" runat="server" ValueType="System.String"  CallbackPageSize="15" EnableCallbackMode="True" DropDownStyle="DropDownList"  IncrementalFilteringMode="Contains"  AnimationType="Slide">
                                <ValidationSettings>
                                    <RequiredField IsRequired="True" />
                                </ValidationSettings>
                            </dx:ASPxComboBox>
                ...
                <tr>
                 ...
                 <tr>
                        ...
                        <td colspan ="1" style="height: 23px">
                            <dx:ASPxLabel ID="txtinit" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Initial Price">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan ="1" style="height: 23px">
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <dx:ASPxLabel ID="ASPxLabel54" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Term(Years)" >
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1">
                ...
                <tr>
                    <td colspan="1">&nbsp;</td>
                    <td colspan="5">
                        <asp:Panel ID="Panel7" runat="server" GroupingText="Constitution">
                            <table class="auto-style1">
                                ...
                                <tr>
                                    <td style="height: 18px">
                                        <dx:ASPxLabel ID="ASPxLabel57" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Company" >
                                        </dx:ASPxLabel>
                                    </td>
                                    <td style="height: 18px">
                                        <dx:ASPxComboBox ID="cmbcompany" runat="server" AutoPostBack="True"  ValueType="System.String" Width="200px">
                                           
                                        </dx:ASPxComboBox>
                                    </td>
                                    <td style="height: 18px">
                                        <dx:ASPxLabel ID="ASPxLabel58" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Percentage(%)" >
                                        </dx:ASPxLabel>
                                    </td>
                                    <td style="height: 18px">
                                        <dx:ASPxTextBox ID="txtpercentage" runat="server"   Width="200px">
                                        </dx:ASPxTextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="3" style="height: 18px">
                                        <dx:ASPxButton ID="btnSearchSecName0" runat="server" CausesValidation="False" Text="Save Constitution" >
                                        </dx:ASPxButton>
                                    </td>
                                </tr>
                                <tr>
                ...
                <tr>
                        <td align="center" colspan ="6">
                            <dx:ASPxButton ID="btnSaveCompany" runat="server" Text="Save ETF">
                            </dx:ASPxButton>
                        </td>
