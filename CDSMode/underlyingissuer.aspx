        ...
        <asp:Panel runat="server" ID="panel2" Font-Names="Cambria" GroupingText="Basic Details">
            ...
            <table>
                ...
                <tr>
                        ...
                        <td colspan ="1">
                            <dx:ASPxTextBox ID="txtissuercode" runat="server" BackColor="#E4E4E4" Theme="BlackGlass" Width="200px">
                            </dx:ASPxTextBox>
                        </td>
                        <td colspan ="1">
                            &nbsp;</td>
                ...
                <tr>
                        ...
                        <td colspan ="1" style="height: 32px">
                            <dx:ASPxLabel ID="ASPxLabel7" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Incorporation" Theme="BlackGlass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan ="1" style="height: 32px">
