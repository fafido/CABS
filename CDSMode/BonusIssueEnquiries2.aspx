<%@ Page Language="VB" MasterPageFile="~/CDSuser.master" AutoEventWireup="false" CodeFile="BonusIssueEnquiries2.aspx.vb" Inherits="CDSMode_BonusIssueEnquiries2" title="Name Enquiry" %>
            ...
            <tr>
                <td style="width: 870px" align="center">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="Bonus Issue Enquiries" width="855px"></asp:Label></td>
            </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="width: 629px">
                        <asp:RadioButton id="rdDate" runat="server" autopostback="True" 
                            GroupName="SearchOptions" Text="Bonus Instructions" />
                        <asp:RadioButton id="rdDate0" runat="server" autopostback="True" 
                            GroupName="SearchOptions" Text="Bonus Issue Schedules" />
