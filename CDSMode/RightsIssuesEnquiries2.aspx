<%@ Page Language="VB" MasterPageFile="~/CDSuser.master" AutoEventWireup="false" CodeFile="RightsIssuesEnquiries2.aspx.vb" Inherits="CDSMode_RightsIssuesEnquiries2" title="Name Enquiry" %>
            ...
            <tr>
                <td style="width: 870px" align="center">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="Rights Issue Enquiries" width="851px"></asp:Label></td>
            </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="width: 629px">
                        <asp:RadioButton id="rdDate" runat="server" autopostback="True" 
                            GroupName="SearchOptions" Text="Rights Instructions" />
                        <asp:RadioButton id="rdDate0" runat="server" autopostback="True" 
                            GroupName="SearchOptions" Text="Rights Issue Schedules" />
                ...
                <tr>
                    <td>
                        <asp:Label id="Label8" runat="server" font-names="Verdana" font-size="Small" 
                            Text="Issue Number" width="144px"></asp:Label>
                    </td>
                    <td style="width: 629px">
