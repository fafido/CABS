<%@ Page Language="VB"  MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="InstrumentsSetUp2.aspx.vb" Inherits="CDSMode_InstrumentsSetUp2" title="Instruments Setup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <asp:panel runat="server" scrollbars="Auto" font-names="Cambria" font-size="Medium" groupingtext="Parameters&gt;&gt;Cross Listed Securities Setup" backcolor="White">
        <asp:Panel runat="server" ID="panel2" Font-Names="Cambria" GroupingText="Basic Details">

            <table>
                <tr>
                    <td colspan ="8" align ="center">
                        <asp:RadioButtonList runat="server" id="rdbType" repeatdirection="horizontal" autopostback="true">
                ...
                <tr>
                    <td>
                        <dx:ASPxLabel runat="server" ID="lblSearchSecName" Font-Names="Cambria" Font-Size="Small" Text="Security Name" Theme="BlackGlass"></dx:ASPxLabel>
                    </td>
                    <td colspan="1" style="display:inline;">
                        <dx:ASPxTextBox ID="txtSearchSecName" runat="server" BackColor="#E4E4E4" Theme="BlackGlass" Width="200px">
                        </dx:ASPxTextBox>
                    </td>
                    <td>
                ...
                <tr>
                        ...
                        <td colspan ="1">
                            <dx:ASPxLabel ID="ASPxLabel1" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Security Name" Theme="BlackGlass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan ="1">
                ...
                <tr>
                        <td colspan ="1" style="height: 32px">
                            <dx:ASPxLabel ID="ASPxLabel4" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Indunstry Type" Theme="BlackGlass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan ="1" style="height: 32px">
                        ...
                        <td colspan ="1" style="height: 32px">
                            <dx:ASPxTextBox ID="txtTicker" runat="server" Theme="BlackGlass" Width="200px" BackColor="#E4E4E4">
                            </dx:ASPxTextBox>
                        </td>
                        <td colspan ="1" style="height: 32px">
                            &nbsp;</td>
                ...
                <tr>
                        <td colspan ="1">
                            <dx:ASPxLabel ID="ASPxLabel7" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Year Listed" Theme="BlackGlass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan ="1">
                        ...
                        <td colspan ="1">
                            <dx:ASPxLabel ID="ASPxLabel52" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Company" Theme="BlackGlass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan ="1">
                            <dx:ASPxComboBox ID="cmbSecType0" runat="server" Theme="BlackGlass" ValueType="System.String" Width="200px">
                                  <ValidationSettings>
                            <RequiredField IsRequired="True" />
                        </ValidationSettings>
                            </dx:ASPxComboBox>
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <dx:ASPxLabel ID="ASPxLabel6" runat="server" Font-Names="Cambria" Font-Size="Small" Text="ISIN" Theme="BlackGlass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1">
                        <dx:ASPxTextBox ID="txtISIN" runat="server" BackColor="#E4E4E4" Theme="BlackGlass" Width="200px">
                            <ValidationSettings>
                                <RequiredField IsRequired="True" />
                            </ValidationSettings>
                        </dx:ASPxTextBox>
                ...
                <tr>
                    <td colspan="1">
                        <dx:ASPxLabel ID="ASPxLabel8" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Country Listed" Theme="BlackGlass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1">
                        <dx:ASPxComboBox ID="cmbCountryListed" runat="server" Theme="BlackGlass" ValueType="System.String" Width="200px">
                            <ValidationSettings>
                                <RequiredField IsRequired="True" />
                            </ValidationSettings>
                        </dx:ASPxComboBox>
                    ...
                    <td colspan="1">
                        <dx:ASPxLabel ID="ASPxLabel53" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Stock Exchange" Theme="BlackGlass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1">
                        <dx:ASPxComboBox ID="cmbstockexchange" runat="server" Theme="BlackGlass" ValueType="System.String" Width="200px">
                            <ValidationSettings>
                                <RequiredField IsRequired="True" />
                            </ValidationSettings>
                        </dx:ASPxComboBox>
                ...
                <tr>
                        ...
                        <td colspan ="7">
                            <dx:ASPxTextBox ID="txtRegdOffice1" runat="server" Theme="BlackGlass" Width="630px" BackColor="#E4E4E4">
                                  <ValidationSettings>
                            <RequiredField IsRequired="True" />
                        </ValidationSettings>
                            </dx:ASPxTextBox>
                ...
                <tr>
                    <td colspan ="1"></td>
                    <td colspan ="7">
                        <dx:ASPxTextBox ID="txtRegdOffice2" runat="server" BackColor="#E4E4E4" Theme="BlackGlass" Width="630px">
                        </dx:ASPxTextBox>
                    </td>
                ...
                <tr>
                    <td colspan ="1"></td>
                    <td colspan ="7">
                        <dx:ASPxTextBox ID="txtRegdOffice3" runat="server" BackColor="#E4E4E4" Theme="BlackGlass" Width="630px">
                        </dx:ASPxTextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td colspan ="7" style="height: 23px">
                        <dx:ASPxTextBox ID="txtRegdOffice4" runat="server" BackColor="#E4E4E4" Theme="BlackGlass" Width="630px">
                        </dx:ASPxTextBox>
                    </td>
                ...
                <tr>
                    <td colspan ="1">
                        <dx:ASPxLabel ID="ASPxLabel10" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Company Secretary" Theme="BlackGlass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan ="7">
                        <dx:ASPxTextBox ID="txtCompSecretary" runat="server" BackColor="#E4E4E4" Theme="BlackGlass" Width="630px">
                        </dx:ASPxTextBox>
                    </td>
            ...
            <asp:Panel runat="server" ID="panel6" Font-Names="Cambria" GroupingText="Shareholding" Visible="False">
