<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="SplitPostingAuth.aspx.vb" Inherits="Corp_SplitPostingAuth" title="Split Posting Authorization" %>

<%@ Register Assembly="DevExpress.Web.v13.2, Version=13.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxGridView" TagPrefix="dx" %>
<%@ Register Assembly="DevExpress.Web.v13.2, Version=13.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxEditors" TagPrefix="dx" %>

<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel id="Panel1" runat="server" Width="90%" Font-Names="Cambria" BackColor="White" GroupingText="Split Posting Authorization">
       <table>
           ...
           <tr id="Tr11a" runat="server">
                <td colspan="6">
                    <dx:ASPxGridView ID="grdPaymentsSplit" Width="100%" runat="server" KeyFieldName="ID" Settings-ShowTitlePanel="true" Theme="Glass" Visible="false">
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataColumn Caption="Total Split Shares">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel runat="server" Text='<%# Eval("Scaled_Shares") %>'>
                                        </dx:ASPxLabel>
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
                                <dx:GridViewDataColumn FieldName="Sharesc" Caption="Post Split Shares">
                                    <DataItemTemplate>
