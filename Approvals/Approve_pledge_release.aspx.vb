...
Partial Class _Default
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Session("end") = "Yes1" Then
                Session("end") = ""
                msgbox("Email Sent to Pledgee for Approval")
            Else
    ...
    Public Sub getlst()
        Try
            ...
            cmd = New SqlCommand("select CONVERT(varchar(10), id)+' '+ company+' '+ securitytype+' '+ CONVERT(varchar(10), Quantity ) as pleadgeinf, id from pledges_recording where Pledge_Status='A' and released is not null  and transferred is null and id not in (select pledge_id from Pledges_release where release_approval='Yes')", cn)
            adp = New SqlDataAdapter(cmd)
