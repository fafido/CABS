Partial Class Batch_Authorization
    ...
    Public Sub loadbatches()
        ...
        cmd = New SqlCommand("select b.batch_no as [Batch No],b.Company as [Company], b.Batch_Shares as [Batch Shares],b.security_type as [Security Type], convert(date,b.Batch_date) as [Date], b.Lodger as [Lodger],cc.company_name as [Broker] from Batch_receipt b, Client_Companies cc where cc.Company_Code= b.broker_code and b.balanced='1'  and b.verified='1' and b.successful='0' and b.company in (select company from para_company)", cn)
        adp = New SqlDataAdapter(cmd)
    ...
    Public Sub getcerts()
        Dim ds As New DataSet
        cmd = New SqlCommand("select id as [Entry ID], Batch_no as [Batch No],certificate_no as [Certificate No], cds_number as [CDS Number], shares as [Shares] from batch_certs where batch_no='" + txtbatchno.Text + "'", cn)
        adp = New SqlDataAdapter(cmd)
    ...
    Protected Sub ASPxButton2_Click(sender As Object, e As EventArgs) Handles ASPxButton2.Click
        If txtbatchtype.Text = "Allot" Then
            cmd = New SqlCommand("update batch_receipt set verified='2' where batch_no='" + txtbatchno.Text + "'", cn)
