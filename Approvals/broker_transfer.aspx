<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="broker_transfer.aspx.vb" Inherits="TransferSec_broker_transfer" title="Account Details Enquiry" %>
...
<asp:Panel runat="server" ID="panelSearch" Font-Names="Cambria" GroupingText="Search">
    <table>
        ...
        <table width="810px">
           ...
           <tr>
               <td colspan ="1">
                   <dx:ASPxLabel ID="ASPxLabel57" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Company" Theme="Glass">
                   </dx:ASPxLabel>
               </td>
               <td>
             ...
             <tr>
                 <td colspan="1">
                     <dx:ASPxLabel ID="ASPxLabel58" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Portfolio" Theme="Glass">
                     </dx:ASPxLabel>
                 </td>
                 <td>
