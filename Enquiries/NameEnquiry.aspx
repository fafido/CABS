<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="NameEnquiry.aspx.vb" Inherits="Enquiries_NameEnquiry" title="Name Enquiry" %>
...
<%@ Register Assembly="DevExpress.Web.v13.2, Version=13.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxSiteMapControl" TagPrefix="dx" %>
            ...
            <tr>
                <td style="width: 870px" align="center">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="Account Details Enquiry" width="848px"></asp:Label></td>
            </tr>
                <tr>
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 148px">
                        <asp:ListBox id="lstNames" runat="server" Height="59px" width="310px"></asp:ListBox></td>
                </tr>
                <tr>
                    <td style="width: 146px"></td>
            ...
            <table>
                ...
                <tr>
                    <td valign="top" style="width: 168px">
                        ...
                        <td>
                            <asp:TextBox id="txtAdd1" runat="server" font-bold="True" ReadOnly="True" 
                                Height="36px" TextMode="MultiLine" width="304px"></asp:TextBox></td>
                            <td></td>
                            <td>
                                </td>
                </tr>
                ...
                <tr>
                    <td valign="top" style="width: 168px; height: 41px;">
                        <asp:Label id="Label12" runat="server" Text="Other Contact Details" font-names="Verdana" font-size="Small"></asp:Label></td>
                        <td style="height: 41px">
                            <asp:TextBox id="txtEmail" runat="server" Enabled="False" font-bold="True" 
                                ReadOnly="True" Height="36px" TextMode="MultiLine" width="304px"></asp:TextBox></td>
                            <td style="height: 41px">
                                </td>
                                <td style="height: 41px">
                                    </td>
                ...
                <tr>
                    <td style="width: 168px">
                        ...
                        <td>
                            <asp:TextBox id="txtBank" runat="server" Enabled="False" font-bold="True" ReadOnly="True" width="304px"></asp:TextBox></td>
                            <td>
                                </td>
                                <td>
                                    </td>
                ...
                <tr>
                    <td style="width: 168px">
                        ...
                        <td>
                                    <asp:TextBox id="txtBranch" runat="server" Enabled="False" font-bold="True" ReadOnly="True" width="304px"></asp:TextBox></td>
                            <td>
                                </td>
                                <td>
                                    </td>
                ...
                <tr>
                    ...
                    <td>
                            <asp:TextBox id="txtBnkAccount" runat="server" Enabled="False" font-bold="True" ReadOnly="True" width="304px"></asp:TextBox></td>
                    <td></td>
                    <td></td>
                </tr>
                <tr>
