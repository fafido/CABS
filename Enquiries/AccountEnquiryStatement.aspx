<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="AccountEnquiryStatement.aspx.vb" Inherits="Enquiries_AccountEnquiryStatement" title="Account Details Enquiry" %>
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 148px">
                        <asp:ListBox id="lstNames" runat="server" Height="53px" width="328px"></asp:ListBox></td>
                </tr>
                <tr>
                    <td></td>
                    <td align="right">
