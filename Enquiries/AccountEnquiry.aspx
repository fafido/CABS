<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="AccountEnquiry.aspx.vb" Inherits="Enquiries_AccountEnquiry" title="Account Details Enquiry" %>
            ...
            <tr>
                <td style="width: 870px" align="center">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="Register Accounts  Enquiry" width="848px"></asp:Label></td>
            </tr>
            <tr>
