<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="AccountsEnquiryPortfolio.aspx.vb" Inherits="Enquiries_AccountsEnquiryPortfolio" title="Account Details Enquiry" %>
        ...
        <table width ="810px">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Enquiries>>Accounts Portfolio" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
...
<tr>
    ...
    <td colspan ="8" align="center">
        ...
        <asp:RadioButton ID="RadioButton4" runat="server" GroupName="SecuritiesType" Text="Tresuary Bills" />
         ...
         <asp:Panel runat="server" ID="Panel5" Font-Names="Cambria" GroupingText="Portfolio Summary" Font-Size="Medium">

                <table width="810px">
<tr>
        
    <td colspan ="8" align="center">
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" Theme="Office2003Blue" Width="475px"></dx:ASPxGridView>
        </td>
