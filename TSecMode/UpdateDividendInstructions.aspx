<%@ Page Language="VB" MasterPageFile="~/Tsec.master" AutoEventWireup="false" CodeFile="UpdateDividendInstructions.aspx.vb" Inherits="TsecMode_UpdateDividendInstructions" title="CDS Capture" %>
            ...
            <tr>
                ...
                <asp:Label ID="Label1" runat="server" Text="Div Number"></asp:Label></td>
                            <td colspan ="1">
                                &nbsp;</td>
                            <td colspan ="1">
                                <asp:DropDownList ID="cmbDivno" runat="server" AutoPostBack="True" 
                                    Width="245px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                ...
                <asp:Label ID="Label23" runat="server" Text="EFT"></asp:Label></td>
                            <td colspan ="1">
                                <asp:CheckBox ID="chkEft" runat="server" Text="EFT" AutoPostBack="True" />
                ...
                <asp:Label ID="Label36" runat="server" Text="Account No."></asp:Label></td>
                            <td colspan ="1">
                                &nbsp;</td>
                            <td colspan ="1">
                                <asp:TextBox ID="txtAccount" runat="server" Width="245px"></asp:TextBox>
                             </td>
                        </tr>
                        <tr>
                                <td colspan ="1"></td>
