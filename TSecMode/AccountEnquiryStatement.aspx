<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="AccountEnquiryStatement.aspx.vb" Inherits="TSecMode_AccountEnquiryStatement" title="Account Details Enquiry" %>
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 148px">
                        <asp:ListBox id="lstNames" runat="server" Height="49px" width="269px"></asp:ListBox></td>
                </tr>
                <tr>
                    <td></td>
                    <td align="center">
