<%@ Page Language="VB" MasterPageFile="~/TSec.master" AutoEventWireup="false" CodeFile="BatchVerification.aspx.vb" Inherits="TSecTrading_BatchVerification" title="Batch Receipting" %>
            ...
            <tr>
                <td style="width: 870px" align="center" colspan="2">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="Batch Verification" width="846px"></asp:Label></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="1" style="width: 68px">
                    <asp:Label id="Label1" runat="server" Text="Batch Type" font-names="Verdana" 
                        font-size="Small" width="124px"></asp:Label></td> 
                            <td colspan ="1" style="width: 473px">
            ...
            <tr>
                <td colspan="1" style="width: 68px">
                    <asp:Label id="Label11" runat="server" Text="Batching Date" 
                        font-names="Verdana" font-size="Small" width="124px"></asp:Label></td> 
                            <td colspan ="1" style="width: 473px">
            ...
            <tr>
                <td colspan="1" style="width: 68px">
                    <asp:Label id="Label13" runat="server" Text="Broker / Lodger ?" 
                        font-names="Verdana" font-size="Small" width="141px"></asp:Label></td> 
                            <td colspan ="1" style="width: 473px">
            ...
            <tr>
                <td colspan="1" style="width: 68px">
                    <asp:Label id="lblBroker" runat="server" Text="Broker/Lodger" 
                        font-names="Verdana" font-size="Small" width="133px"></asp:Label></td> 
                            <td colspan ="1" style="width: 473px">
            ...
            <tr>
                <td colspan="1" style="width: 68px">
                    <asp:Label id="Label15" runat="server" Text="Options" font-names="Verdana" 
                        font-size="Small" width="99px"></asp:Label></td> 
                            <td colspan ="1" style="width: 473px">
