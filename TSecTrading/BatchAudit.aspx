<%@ Page Language="VB" MasterPageFile="~/Tsec.master" AutoEventWireup="false" CodeFile="BatchAudit.aspx.vb" Inherits="TSecTrading_BatchAudit" title="Batch Audit" %>
        ...
        <td style="width: 712px; height: 226px" valign="top">
            ...
            <tr>
                <td  style="height: 21px;" colspan="2">
                    ...
                    <asp:Button id="btnDeclineBatch" runat="server" Text="Decline Batch" />
                    </td> 
            </tr>
            <tr>
                <td style="background-color: #ccccff">
            ...
            <tr>
                <td colspan="2">
                    ...
                    &nbsp;<asp:Button id="btnDeclineall" runat="server" Text="Decline All" />
                </td>
            </tr>
            <tr>
                <td></td>
