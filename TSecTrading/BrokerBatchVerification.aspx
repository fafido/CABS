<%@ Page Language="VB" MasterPageFile="~/TSec.master" AutoEventWireup="false" CodeFile="BrokerBatchVerification.aspx.vb" Inherits="TSecTrading_BrokerBatchVerification" title="Batch Verification" %>
        ...
        <td style="width: 712px; height: 226px" valign="top">
            ...
            <tr>
                <td style="width: 870px" align="center" colspan="2">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="Batch Verification" width="855px" Height="16px"></asp:Label></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="1" style="width: 15px; height: 22px;">
                    <asp:Label id="Label11" runat="server" Text="Batching Date" 
                        font-names="Verdana" font-size="Small" width="132px"></asp:Label></td> 
            ...
            <tr>
                <td><asp:Label id="Label1" runat="server" font-size="Small" font-names="Verdana" 
                        width="146px" Text="Batch Captured By"></asp:Label></td>
                <td>
