<%@ Page Language="VB" MasterPageFile="~/TSec.master" AutoEventWireup="false" CodeFile="CodeTSecBatchVerification.aspx.vb" Inherits="TSecTrading_CodeTSecBatchVerification" title="Batch Verification" %>
...
<table style="border-right: #000033 thin solid; border-top: #000033 thin solid; border-left: #000033 thin solid; width: 832px; border-bottom: #000033 thin solid; background-color: #ffffff">
    <tr>
        <td style="width: 712px; height: 226px" valign="top">
            ...
            <tr>
                <td style="width: 870px" align="center" colspan="2">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="T\Sec Batch Verification" width="872px"></asp:Label></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="1" style="width: 15px; height: 21px;">
                    <asp:Label id="Label11" runat="server" Text="Batching Date" 
                        font-names="Verdana" font-size="Small" width="122px" Height="16px"></asp:Label></td> 
            ...
            <tr>
                <td style="height: 25px"><asp:Label id="Label1" runat="server" font-size="Small" 
                        font-names="Verdana" width="164px" Text="Batch Captured By"></asp:Label></td>
