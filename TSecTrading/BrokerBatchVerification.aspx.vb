    ...
    Public Sub getBatch()
        Try
            ...
            If (ds.Tables(0).Rows.Count > 0) Then
                ...
                cmd = New SqlCommand("Select Company,Batch_Type,Shareholder as [Old Holder Number],Shares,Certificate,CD,CDS_Number,HolderNames from broker_Batch_Ref where batch_ref=" & lblbatchref.Text & " AND status='B'", cn)
                adp = New SqlDataAdapter(cmd)
