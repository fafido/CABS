Partial Class BA_receivables
    ...
    Public Sub GetDetails()
        Try
            Dim ds As New DataSet
            cmd = New SqlCommand("select * from bas ba,ba_mast bm,  Client_Companies c where bm.ba_number=ba.BA_number and c.Company_Code=ba.Issuer and ba.Issuer='" + Session("Brokercode") + "'", cn)
            adp = New SqlDataAdapter(cmd)
