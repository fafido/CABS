Partial Class BA_offers_deriv
    ...
    Public Sub GetDetails()
        Try
            Dim ds As New DataSet
            cmd = New SqlCommand("select * from offers o, client_companies c, Client_Companies c1, bas b where o.offer_by= c.Company_Code and c1.Company_Code=b.issuer and b.BA_number=o.ba_number and c1.company_code='" + Session("Brokercode") + "' and O.id not in (select offer_number from Accepted_offers)", cn)
            adp = New SqlDataAdapter(cmd)
