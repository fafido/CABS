            ...
            <tr  runat="server" visible="false">
             ...
             <tr > 
                    ...
                    <td align="center"  Width="100%" >
                        <dx:ASPxGridView ID="grdAvailableWRs"  Settings-verticalScrollBarMode="Auto" runat="server"  KeyFieldName="ID" Settings-ShowTitlePanel="true"  Theme="Glass" Width="100%">
                            ...
                            <Columns>
                                  ...
                                  <dx:GridViewDataColumn Caption="" VisibleIndex="0">
                                    <DataItemTemplate>
                                        <asp:LinkButton ID="otpenabled" runat="server" CommandArgument='<%# Eval("ID") %>' CommandName="Split"  Text="Split">
                                                              </asp:LinkButton>
                                    </DataItemTemplate>
                                  ...
                                  <dx:GridViewDataColumn Caption="WR#" Width="150px">
                                                         <DataItemTemplate>
                                                              <dx:ASPxLabel Text='<%# Eval("ReceiptNo") %>' runat="server"></dx:ASPxLabel>
                                                         </DataItemTemplate>
                                                    </dx:GridViewDataColumn>

                                      <dx:GridViewDataColumn Caption="Depositor Acc#">
                                                         <DataItemTemplate>
                                 ...
                                 <dx:GridViewDataColumn Caption="Grade">
                                      ...
                                      <dx:GridViewDataColumn Caption="Quantity"  CellStyle-HorizontalAlign="Right" >
                                                         <DataItemTemplate>
...
<%--                     <tr>
                    ...
                    <td align="center">
                        <dx:ASPxGridView ID="grdSplits" runat="server"  KeyFieldName="ID" Settings-ShowTitlePanel="true"  Theme="Glass" Width="100%">
                            <SettingsBehavior AllowSelectByRowClick="True" AllowSelectSingleRowOnly="True" ProcessSelectionChangedOnServer="True" />
                            <SettingsPager Visible="False">
                            </SettingsPager>
                            ...
                            <Columns>
                                  ...
                                  <dx:GridViewDataColumn Caption="WR#">
                                                         <DataItemTemplate>
                                                              <dx:ASPxLabel Text='<%# Eval("TransactionRef") %>' runat="server"></dx:ASPxLabel>
                                                         </DataItemTemplate>
                                                    </dx:GridViewDataColumn>

                                      <dx:GridViewDataColumn Caption="Suffix">
                                                         <DataItemTemplate>
                                                              <dx:ASPxLabel Text='<%# Eval("WRChildSuffix") %>' runat="server"></dx:ASPxLabel>
                                                         </DataItemTemplate>
                                                    </dx:GridViewDataColumn>
                                      <dx:GridViewDataColumn Caption="Split Quantity">
                                                         <DataItemTemplate>
                                                              <dx:ASPxLabel Text='<%# Eval("ChildQTY") %>' runat="server"></dx:ASPxLabel>
                                                         </DataItemTemplate>
                                                    </dx:GridViewDataColumn>
                     ...
                     <td colspan ="8">
                         ...
                         <asp:GridView ID="grdSplits" runat="server" BackColor="White"  Settings-ShowTitlePanel="true" SettingsText-Title="Transfers"
                        ...
                        <HeaderStyle CssClass="headerstyle" HorizontalAlign="right"  BackColor="#eafaf1" Font-Bold="True" ForeColor="#000" />
                        ...
                        <RowStyle CssClass="rowstyle" ForeColor="#000" />
                                 ...
                                 <asp:CommandField  ShowSelectButton="true" FooterStyle-HorizontalAlign="Center" SelectText="Edit"   />

                                                  <asp:BoundField DataField="id" Visible="false" HeaderText="ID" />
                      
                                                    <asp:BoundField DataField="TransactionRef"  Visible="false" HeaderText="TransactionRef" />
                                                 <asp:BoundField DataField="WRChildSuffix" HeaderText="Suffix"  ItemStyle-HorizontalAlign="Right" />
                                <asp:BoundField DataField="ChildQTY" HeaderText="Split Quantity" ItemStyle-HorizontalAlign="Right" />
...
<tr>
    ...
    <td align="center" colspan="2">&nbsp;</td>
                   ...
                   <td colspan="1">&nbsp;</td>
                    <td   align="left" colspan="1" style="width: 158px">
                        <dx:ASPxButton ID="ASPxButton12" runat="server" Text="Submit" Theme="BlackGlass">
                             <ClientSideEvents Click="function(s,e){ e.processOnServer = confirm('Are you sure you want to Split?');}" />  
                        </dx:ASPxButton>
                    </td>
        ...
        <asp:Panel ID="Panel9" runat="server" Enabled="True" Font-Names="Cambria" Font-Size="Medium" GroupingText="Pending">
            <table width="100%">
                  ...
                  <tr>
                    <td align="center">
                        ...
                        <dx:ASPxGridView ID="ASPxGridView3" runat="server" AutoGenerateColumns="true"  KeyFieldName="ReceiptNo" Theme="Glass" Width="100%">
                      
                        <Columns >
                                   <dx:GridViewDataColumn Caption="" VisibleIndex="0">
                                    <DataItemTemplate>
                                        <asp:LinkButton ID="otpenabled" runat="server" CommandArgument='<%# Eval("ReceiptNo") %>' CommandName="Re-Send"  Text="Resend OTP">
                                                              </asp:LinkButton>
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
                             ...
                             <dx:GridViewDataColumn Caption="" VisibleIndex="0">
                                    <DataItemTemplate>
                                        <asp:LinkButton ID="otpenabled" runat="server" CommandArgument='<%# Eval("ReceiptNo") %>' CommandName="OTP"  Text="Enter OTP">
                                                              </asp:LinkButton>
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn VisibleIndex="0" Caption="">
                                                                                           <DataItemTemplate>
                                                              <asp:LinkButton ID="DeleteID" Text="Cancel Transaction" CommandName="Delete" OnClientClick="if ( !confirm('Are you sure you want to delete ? ')) return false;" CommandArgument='<%# Eval("ReceiptNo") %>' runat="server">
                                                              </asp:LinkButton>
                                                         </DataItemTemplate>
                                                    </dx:GridViewDataColumn>
         ...
         <asp:Panel ID="Panel3" runat="server" Enabled="True" Font-Names="Cambria" Font-Size="Medium" GroupingText="Approved">
            <table width="100%">
                 <tr>
                         <td align="center">
...
<dx:PopupControlContentControl runat="server" SupportsDisabledAttribute="True">
    <dx:ASPxRoundPanel ID="ASPxRoundPanel6" BackColor="White" runat="server" ShowHeader="False"  Width="100%">
        <panelcollection>
            ...
            <table  width="810px">
                <tr runat="server" id="h" visible="false"> 
                        <td align="RIGHT" >
                   ...
                   <tr  runat="server" id="k" visible="false">
                       <td colspan="1">  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </td>
                       

                        <%--<td align="left" >
                            <dx:ASPxButton ID="" runat="server" Text="Confirm" Theme="BlackGlass">
                            </dx:ASPxButton>
                        </td>--%>
                           <td colspan="1"></td>
                        <td colspan="1"></td>
