...
Partial Class BA_broadcast
    ...
    Public Sub GetDetails()
        Try
            Dim ds As New DataSet
            cmd = New SqlCommand("select * from Bas b, Client_Companies c where c.Company_Code=b.issuer and b.Ba_Status=0 and b.Expired=0 and issuer='" + Session("Brokercode") + "' and b.broadcast='0'", cn)
            adp = New SqlDataAdapter(cmd)
    ...
    Protected Sub grdEvent0_SelectedIndexChanged(sender As Object, e As EventArgs) Handles grdEvent0.SelectedIndexChanged
        cmd = New SqlCommand("update bas set broadcast='1' where id='" + grdEvent0.SelectedValue.ToString + "'", cn)
    ...
    Public Sub sendmail()
        ...
        Try
            ...
            If (ds.Tables(0).Rows.Count > 0) Then
                ...
                Mail.Body = "BA " + grdEvent0.SelectedValue.ToString + " has been successfully broadcasted."
