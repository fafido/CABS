<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="TSecBatchVerification.aspx.vb" Inherits="Trading_BrokerBatchVerification" title="Batch Verification" %>
                        ...
                        <table>
                            <tr align="center">                                                             
                                <td style="width: 276px; border-right: #cccccc thin solid; border-top: #cccccc thin solid; border-left: #cccccc thin solid; border-bottom: #cccccc thin solid;">
                                    <asp:Button id="btnForward" runat="server" Text="Immobilize Account" /></td>
