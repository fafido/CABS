<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="BrokerBatchVerification.aspx.vb" Inherits="Trading_BrokerBatchVerification" title="Batch Verification" %>
...
<table style="border-right: #000033 thin solid; border-top: #000033 thin solid; border-left: #000033 thin solid; width: 832px; border-bottom: #000033 thin solid; background-color: #ffffff">
    <tr>
        <td style="width: 712px; height: 226px" valign="top">
            ...
            <tr>
                <td style="width: 870px" align="center" colspan="2">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="Batch Verification" width="851px"></asp:Label></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="height: 23px"><asp:Label id="Label1" runat="server" font-size="Small" font-names="Verdana" width="128px" Text="Batch Captured By"></asp:Label></td>
                ...
                <tr align="center">
                    <td style="width: 425px">
                        <asp:CheckBox id="CheckBox2" runat="server" autopostback="True" 
                            font-names="Arial" font-size="Small" Text="Decline batch" />
                    </td>
                </tr>
                <tr align="center">
                    <td style="width: 425px">
                        <asp:Label id="Label13" runat="server" Text="Rejection Reason" Visible="False"></asp:Label>
                        <asp:TextBox id="txtRejectionReason" Visible="false" TextMode ="MultiLine" 
                            runat="server" Height="51px" width="346px"></asp:TextBox>
                        &nbsp;</td>
                </tr>
            </table>
           </center>
                        ...
                        <table>
                            <tr align="center">                                                             
                                <td style="width: 276px; border-right: #cccccc thin solid; border-top: #cccccc thin solid; border-left: #cccccc thin solid; border-bottom: #cccccc thin solid;">
                                    <asp:Button id="btnForward" runat="server" Text="Forward Batch" /></td>
