<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="MasttempVerification.aspx.vb" Inherits="Trading_MasttempVerification" title="MAST - TEMP VERIFICATION BEFORE UPLOAD" %>
        ...
        <td style="width: 712px; height: 226px" valign="top">
            ...
            <tr>
                <td style="width: 66px; height: 11px;">
                    <asp:Label id="Label3" runat="server" Text="Select Company" font-names="Verdana" font-size="Small" width="112px"></asp:Label></td> 
            ...
            <tr>
                <td style="width: 66px">
                    <asp:Label id="Label11" runat="server" Text="Current Share Capital" font-names="Verdana" font-size="Small" width="144px"></asp:Label></td> 
                            <td colspan ="1" style="width: 473px">
                                <asp:Label id="LblBatchDate" runat="server"></asp:Label></td>                   
            </tr>
                <tr>
                <td style="width: 66px">
                    <asp:Label id="Label12" runat="server" Text="Pending Upload Shares " font-names="Verdana" font-size="Small" width="152px"></asp:Label></td> 
                            <td style="width: 473px">
