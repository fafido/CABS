<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="TransferBatch.aspx.vb" Inherits="Trading_TransferBatch" title="Batch Receipting" %>
        ...
        <td style="width: 712px; height: 226px" valign="top">
            ...
            <tr>
                <td style="width: 870px" align="center" colspan="2">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="Transfer Batch Processing" width="872px"></asp:Label></td>
            </tr>
            <tr>
                <td style="width: 47px">
                ...
                <td  style="width: 47px">
                    <asp:Label id="Label2" runat="server" font-names="Verdana" font-size="Small" Text="holder Number Search"
                        width="120px"></asp:Label></td> 
                            <td colspan ="1" style="width: 473px">
                                &nbsp;<asp:TextBox id="txtHolderSearch" runat="server"></asp:TextBox>
                                <asp:Button id="btnNumSearch" runat="server" Text=">>" /></td>                   
            </tr>
            <tr>
                <td style="width: 47px">
                    <asp:Label id="Label5" runat="server" font-names="Verdana" font-size="Small" Text="Name Search"
                        width="88px"></asp:Label></td> 
                            <td colspan ="1" style="width: 473px">
                                ...
                                <asp:Button id="btnNameSearch" runat="server" Text=">>" /></td>                   
            </tr>
            <tr>
                <td  style="width: 47px">
                    <asp:Label id="Label6" runat="server" font-names="Verdana" font-size="Small" Text="Batch Shares"
                        width="88px"></asp:Label></td> 
                            <td colspan ="1" style="width: 473px">
                                &nbsp;<asp:ListBox id="lstNames" runat="server" width="416px"></asp:ListBox></td>                                                   
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp;
                    <asp:Button id="btnDelFrom" runat="server" Text="Remove Holder" /></td>
            </tr>
            ...
            <tr>
                <td  style="width: 47px">
                    <asp:Label id="Label10" runat="server" font-names="Verdana" font-size="Small" Text="holder Number Search"
                        width="120px"></asp:Label></td> 
                            <td colspan ="1" style="width: 473px">
                                &nbsp;<asp:TextBox id="txtToHolderNum" runat="server"></asp:TextBox>
                                <asp:Button id="btnHolderNumto" runat="server" Text=">>" /></td>                   
            </tr>
            <tr>
                <td style="width: 47px">
                    <asp:Label id="Label13" runat="server" font-names="Verdana" font-size="Small" Text="Name Search"
                        width="88px"></asp:Label></td> 
                            <td colspan ="1" style="width: 473px">
                                &nbsp;<asp:TextBox id="txtHolderNameTo" runat="server"></asp:TextBox>
                                <asp:Button id="btnHolderNameto" runat="server" Text=">>" /></td>                   
            </tr>
            <tr>
                <td  style="width: 47px">
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp;
                    <asp:Button id="btnDelto" runat="server" Text="Remove Holder" /></td>
            </tr>
            <tr>
                <td></td>
                <td align="center">
