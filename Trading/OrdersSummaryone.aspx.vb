Partial Class Trading_OrdersSummaryone
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            Dim OrderNum As String = Request.QueryString("OrderNumber")
            myreport = New CrystalDecisions.CrystalReports.Engine.ReportDocument()
            myreport.Load(Server.MapPath("..\Trading\SingleOrderReport.rpt"))
            ...
            myDiscreteValue.Value = OrderNum
