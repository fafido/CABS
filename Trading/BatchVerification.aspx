<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="BatchVerification.aspx.vb" Inherits="Trading_BatchVerification" title="Batch Receipting" %>
...
<table style="border-right: #000033 thin solid; border-top: #000033 thin solid; border-left: #000033 thin solid; width: 832px; border-bottom: #000033 thin solid; background-color: #ffffff">
    <tr>
        <td style="width: 712px; height: 226px" valign="top">
            ...
            <tr>
                <td style="width: 870px" align="center" colspan="2">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="Batch Verification" width="872px"></asp:Label></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="1" style="width: 68px">
                    <asp:Label id="Label13" runat="server" Text="Broker / Lodger ?" font-names="Verdana" font-size="Small" width="120px"></asp:Label></td> 
                            <td colspan ="1" style="width: 473px">
            ...
            <tr>
                <td colspan="1" style="width: 68px">
                    <asp:Label id="lblBroker" runat="server" Text="Broker/Lodger" font-names="Verdana" font-size="Small" width="80px"></asp:Label></td> 
                            <td colspan ="1" style="width: 473px">
