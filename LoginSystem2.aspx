<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LoginSystem2.aspx.vb" Inherits="_LoginSystem2" %>
...
<asp:Label id="Label8" runat="server" font-names="Verdana" font-size="Small" 
                        ...
                        <td align="left">
<asp:TextBox id="txtConfirmPassword" runat="server" TextMode="Password" width="144px" Height="22px"></asp:TextBox>
