<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="frmViewEvents.aspx.vb" Inherits="frmViewEvents" title="Untitled Page" %>
            ...
            <td style="width: 712px; height: 226px" valign="top" __designer:mapid="221">
                <table __designer:mapid="222">
                    <tr __designer:mapid="223">
                        ...
                        Text="View Event Calendar" width="848px"></asp:Label>
                        </td>
                    </tr>
                </table>
                <table __designer:mapid="226" style="width: 511px">
                    <tr>
                        <td align="left" __designer:mapid="228" colspan="2">
                            <asp:RadioButtonList id="RadioButtonList1" runat="server" Height="16px" 
                                RepeatDirection="Horizontal" 
                                style="font-family: Verdana; font-weight: 700; font-size: small; text-align: center" 
                                width="467px">
                                <asp:ListItem>All</asp:ListItem>
                                <asp:ListItem>Past events</asp:ListItem>
                                <asp:ListItem>Current / Future Events</asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                    ...
                    <tr __designer:mapid="231">
                        <td align="left" __designer:mapid="232" colspan="2" style="text-align: center">
                            <asp:Button id="btnSave" runat="server" Text="View" width="64px" 
