Partial Class Reporting_ClientAccountStatementReport
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Dim cdsno As String = Request.QueryString("cdsno")
            ...
            myReport.Load(Server.MapPath("..\Reporting\AccountsStatementByClientNew.rpt"))
