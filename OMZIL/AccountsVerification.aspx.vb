Partial Class TransferSec_AccountsVerification
    ...
    Public Sub GetPendingAccounts()
        Try
            ...
            cmd = New SqlCommand("select cds_number+' '+surname+' '+forenames as namess from Accounts_audit where AuthorizationState='O'", cn)
    ...
    Public Sub getAccountDetails()
        Try
            ...
            If (ds.Tables(0).Rows.Count > 0) Then
                ...
                txtDOB.Text = FormatDateTime(ds.Tables(0).Rows(0).Item("DOB").ToString, DateFormat.ShortDate)
