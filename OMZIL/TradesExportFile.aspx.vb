...
Partial Class BrokerMode_TradesExportFile
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        cmd = New SqlCommand("SELECT convert(varchar,tbl_SettlementSummary.Settlement_date,120) as settlement_date , Accounts_Clients.Div_Branch , Accounts_Clients.Div_AccountNo  ,Accounts_Clients.Surname +' '+ Accounts_Clients.Forenames AS AccountName , tbl_SettlementSummary.Amount_due,'USD' AS USD FROM tbl_SettlementSummary , Accounts_Clients where tbl_SettlementSummary .cds_number = Accounts_Clients.CDS_Number and tbl_SettlementSummary .OrderType ='S' AND Eft_File_Status='O' ", cn)
