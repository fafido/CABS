<%@ Page Language="VB" MasterPageFile="~/BrokerAdministration.master" AutoEventWireup="false" CodeFile="AdministratorsHome.aspx.vb" Inherits="Administration_AccountCreation" title="Account Creation" %>
            ...
            <tr>
                <td style="width: 870px" align="center">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="Administration Login" width="848px"></asp:Label></td>
            </tr>
                <tr>
                    <td colspan ="4" valign="top">
                        <asp:Label id="Label1" runat="server" Text="User:" width="144px" font-names="Verdana" font-size="Small" Visible="False"></asp:Label>
