...
Partial Class BrokerMode_AccountCodeUpdateApproval
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            'msgbox(Trim(ds.Tables(0).Rows(0).Item("ActivationCode").ToString))

            If (ds.Tables(0).Rows(0).Item("Activationcode").ToString = TextBox1.Text) Then
                If (ds.Tables(0).Rows.Count > 0) Then
                    ...
                    cmd = New SqlCommand("Update pre_names_creation set Approved=1 where cds_number='" & cmbCdsNumber.Text & "' and brokercode='" & Session("BrokerCode") & "' ", cn)
                    If (cn.State = ConnectionState.Open) Then
                        cn.Close()
                    End If
                    cn.Open()
