<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="AccountCreation.aspx.vb" Inherits="BrokerMode_AccountCreation" title="Account Creation" %>
                ...
                <td style="width: 712px; height: 226px" valign="top">
                    ...
                    <table style="width: 838px">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList id="cmbIndustry" runat="server" width="187px" AutoPostBack="True">
                                </asp:DropDownList>
                            </td>
                            <td style="width: 172px">
