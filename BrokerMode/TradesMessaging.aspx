<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="TradesMessaging.aspx.vb" Inherits="BrokerMode_TradesMessaging" title="Broker Home" %>
...
<table style="border-right: #000033 thin solid; border-top: #000033 thin solid; border-left: #000033 thin solid; width: 832px; border-bottom: #000033 thin solid; background-color: #ffffff">
    <tr>
        <td style="width: 712px; height: 226px" valign="top">
            ...
            <tr>
                <td colspan ="1">
                    <dx:ASPxLabel ID="ASPxLabel36" runat="server" Text="Messaging Platform" Theme="Office2010Blue">
                    </dx:ASPxLabel>
                </td>
                <td colspan ="1">
                ...
                <td colspan ="1"></td>
                   ...
                   <tr>
                <td colspan ="1">
                    <dx:ASPxLabel ID="ASPxLabel37" runat="server" Text="Messaging Format" Theme="Office2010Blue">
                    </dx:ASPxLabel>
                       </td>
                <td colspan ="1">
                    &nbsp;</td>
