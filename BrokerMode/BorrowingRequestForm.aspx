<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="BorrowingRequestForm.aspx.vb" Inherits="BrokerMode_BorrowingRequestForm" title="Broker Home" %>
    ...
    <tr>
        <td style="width: 712px; height: 226px" valign="top">
            ...
            <table>
                ...
                <tr>
                        <td colspan ="1">
                            <dx:ASPxButton ID="ASPxButton2" runat="server" Text="previous" Theme="SoftOrange" Width="85px">
                            </dx:ASPxButton>
                        </td>
                    <td colspan ="1"></td>
                    <td colspan ="1"></td>
