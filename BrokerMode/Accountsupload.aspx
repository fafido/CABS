<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="Accountsupload.aspx.vb" Inherits="BrokerMode_Accountsupload" title="Accounts Upload" %>
        ...
        <td style="width: 712px; height: 226px" valign="top">
            ...
            <asp:Panel runat="server" ID="PanelASet" Font-Names="Cambria" GroupingText="Upload File">
                 <table>
                     <tr>
                            <td colspan ="1">
                                <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="Company" Theme="Glass">
                                </dx:ASPxLabel>
                            </td>
                         <td colspan ="1">
