<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="AccountCodeUpdateApproval.aspx.vb" Inherits="BrokerMode_AccountCodeUpdateApproval" title="Account Creation" %>
...
Text="Accounts Update Approval Form" width="786px"></asp:Label></td>
</tr>
<tr>
<td valign="top">
<asp:Label id="Label1" runat="server" Text="Shareholder Number:" width="169px" 
...
<asp:Label id="Label32" runat="server" Text="Activation Code" font-names="Verdana" font-size="Small"></asp:Label></td>
<td>
</td>
<td>
</td>
...
<table>
<tr>
<td colspan ="1" style="width: 315px">
...
<td colspan ="1" style="width: 453px">
