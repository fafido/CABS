<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="TradesExportFile.aspx.vb" Inherits="BrokerMode_TradesExportFile" title="Trades File Generation" %>
      ...
      <%--      <tr>
                ...
                <tr><td colspan="5"> <asp:GridView ID="grdData1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="850px">
                            <Columns>
                                ...
                                <asp:BoundField DataField="From Branch" HeaderText="From Branch" />
                                <asp:BoundField DataField="From Account No" HeaderText="From Account No" />
                                <asp:BoundField DataField="From Account Name" HeaderText="From Account Name" />
                                <asp:BoundField DataField="To Branch" HeaderText="To Branch" />
                                <asp:BoundField DataField="To Account No" HeaderText="To Account No" />
                                <asp:BoundField DataField="To Account Name" HeaderText="To Account Name" />
                                <asp:BoundField DataField="AMOUNT" HeaderText="AMOUNT" />
                                <asp:BoundField DataField="USD" HeaderText="Currency" />
                            </Columns>
