        ...
        <table width ="810px">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Reporting&gt;&gt;Settlement" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
        ...
        <table width="810px">
            ...
            <tr>
                <td colspan="1" style="width: 109px; height: 23px;">
                    <dx:ASPxLabel ID="ASPxLabel14" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Report Currency" Theme="Glass">
                    </dx:ASPxLabel>
                </td>
                ...
                <td colspan="1" style="height: 23px; width: 359px">
