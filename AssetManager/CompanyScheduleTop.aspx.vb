Partial Class Reporting_CompanyScheduleTop
        ...
        Try
            ...
            If (holderType = 5) Then
                If Session("Companytype") = "CUSTODIAN" Then
                    ...
                    Dim Top As Integer = Request.QueryString("Top")

                    myreport = New CrystalDecisions.CrystalReports.Engine.ReportDocument()
                    myreport.Load(Server.MapPath("..\Reporting\CompanyTopcust.rpt"))
                    ...
                    myParameterField3.ParameterFieldName = "pcust"
                ...
                ElseIf Session("Companytype") = "CDS" Or Session("Companytype") = "TSec" Then
                    ...
                    myreport = New CrystalDecisions.CrystalReports.Engine.ReportDocument()
                    myreport.Load(Server.MapPath("..\Reporting\CompanyTop.rpt"))
