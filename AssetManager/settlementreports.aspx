        ...
        <table width="810px">
            <tr>
                <td align="center" class="dxcpCurrentColor_PlasticBlue" style="height: 46px">
                    ...
                    <dx:ASPxButton ID="ASPxButton2" runat="server" BackColor="#6699FF" Text="Settlement Report" Theme="iOS" Width="322px">
                    </dx:ASPxButton>
                </td>
            </tr>
            <tr>
                <td align="center" class="dxcpCurrentColor_PlasticBlue" style="height: 46px">
                    <dx:ASPxButton ID="ASPxButton3" runat="server" BackColor="#6699FF" Text="Settlement" Theme="iOS" Width="322px">
                    </dx:ASPxButton>
                </td>
            </tr>
            <tr>
                <td align="center" class="dxcpCurrentColor_PlasticBlue" style="height: 46px">
                    <dx:ASPxButton ID="ASPxButton4" runat="server" BackColor="#6699FF" Text="Settlement By Broker" Theme="iOS" Width="322px">
                    </dx:ASPxButton>
                </td>
            </tr>
            <tr>
                <td align="center" class="dxcpCurrentColor_PlasticBlue" style="height: 46px">
                    <dx:ASPxButton ID="ASPxButton9" runat="server" BackColor="#6699FF" Text="Consolidated Summary By Broker" Theme="iOS" Width="322px">
                    </dx:ASPxButton>
                </td>
            </tr>
            <tr>
                <td align="center" class="dxcpCurrentColor_PlasticBlue" style="height: 46px">
                    <dx:ASPxButton ID="ASPxButton8" runat="server" BackColor="#6699FF" Text="Consolidated Delivery" Theme="iOS" Width="322px">
                    </dx:ASPxButton>
                </td>
            </tr>
            <tr>
                <td align="center" class="dxcpCurrentColor_PlasticBlue" style="height: 58px">
                    <dx:ASPxButton ID="ASPxButton10" runat="server" BackColor="#6699FF" Text="Broker Settlement Report" Theme="iOS" Width="322px">
                    </dx:ASPxButton>
                </td>
            </tr>
            <tr>
                <td align="center" class="dxcpCurrentColor_PlasticBlue" style="height: 58px">
                    <dx:ASPxButton ID="ASPxButton13" runat="server" BackColor="#6699FF" Text="Incoming Trades" Theme="iOS" Width="322px">
                    </dx:ASPxButton>
                </td>
            </tr>
            <tr>
