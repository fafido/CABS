...
Partial Class Reporting_rptparticipantlist
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            Dim companytype As String = Request.QueryString("Participant")
            ...
            myReport.Load(Server.MapPath("..\Reporting\rptparticipantlist.rpt"))
            ...
            myParameterField.ParameterFieldName = "companytype"
            myDiscreteValue.Value = companytype
