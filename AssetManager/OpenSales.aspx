    ...
    <asp:Panel id="Panel1" runat="server" Width="840px" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width="810px">
            <tr>
                <td></td>
                <td>
                    <asp:RadioButton ID="rdOpenSale" runat="server" AutoPostBack="True" GroupName="SalesPurchases" Text="Sales" />
                    <asp:RadioButton ID="rdPurchasesOpen" runat="server" AutoPostBack="True" GroupName="SalesPurchases" Text="Purchases" />
                </td>
                <td></td>
                <td></td>
                <td></td>
