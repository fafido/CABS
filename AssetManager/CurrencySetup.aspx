...
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder1">
    ...
    <tr>
        <td  align="left" style="height: 18px;" colspan="3">
            <dx1:ASPxLabel ID="ASPxLabel8" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Parameters&gt;&gt;Currency Setup" Theme="PlasticBlue"></dx1:ASPxLabel>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="height: 107px;" colspan="2">
            <asp:GridView ID="grdvCurrencies" runat="server" AutoGenerateSelectButton="True" CellPadding="4" ForeColor="#333333" GridLines="None" Width="782px">
