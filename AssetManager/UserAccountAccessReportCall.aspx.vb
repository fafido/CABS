...
Partial Class Reporting_UserAccountAccessReportCall
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
        Try
            Dim usern As String = Request.QueryString("Usern")
            myreport = New CrystalDecisions.CrystalReports.Engine.ReportDocument()
            myreport.Load(Server.MapPath("..\Reporting\UserAccessReport.rpt"))
            ...
            myParameterField.ParameterFieldName = "pUser"
            myDiscreteValue.Value = usern
