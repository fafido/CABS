<%@ Page Title="" Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="bi.aspx.vb" Inherits="Reporting_bi" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel id="Panel1" runat="server" Width="840px" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <asp:panel id="Panel5" runat="server" GroupingText="Business Intelligence" Font-Names="Cambria">
        <table width="810px">
            <tr>
                <td align="center" class="dxcpCurrentColor_PlasticBlue" style="height: 46px">
                    <dx:ASPxComboBox ID="ASPxComboBox1" runat="server" Theme="iOS">
                        <Items>
            ...
            <tr>
                <td align="center" class="dxcpCurrentColor_PlasticBlue" style="height: 46px">
                    <dx:ASPxButton ID="ASPxButton1" runat="server" BackColor="#6699FF" target="_blank" Text="Load" Theme="iOS" Width="173px">
                    </dx:ASPxButton>
                </td>
            </tr>
            <tr>
