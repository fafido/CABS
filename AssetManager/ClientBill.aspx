<%@ Page Title="" Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="ClientBill.aspx.vb" Inherits="Reporting_ClientBill" %>
        ...
        <table width ="810px">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Reporting&gt;&gt;Client Bill Statement" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
        ...
        <table width="810px">
            <tr>
                <td colspan ="1" align="right">
                    <dx:ASPxLabel ID="ASPxLabel15" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Search Type" Theme="Glass">
                    </dx:ASPxLabel>
                </td>
                <td colspan ="1" width="301">
                    <asp:RadioButtonList ID="RadioButtonList1" runat="server" Font-Size="Small" RepeatDirection="Horizontal">
                        <asp:ListItem>Individual Bills</asp:ListItem>
                        <asp:ListItem>Group Bills</asp:ListItem>
                    </asp:RadioButtonList>
                </td>
                <td colspan ="1">
                    &nbsp;</td>
             ...
             <tr>
                 ...
                 <td colspan="1">&nbsp;</td>
                 <td colspan="1">
                     <dx:ASPxButton ID="btnSearch" runat="server" CausesValidation="false" Text="&gt;&gt;" Theme="BlackGlass" Width="80px">
                     </dx:ASPxButton>
                 </td>
                 <td colspan="1"></td>
            </tr>
