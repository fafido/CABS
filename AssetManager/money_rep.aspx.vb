...
Partial Class Money_Rep
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            Dim datefrom As String = Request.QueryString("fdate")
            Dim dateto As String = Request.QueryString("tdate")
            ...
            myReport = New CrystalDecisions.CrystalReports.Engine.ReportDocument()
                ...
                myReport.Load(Server.MapPath("..\Reporting\money_market.rpt"))
