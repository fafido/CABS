<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="PledgeReporting.aspx.vb" Inherits="Reporting_PledgeReporting" title="Account Details Enquiry" %>
            ...
            <tr>
                <td style="width: 870px" align="center">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="Holder Movement Report" width="848px"></asp:Label></td>
            </tr>
            <tr>
            ...
            <table>
                <tr>
                    <td style="width: 146px">
                        <asp:Label id="Label1" runat="server" Text="Shareholder Number:" 
                            font-names="Verdana" font-size="Small" width="144px"></asp:Label></td>
                        <td style="width: 3px">
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 148px">
                        <asp:ListBox id="lstNames" runat="server" Height="59px" width="301px"></asp:ListBox></td>
                </tr>
                <tr>
                    <td></td>
                    <td align="right">
