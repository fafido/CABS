<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="ConsolFinalPosting.aspx.vb" Inherits="Corp_ConsolFinalPosting" title="Consolidation Final Authorization" %>

<%@ Register Assembly="DevExpress.Web.v13.2, Version=13.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxGridView" TagPrefix="dx" %>
<%@ Register Assembly="DevExpress.Web.v13.2, Version=13.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxEditors" TagPrefix="dx" %>

<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel id="Panel1" runat="server" Width="70%" Font-Names="Cambria" BackColor="White" GroupingText="Consolidation Final Authorization">
       <table>
           ...
           <tr id="PanelSAVE" runat="server" visible="false">
                        ...
                        <td style="width:212px">
                            &nbsp;<dx:ASPxButton ID="btnCompute" runat="server" Text="Final Authorization" Theme="Glass">
                            </dx:ASPxButton>
                        </td>
                </tr>
        </table> 
