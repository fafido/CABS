<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="brokers.aspx.vb" Inherits="Parameters_brokers" title="Create Broker" %>
        ...
        <table width ="810px">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Parameters&gt;&gt;Broker" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>

                   </td>
            </tr>
        </table>
        <asp:Panel runat="server" ID="Panel5" Font-Names="Cambria" GroupingText="Create Broker">

                <table width="810px">
                    <tr>
                        <td colspan="1">
                            <dx:ASPxLabel ID="ASPxLabel7" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Broker Code" Theme="Glass">
                                  </dx:ASPxLabel>
                        </td>
                        <td colspan="1">
                    ...
                    <tr>
                        ...
                        <td style="height: 18px">
                            ...
                            <Columns>
                                  ...
                                  <dx:GridViewDataColumn Caption="Broker Code">
                                                         <DataItemTemplate>
                                                              <dx:ASPxLabel Text='<%# Eval("broker_code") %>' runat="server"></dx:ASPxLabel>
                                                         </DataItemTemplate>
                                                    </dx:GridViewDataColumn>
