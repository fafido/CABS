<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="tsec.aspx.vb" Inherits="Parameters_tsec" title="Create Transfer Secretary" %>
        ...
        <table width ="810px">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Parameters>>Transfer Secretary" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>

                   </td>
            </tr>
        </table>
        <asp:Panel runat="server" ID="Panel5" Font-Names="Cambria" GroupingText="Add Transfer Secretary">

                <table width="810px">
                    <tr>
                        <td colspan="1">
                            <dx:ASPxLabel ID="ASPxLabel7" runat="server" Font-Names="Cambria" Font-Size="Small" Text="TSec Code" Theme="Glass">
                                  </dx:ASPxLabel>
                        </td>
                        <td colspan="1">
                    ...
                    <tr>
                        <td colspan ="1">
                            <dx:ASPxLabel ID="ASPxLabel22" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Name" Theme="Glass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan ="1">
                    ...
                    <tr>
                        ...
                        <td style="height: 18px">
                            ...
                            <Columns>
                                  ...
                                  <dx:GridViewDataColumn Caption="TSec Code">
                                                         <DataItemTemplate>
                                                              <dx:ASPxLabel Text='<%# Eval("Code") %>' runat="server"></dx:ASPxLabel>
                                                         </DataItemTemplate>
                                                    </dx:GridViewDataColumn>
