Partial Class Parameters_redemptioninstr
    ...
    Protected Sub ASPxButton7_Click(sender As Object, e As EventArgs) Handles ASPxButton7.Click
        ...
        If txtDesc.Text <> "" Then
            cmd = New SqlCommand("insert into capital_repayment_instr (issuer, issue_no, payment_No, date_declared, date_closed, date_payment, rate, mess_1, mess_2,bank_accno, datecreated, createdby, authorized) values ('" + cmbsecurity.SelectedItem.Value.ToString + "',1," + txtpaymentNo.Text + ",NULL,NULL,'" + cmbpaymentsdate.Text + "',NULL,'" + txtDesc.Text + "','','255647',getdate(),'" + Session("Username") + "',0)", cn)
