<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="ChargeType.aspx.vb" Inherits="TransferSec_ChargesParameters" title="Charges setup" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel id="Panel1" runat="server" Width="100%" Font-Names="Cambria" BackColor="White" GroupingText="Charges setup">
       <table style="width:100%">
           ...
           <tr id="PanelSAVE" runat="server">
                        ...
                        <td style="width:212px">
                            &nbsp;<dx:ASPxButton ID="btnSaveCharge" runat="server" Width="164px" Text="Save" Theme="Glass">
                            </dx:ASPxButton>
                        </td>
                </tr>
           ...
           <tr id="panel00002" runat="server">
              <td colspan="4" style="height: 18px;">
                    <dx:ASPxLabel ID="ASPxLabel25" runat="server" Font-Names="Cambria" Font-Size="Small" Font-Bold="true" Text="List of Pending Charges" Theme="Glass">
                    </dx:ASPxLabel>
                    <hr/>
                </td>
              </tr>
           <tr id="panel00003" runat="server">
                <td colspan="4" style="height: 18px">
                    <dx:ASPxGridView ID="grdChargesCreated" SettingsPager-Mode="ShowAllRecords" runat="server" KeyFieldName="ID" Theme="Glass" Width="100%">
                        ...
                        <Columns >
                            ...
                            <dx:GridViewDataColumn HeaderStyle-Font-Bold="true" Caption="Charge Name">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel Text='<%# Eval("Name") %>' runat="server"></dx:ASPxLabel>
                                    </DataItemTemplate>
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn HeaderStyle-Font-Bold="true" Caption="Charge Type">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel Text='<%# Eval("ChargeType") %>' runat="server"></dx:ASPxLabel>
                                    </DataItemTemplate>
                            </dx:GridViewDataColumn>
                                 <dx:GridViewDataTextColumn HeaderStyle-Font-Bold="true" Name="Range From" FieldName="RangeFrom" PropertiesTextEdit-DisplayFormatString="n">    </dx:GridViewDataTextColumn>
                               <dx:GridViewDataTextColumn HeaderStyle-Font-Bold="true" Name="Range To" FieldName="RangeTo" PropertiesTextEdit-DisplayFormatString="n">    </dx:GridViewDataTextColumn>
                              <dx:GridViewDataColumn HeaderStyle-Font-Bold="true" Caption="Range Currency">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel Text='<%# Eval("Currency") %>' runat="server"></dx:ASPxLabel>
                                    </DataItemTemplate>
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn HeaderStyle-Font-Bold="true" Caption="Charge Sub. Type">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel Text='<%# Eval("ChargeSUBType") %>' runat="server"></dx:ASPxLabel>
                                    </DataItemTemplate>
                            </dx:GridViewDataColumn>
                                  <dx:GridViewDataColumn HeaderStyle-Font-Bold="true" Caption="Charge Currency">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel Text='<%# Eval("ChargeCurrency") %>' runat="server"></dx:ASPxLabel>
                                    </DataItemTemplate>
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn HeaderStyle-Font-Bold="true" Caption="Percentage/Amount" >
                                    <DataItemTemplate>
                                        <dx:ASPxLabel Text='<%# Eval("PercAmount1") %>' runat="server"></dx:ASPxLabel>
                                    </DataItemTemplate>
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn HeaderStyle-Font-Bold="true" Caption="Indicator" >
                                    <DataItemTemplate>
                                        <dx:ASPxLabel Text='<%# Eval("Indicator") %>' runat="server"></dx:ASPxLabel>
                                    </DataItemTemplate>
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn HeaderStyle-Font-Bold="true" Caption="Charge Interval">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel Text='<%# Eval("ChargeInterval") %>' runat="server"></dx:ASPxLabel>
                                    </DataItemTemplate>
                            </dx:GridViewDataColumn>
                             <dx:GridViewDataColumn HeaderStyle-Font-Bold="true" Caption="Update Type">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel Text='<%# Eval("UpdateType") %>' runat="server"></dx:ASPxLabel>
                                    </DataItemTemplate>
                            </dx:GridViewDataColumn>
