<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="withdrawalreversal.aspx.vb" Inherits="Parameters_withdrawalreversal" title="Withdrawal Reversal" %>
    ...
    <asp:Panel id="Panel1" runat="server" Width="840px" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <asp:Panel runat="server" ID="Panel5" Font-Names="Cambria" GroupingText="Withdrawal Reversals">
                ...
                <table width="810px">
                    ...
                    <tr>
                        <td colspan="1">
                            <dx:ASPxLabel ID="ASPxLabel26" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Withdrawal From" Theme="Glass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan="1">
                    ...
                    <tr>
                        <td colspan="1">
                            <dx:ASPxLabel ID="ASPxLabel27" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Withdrawal to" Theme="Glass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan="1">
                    ...
                    <tr>
                        <td colspan="1">&nbsp;</td>
                        <td colspan="1">
                            <dx:ASPxButton ID="ASPxButton7" runat="server" Text="View Withdrawals" Theme="BlackGlass">
                            </dx:ASPxButton>
                            &nbsp;</td>
                        <td colspan="1">&nbsp;</td>
                        <td colspan="1">&nbsp;</td>
