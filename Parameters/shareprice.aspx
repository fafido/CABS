<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="frmstockexchange.aspx.vb" Inherits="Parameters_stockexchange" title="Untitled Page" %>
            ...
            <td style="width: 712px; height: 226px" valign="top" __designer:mapid="221">
                <table __designer:mapid="222">
                    <tr __designer:mapid="223">
                        ...
                        Text="Stock Exchange Parameters" width="848px"></asp:Label>
                        </td>
                    </tr>
                </table>
                <table __designer:mapid="226" style="width: 343px">
                    <tr __designer:mapid="227">
                        <td align="left" __designer:mapid="228" style="width: 225px">
                            <asp:Label id="Label1" runat="server" Text="Stock Exchange Code" font-names="Arial" 
                    ...
                    <tr __designer:mapid="22c">
                        <td align="left" __designer:mapid="22d" style="width: 225px">
                            <asp:Label id="Label2" runat="server" Text="Stock Exchange Name" font-names="Arial" 
                            font-size="Small"></asp:Label>
                        </td>
                    ...
                    <tr __designer:mapid="22c">
                        <td align="left" __designer:mapid="22d" style="width: 225px">
                            <asp:Label id="Label12" runat="server" Text="Stock Exchange Short Name" font-names="Arial" 
                            font-size="Small"></asp:Label>
                        </td>
                        <td __designer:mapid="22f" style="text-align: left">
                    ...
                    <tr>
                        <td align="left" __designer:mapid="22d" style="width: 225px">
                            <asp:Label id="Label11" runat="server" Text="Country" font-names="Arial" 
                            font-size="Small"></asp:Label>
                        </td>
                        <td __designer:mapid="22f" style="text-align: left">
                            <asp:DropDownList ID="DropDownList1" runat="server" Height="21px" Width="142px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr __designer:mapid="22c">
