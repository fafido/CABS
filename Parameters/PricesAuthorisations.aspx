<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="PricesAuthorisations.aspx.vb" Inherits="Orders" title="Bonds Buy" %>
    ...
    <tr>
        <td style="width: 712px; height: 226px" valign="top">
            ...
            <tr>
             ...
             <asp:Panel runat="server" ID="panel4" GroupingText="OMUT&gt;&gt;Prices Authorisation ">
                 
                 <table >
                      <tr>
                <td colspan="8">
                    <dx:ASPxLabel ID="lbltitle" runat="server"  Font-Size="Medium"  Text="Prices Authorisation">
                    </dx:ASPxLabel>
                ...
                <Columns>
                   ...
                   <asp:TemplateField>
                     ...
                     <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkdelete" OnClientClick="if (!confirm('Are you sure you want deny?')) return false;" runat="server"  CommandArgument="<%# Bind('id') %>" OnClick="linkDiscard"     CommandName="Delete" >Delete</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
