<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="frmTax.aspx.vb" Inherits="Parameters_frmTax" title="Untitled Page" %>
            ...
            <td style="width: 712px; height: 226px" valign="top" __designer:mapid="221">
                <table __designer:mapid="222">
                    <tr __designer:mapid="223">
                        ...
                        Text="Tax Codes" width="848px"></asp:Label>
                        </td>
                    </tr>
                </table>
                <table __designer:mapid="226" style="width: 511px">
                    <tr>
                        <td align="left" __designer:mapid="228" style="width: 225px; height: 26px;">
                            <asp:Label id="Label12" runat="server" Text="Tax Code" font-names="Arial" 
                            font-size="Small"></asp:Label>
                        </td>
                        <td __designer:mapid="22a" style="text-align: left; height: 26px;">
                    ...
                    <tr __designer:mapid="227">
                        <td align="left" __designer:mapid="228" style="width: 225px">
                            <asp:Label id="Label1" runat="server" Text="Full Name" font-names="Arial" 
                            font-size="Small"></asp:Label>
                        </td>
                    ...
                    <tr __designer:mapid="22c">
                        <td align="left" __designer:mapid="22d" style="width: 225px">
                            <asp:Label id="Label2" runat="server" Text="Rate" font-names="Arial" 
                            font-size="Small"></asp:Label>
                        </td>
                    ...
                    <tr>
                        <td align="left" __designer:mapid="22d" style="width: 225px">
                            <asp:Label id="Label11" runat="server" Text="Status" font-names="Arial" 
                            font-size="Small"></asp:Label>
                        </td>
                        <td __designer:mapid="22f" style="text-align: left">
