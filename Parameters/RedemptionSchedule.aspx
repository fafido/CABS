<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="RedemptionSchedule.aspx.vb" Inherits="Parameters_RedemptionSchedule" title="Redemption Schedule" %>
        ...
        <table width ="810px">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Parameters&gt;Print Redemption Schedule" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>

                   </td>
            </tr>
        </table>
        <asp:Panel runat="server" ID="Panel5" Font-Names="Cambria" GroupingText="Redemption Schedule">
                ...
                <table width="810px">
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            <dx:ASPxTextBox ID="txtinterest" runat="server" style="margin-top: 0px; margin-bottom: 0px;" Theme="Glass" Visible="False" Width="250px">
                            </dx:ASPxTextBox>
                        </td>
                        <td colspan="1">&nbsp;</td>
                        <td colspan="1">&nbsp;</td>
                    ...
                    <tr>
                        <td colspan="1">&nbsp;</td>
                        <td colspan="1">
                            <dx:ASPxButton ID="ASPxButton7" runat="server" Text="Print Schedule" Theme="BlackGlass" Height="20px" Width="222px">
                            </dx:ASPxButton>
                        </td>
                        <td colspan="1">&nbsp;</td>
                        <td colspan="1">&nbsp;</td>
