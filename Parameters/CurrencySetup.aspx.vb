...
Partial Class Parameters_CurrencySetup
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not IsPostBack = True Then
            grdvCurrencies.Attributes.Add("bordercolor", "#B7D8DC")
            GetCurStatus()
            GetCountry()
            FillGrid()
    ...
    Protected Sub grdvCurrencies_SelectedIndexChanged(sender As Object, e As EventArgs) Handles grdvCurrencies.SelectedIndexChanged
        ...
        Try
            ...
            Try
                cmbCountry.Value = grdvCurrencies.SelectedRow.Cells(6).Text.Replace("&nbsp;", "")
            Catch ex As Exception
            End Try
        ...
        Try
            ...
            If btnSave.Text = "Save Currency" Then
                ...
                If ddSStatus.Text = "BASE" Then
                    ...
                    End If
                End If
                Dim cmd1 = New SqlCommand("insert into para_Currencies (Country,CurrencyCode,CurrencyName,CurrencySymbol,InternationalSTD,CurrencyStatus) values (@Country,@currencycode,@currencyname,@currencysymbol,@internationalstd,'" & ddSStatus.Text & "')", cn)
                ...
                cmd1.Parameters.AddWithValue("@Country", cmbCountry.Text)
                If (cn.State = ConnectionState.Open) Then
                    cn.Close()
                End If
                cn.Open()
            ...
            Else
                ...
                If ddSStatus.Text = "default" Then
                    ...
                    cn.Close()
                End If
                cmd1 = New SqlCommand("update para_Currencies set country=@country,currencycode=@currencycode, currencyname=@currencyname, currencysymbol=@currencysymbol, InternationalSTD=@internationalstd,CurrencyStatus=@currencystatus where CurrencyCode = @selectedcode", cn)
                cmd1.Parameters.AddWithValue("@currencycode", txtCCode.Text)
                cmd1.Parameters.AddWithValue("@currencyname", txtCName.Text)
                cmd1.Parameters.AddWithValue("@currencysymbol", txtCSymbol.Text)
                cmd1.Parameters.AddWithValue("@internationalstd", txtIntStd.Text)
