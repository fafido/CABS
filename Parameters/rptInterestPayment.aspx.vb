Partial Class rptInterestPayment
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Dim issuer As String = Request.QueryString("issuer")
            Dim paymtNo As Integer = Request.QueryString("payNo")

            myreport = New CrystalDecisions.CrystalReports.Engine.ReportDocument()
            myreport.Load(Server.MapPath("rptInterestPayment.rpt"))
            ...
            myParameterField.ParameterFieldName = "pissuer"
            myDiscreteValue.Value = issuer
            ...
            myParameterField2.ParameterFieldName = "payno"
            myDiscreteValue2.Value = paymtNo
