...
<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="ParticipantCharges.aspx.vb" Inherits="Parameters_ParticipantCharges" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel id="Panel1" runat="server" Width="840px" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width ="810px">
          ...
          <asp:panel id="Panel2" runat="server" GroupingText="Participant Charges" Font-Names="Cambria">
        <table style="width: 826px">
            <tr>
             ...
             <tr>
                <td align="left" style="height: 20px; width: 356px;">
                    <dx:ASPxLabel ID="ASPxLabel19" runat="server" Font-Names="Cambria" Font-Size="Small"  Text="Participant Type" Theme="Glass">
                    </dx:ASPxLabel>
                 </td>
                 <td align="left" colspan="1" style="height: 14px; width: 264px;">
                    <asp:DropDownList ID="ASPxTextBox1" runat="server" AutoPostBack="True" Height="20px" Theme="BlackGlass" Width="249px">
                    </asp:DropDownList>
                 </td>
            ...
            <tr>
                <td align="left" style="height: 20px; width: 356px;">
                    <dx:ASPxLabel ID="ASPxLabel2" runat="server" Font-Names="Cambria" Font-Size="Small"  Text="Participant Charge" Theme="Glass">
                    </dx:ASPxLabel>
                 </td>
                 <td align="left" colspan="1" style="height: 14px; width: 264px;">
                     <asp:DropDownList ID="cmdwadi" runat="server" AutoPostBack="True" Height="20px" Theme="BlackGlass" Width="249px">
                    </asp:DropDownList>
                 </td>
                <td colspan ="1" style="height: 14px; width: 73px;">
                    &nbsp;</td>
            ...
            <tr>
                <td align="left" style="height: 2px; width: 356px;">
                    <dx:ASPxLabel ID="ASPxLabel4" runat="server" Font-Names="Cambria" Font-Size="Small"  Text="Charge Description" Theme="Glass">
                    </dx:ASPxLabel>
                </td>
                <td align="left" colspan="1" style="height: 2px; width: 264px;">
                    <dx:ASPxTextBox ID="txtdescription" runat="server"  Theme="BlackGlass" Width="249px" Height="19px">
                    </dx:ASPxTextBox>
                </td>
            ...
            <tr>
                ...
                <td align="left" colspan="1" style="height: 14px; width: 264px;">
                     <asp:DropDownList ID="cmbchargestage" runat="server" AutoPostBack="True" Height="20px" Theme="BlackGlass" Width="249px">
                    </asp:DropDownList>
                </td>
            ...
            <tr>
                ...
                <td align="left" colspan="4" style="height: 2px; ">
                    <dx:ASPxTextBox ID="txtcode" runat="server" Height="16px" Theme="BlackGlass" Width="249px">
                    </dx:ASPxTextBox>
                </td>
                <td colspan="1" style="height: 2px">&nbsp;</td>
            </tr>
            ...
            <tr>
                <td align="left" style="height: 2px; width: 356px;">
                    <dx:ASPxLabel ID="ASPxLabel20" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Value/Percentage" Theme="Glass">
                    </dx:ASPxLabel>
                </td>
                <td align="left" colspan="4" style="height: 2px; ">
                    <dx:ASPxTextBox ID="txtAmt" runat="server"  Height="16px" Theme="BlackGlass" Width="249px">
                    </dx:ASPxTextBox>
                </td>
        ...
        <asp:Panel runat="server" Visible="false" ID="Panel10" Font-Names="Cambria" GroupingText="_" Font-Size="Medium">
