<%@ Page Language="VB"  MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="WarehouseCreation.aspx.vb" Inherits="Custodian_WarehouseCreation"  title="Warehouse Creation"  %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <asp:Panel runat="server" ID="Panel9" Font-Names="Cambria" GroupingText="Warehouse Creation" Width="100%">
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td  style="width: 212px">
                        <dx:ASPxTextBox ID="txtWarehouseName" runat="server"   Height="19px" Theme="BlackGlass" Width="250px">
                            </dx:ASPxTextBox> 
                    </td>             
                    <td  style="width: 208px">
                    ...
                    <td  style="width: 212px">
                        <dx:ASPxTextBox ID="txtWarehouseCode" Enabled ="false" runat="server"  Height="19px" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width: 212px">
                        <dx:ASPxTextBox ID="txtPhone" runat="server"  Height="19px" Theme="BlackGlass" Width="250px">
                            </dx:ASPxTextBox>
                    </td>
                    <td>
                        <table width="100%">
                    ...
                    <td style="width: 61px">
                        <dx:ASPxTextBox ID="txtMobile" runat="server" Height="19px" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                    <td>
                        &nbsp;</td>
                ...
                <tr>
                    ...
                    <td style="width: 212px">
                        <dx:ASPxTextBox ID="txtgooglelocation" runat="server"  Height="19px" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                    <td>
                    ...
                    <td>
                        <dx:ASPxTextBox ID="txtEmail" runat="server"  Height="19px" Theme="BlackGlass" Width="250px">
                ...
                <tr>
                    <td>
                        ...
                        <table class="auto-style1">
                            <tr>
                                <td>
                                    <asp:GridView ID="grdCommodityToBeStored" runat="server" AutoGenerateColumns="False" ShowFooter="true">
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                    ...
                    <td>
                        <table class="auto-style1">
                            <tr>
                                <td>
                                    <asp:GridView ID="grdLoanBreakDown" runat="server" AutoGenerateColumns="False" ShowFooter="true">
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                    ...
                    <tr>
                        ...
                        <td style="width: 212px">
                            <dx:ASPxTextBox ID="txtindivcapacity" runat="server" Height="19px" Theme="BlackGlass" Width="250px">
                            </dx:ASPxTextBox>
                        </td>
                        <td style="width: 208px">
                        ...
                        <td style="width: 212px">
                            <dx:ASPxTextBox ID="txtRepresentative" runat="server" Height="19px" Theme="BlackGlass" Width="250px">
                            </dx:ASPxTextBox>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 212px">
                            <dx:ASPxTextBox ID="txtDesignation" runat="server" Height="19px" Theme="BlackGlass" Width="250px">
                            </dx:ASPxTextBox>
                        </td>
                        <td style="width: 208px">
                        ...
                        <td style="width: 212px">
                            <dx:ASPxDateEdit ID="txtAgreementDate" runat="server" EditFormatString="dd MMM yyyy" Height="21px" Width="250px">
                            </dx:ASPxDateEdit>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 212px">
                            <dx:ASPxTextBox ID="txtcontactpersonPhoneno" runat="server" Height="19px" Theme="BlackGlass" Width="250px">
                            </dx:ASPxTextBox>
                        </td>
                        <td>
                            <table width="100%">
                        ...
                        <td style="width: 118px">
                            <dx:ASPxTextBox ID="txtcontactpersonMobileno" runat="server" Height="19px" Theme="BlackGlass" Width="250px">
                            </dx:ASPxTextBox>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <td style="width: 212px">
                                <dx:ASPxTextBox ID="txtNoStorageunits" runat="server" Height="23px" Theme="BlackGlass" Width="250px">
                                </dx:ASPxTextBox>
                            </td>
                            <td style="width: 208px">
                            ...
                            <td style="width: 212px">
                                <dx:ASPxTextBox ID="txtdeminsionsunits" runat="server" Height="19px" Theme="BlackGlass" Width="250px">
                                </dx:ASPxTextBox>
                            </td>
                        </tr>
                    <tr>
                            ...
                            <td style="width: 212px">
                                <dx:ASPxMemo ID="txtAddresses" runat="server" Height="40px" Theme="BlackGlass" Width="250px">
                                </dx:ASPxMemo>
                            </td>
                            <td style="width: 208px">
                            ...
                            <td style="width: 212px">
                                <dx:ASPxTextBox ID="txtpolice" runat="server" Height="23px" Theme="BlackGlass" Width="250px">
                                </dx:ASPxTextBox>
                            </td>
                        </tr>
                    <tr>
                        ...
                        <td style=" width: 208px;">
                            ...
                            <td style="width: 212px">
                                <dx:ASPxTextBox ID="txtDurationoflease" Visible="false" runat="server" Height="23px" Theme="BlackGlass" Width="250px">
                                </dx:ASPxTextBox>
                            </td>
                        </tr>
                    <tr>
                    ...
                    <tr id="Tr4" runat="server">
                            ...
                            <td style="width: 212px">
                                <dx:ASPxTextBox ID="txtOnwername" runat="server" Height="23px" Visible="false" Theme="Glass" Width="250px">
                                </dx:ASPxTextBox>
                            </td>
                            <td style=" width: 208px;">
                            ...
                            <td style="width: 212px">
                                <dx:ASPxTextBox ID="txtweighbridgeaddress" Visible="false" runat="server" Height="23px" Theme="Glass" Width="250px">
                                </dx:ASPxTextBox>
                            </td>
                        </tr>
                    <tr id="Tr5" runat="server">
                            ...
                            <td style="width: 212px">
                                <dx:ASPxTextBox ID="txtdistance" Visible="false" runat="server" Height="23px" Theme="BlackGlass" Width="250px">
                                </dx:ASPxTextBox>
                            </td>
                            <td style="width: 208px">
                    ...
                    <tr id="Tr1" runat="server">
                            ...
                            <td style="width: 212px">
                                <dx:ASPxTextBox ID="txtwegcapacity" runat="server" Height="23px" Theme="BlackGlass" Width="250px">
                                </dx:ASPxTextBox>
                            </td>
                            <td style=" width: 208px;">
                    ...
                    <tr id="Tr2" runat="server">
                            ...
                            <td style="width: 212px">
                                <dx:ASPxTextBox ID="txtmake_model" runat="server" Height="23px" Theme="BlackGlass" Width="250px">
                                </dx:ASPxTextBox>
                            </td>
                            <td style=" width: 208px;">
                            ...
                            <td style="width: 212px">
                                <dx:ASPxTextBox ID="txtTotalCapacityMetricTons" runat="server" Height="23px" Theme="BlackGlass" Width="250px">
                                </dx:ASPxTextBox>
                            </td>
                        </tr>
                    <tr>
                        <td colspan="5" style="height: 18px;">
                            ...
                            <tr>
                                ...
                                <td style="width: 212px">
                                    <dx:ASPxTextBox ID="txtentry" runat="server" Height="23px" Theme="BlackGlass" Width="250px">
                                    </dx:ASPxTextBox>
                                </td>
                                <td style="width: 208px">
                                ...
                                <td style="width: 212px">
                                    <dx:ASPxTextBox ID="txtExit" runat="server" Height="23px" Theme="BlackGlass" Width="250px">
                                    </dx:ASPxTextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width: 212px">
                                    <dx:ASPxTextBox ID="txtsecurityguards" runat="server" Height="23px" Theme="BlackGlass" Width="250px">
                                    </dx:ASPxTextBox>
                                </td>
                                <td style="width: 208px">
                                ...
                                <td style="width: 212px">
                                    <dx:ASPxTextBox ID="txtbountwithfance" runat="server" Height="23px" Theme="BlackGlass" Width="250px">
                                    </dx:ASPxTextBox>
                                </td>
                            </tr>
                                        <tr>
                                ...
                                <td style="width: 212px">
                                    <dx:ASPxTextBox ID="txtpastRegulatory" runat="server" Height="23px" Theme="BlackGlass" Width="250px">
                                    </dx:ASPxTextBox>
                                </td>
                                <td style="width: 208px">
                                ...
                                <td style="width: 212px">
                                    <dx:ASPxTextBox ID="txtNomberofStorage" runat="server" Height="23px" Theme="BlackGlass" Width="250px">
                                    </dx:ASPxTextBox>
                                </td>
                            </tr>
                     <%--<tr>
...
<%--<tr>
	...
	<td style="width: 212px">
		<dx:ASPxDateEdit ID="txtpolicyexpirydateA" runat="server" EditFormat="Custom" EditFormatString="dd MMM yyyy" Height="21px" Width="250px">
                        ...
                        <td colspan="5" style="height: 18px;">
                            ...
                            <hr/>
                                ...
                                <tr id="otherHide1" runat="server" visible="false">
	                                ...
	                                <td style="width: 212px">
		                                <dx:ASPxTextBox ID="txtDocDescription" runat="server" Height="23px" Theme="BlackGlass" Width="250px">
		                                </dx:ASPxTextBox>
	                                </td>
                                </tr>
                                <tr>
                        ...
                        <td colspan="5" style="height: 18px;">
                            ...
                            <hr/>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 212px;">
                                            <dx:ASPxTextBox ID="txtscalename" runat="server" Height="23px" Theme="BlackGlass" Width="250px">
                                            </dx:ASPxTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="width: 212px">
                                            <dx:ASPxTextBox ID="txtscaleDescription" runat="server" Height="23px" Theme="BlackGlass" Width="250px">
                                            </dx:ASPxTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                ...
                <tr  runat="server" visible="true">
                    <td style=" width: 212px; height: 27px;"></td>
                    <td style=" width: 208px; height: 27px;">
                        <dx:ASPxButton ID="btnsave" runat="server" Text="Save and Submit" Theme="BlackGlass" style="margin-bottom: 0px">
                    ...
                    <td style=" width: 212px; height: 27px;">
                        <dx:ASPxButton ID="btnsaveWIP" runat="server" ValidationGroup="SaveWIP" Text="Save Work in Progress" Theme="BlackGlass" style="margin-bottom: 0px">
                        </dx:ASPxButton>
                    </td>
                </tr>
            </table>
        </asp:Panel>
    <asp:Panel  runat="server" Font-Names="Cambria"   GroupingText="Created Warehouses" Font-Bold="true" style="width: 100%">
            <table>
            ...
            <tr>
                ...
                <td colspan="4" style="height: 18px">
                    <dx:ASPxGridView ID="ASPxGridView3" runat="server" AutoGenerateColumns="true" OnRowCommand="ASPxGridView3_RowCommand" KeyFieldName="ID" Theme="Glass" Width="390px">
                        <SettingsPager Visible="False">
                        </SettingsPager>
                        <Columns >
            ...
            <tr>
                ...
                <td colspan="4" style="height: 18px">
                 ...
                 <tr>
              <td colspan="5" style="height: 18px;">
                    <dx:ASPxLabel ID="ASPxLabel11" runat="server" Font-Names="Cambria" Font-Size="Small" Font-Bold="true" Text="Rejected Waehouses " Theme="Glass">
                    </dx:ASPxLabel>
                    <hr/>
                </td>
              </tr>
            <tr>
                <td style="height: 18px;"></td>
                <td colspan="4" style="height: 18px">
                    <dx:ASPxGridView ID="grdReject" runat="server" AutoGenerateColumns="true" OnRowCommand="grdReject_RowCommand" KeyFieldName="ID" Theme="Glass" Width="390px">
                        <SettingsPager Visible="False">
                        </SettingsPager>
                        <Columns >
                            <%--<dx:GridViewDataColumn VisibleIndex="0">
                           ...
                           <%-- <dx:GridViewDataColumn HeaderStyle-Font-Bold="true" Caption="WarehouseCode">
                            ...
                            <dx:GridViewDataColumn HeaderStyle-Font-Bold="true" Caption="Phone">
                             ...
                             <dx:GridViewDataColumn HeaderStyle-Font-Bold="true" Caption="Reason">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel Text='<%# Eval("Reason") %>' runat="server"></dx:ASPxLabel>
                                    </DataItemTemplate>
                            </dx:GridViewDataColumn>
                        </Columns>
                    </dx:ASPxGridView>
