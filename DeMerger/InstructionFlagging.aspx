...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel id="Panel1" runat="server" Width="80%" Font-Names="Cambria" BackColor="White" GroupingText="Instruction flagging">
       <table>
           ...
           <tr id="Panel13a" runat="server">
            ...
            <tr id="Panel004Merger" runat="server" visible="false">
                <td colspan="6">
                  <dx:ASPxGridView ID="grdMerger" SettingsPager-Mode="ShowAllRecords" runat="server" KeyFieldName="ID" Theme="Glass" Width="100%">
