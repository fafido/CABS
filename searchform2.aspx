<%@ Page Language="VB" AutoEventWireup="false" CodeFile="searchform2.aspx.vb" Inherits="Custodian_searchform2" %>
...
<body>
    <form id="form1" runat="server" class="form-inline">
        ...
        <asp:TextBox  ID="txtid" style="width: 55%; height:55px; margin-left: 367px; margin-right: 7px;" runat="server"  placeholder="Enter Name/Reference (Search for your lost/stollen warehouse receipt)" />
