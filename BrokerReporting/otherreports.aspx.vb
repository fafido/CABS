...
Partial Class Reporting_otherreports
    ...
    Protected Sub ASPxButton1_Click(sender As Object, e As EventArgs) Handles ASPxButton1.Click
        Response.Redirect("~/BrokerReporting/CompanySchedule.aspx")
    End Sub

    Protected Sub ASPxButton2_Click(sender As Object, e As EventArgs) Handles ASPxButton2.Click
        Response.Redirect("~/BrokerReporting/CompanyTopSchedule.aspx")
    End Sub
    ...
    Protected Sub new1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles new1.Click
        Response.Redirect("~/BrokerReporting/gvtschedule.aspx")
    End Sub
End Class
