<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="CompanyTopSchedule.aspx.vb" Inherits="Reporting_CompanyTopSchedule" title="Company Schedule" %>
            ...
            <tr>
                <td style="width: 870px" align="center">
                    <asp:Label id="Label4" runat="server" backcolor="#8080FF" font-bold="True" font-names="Arial"
                        Text="Company Top Schedule Report" width="848px"></asp:Label></td>
            </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label7" runat="server" font-names="Verdana" font-size="Small" 
                            Text="Top" width="144px"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtTop" runat="server" Width="190px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td colspan ="1">
