Partial Class Reporting_CompanyTopSchedule
    ...
    Protected Sub btnSelect_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSelect.Click
        Try
            ...
            If (cmbCompany.Text <> "" And ClassType <> "" And txtTargetDate.Text <> "" And txtTop.Text <> "") Then
                ...
                strscript += "window.open('CompanyScheduleTop.aspx?Classfication=" & ClassType & "&company=" & cmbCompany.SelectedItem.Text & "&RepDate=" & txtTargetDate.Text & "&Top=" & txtTop.Text & "');"
                strscript += "</script>"
