<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OrderRegister.aspx.vb" Inherits="OrderRegister" %>
...
<body>
    <form id="form1" runat="server" backcolor="Gainsboro" style="background-color: #E4E4E4;" >
        <div>
