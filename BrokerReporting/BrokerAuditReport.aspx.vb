...
Partial Class Reporting_BrokerAuditReport
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Dim brokercode As String = Request.QueryString("brokercode")
            ...
            myReport.Load(Server.MapPath("..\Reporting\BrokerAudit.rpt"))
            ...
            myParameterField2.ParameterFieldName = "pbrokercode"
            myDiscreteValue2.Value = brokercode
