<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="HolderMovement.aspx.vb" Inherits="Reporting_HolderMovement" title="Account Details Enquiry" %>
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 148px">
                        <asp:ListBox id="lstNames" runat="server" Height="136px" width="328px" AutoPostBack="True"></asp:ListBox></td>
                </tr>
                <tr>
                    <td></td>
                    <td align="center">
