<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="ChargeDepositorsAdhoc.aspx.vb" Inherits="ChargeDepositorsAdhoc" title="Cash Deposits" %>
        ...
        <table width ="810px">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Trading&gt;&gt;Adhoc Charges" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
...
<tr>
    <td colspan="1" style="height: 18px">
            <dx:ASPxLabel ID="ASPxLabel10" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Charge Code" Theme="Glass">
            </dx:ASPxLabel>
            </td>
    <td colspan="1" style="height: 18px">
        <dx:ASPxComboBox ID="cmbCounter" runat="server" AutoPostBack="true" AnimationType="Slide" IncrementalFilteringMode="Contains" Theme="BlackGlass" ValueType="System.String" Width="250px">
            <Items>
    ...
    <td colspan="1">
        <dx:ASPxTextBox ID="txtAmount" Enabled="false" runat="server" BackColor="#E4E4E4" Theme="BlackGlass" Width="250px">
        </dx:ASPxTextBox>
                        </td>
    <td colspan="1"></td>
    <td colspan="1"></td>
