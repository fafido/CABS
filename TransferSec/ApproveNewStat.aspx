<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="ApproveNewStat.aspx.vb" Inherits="TransferSec_ApproveNewStat" title="Trade Status Approval" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel id="Panel1" runat="server" Width="100%" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width ="100%">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Trading&gt;&gt;Trade Status Approval" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
        ...
        <asp:Panel ID="Panel3" runat="server" Font-Names="Cambria" Font-Size="Medium" GroupingText="Trade Status Approval">
            <table width="100%">
                <tr>
                    <td colspan="7" style="height: 26px">
                        <dx:ASPxGridView ID="grddocuments" Width="100%" runat="server" KeyFieldName="id" Settings-ShowTitlePanel="true" Theme="Glass">
                            ...
                            <Columns>
                                    <dx:GridViewDataColumn Caption="Select" FieldName="Selec"  VisibleIndex="0" Settings-ShowInFilterControl="False" Settings-ShowFilterRowMenu="False" Settings-ShowFilterRowMenuLikeItem="False"    >
                                    <DataItemTemplate>
                                ...
                                <dx:GridViewDataColumn Caption="" VisibleIndex="0">
                                    <DataItemTemplate>
                                        <asp:LinkButton ID="ViewDoc1" runat="server" CommandArgument='<%# Eval("ID") %>' CommandName="View Details" Text="View Details">
                                                              </asp:LinkButton>
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
                                <dx:GridViewDataColumn Caption="" VisibleIndex="0">
                        ...
                        <dx:GridViewDataTextColumn Name="Client No" FieldName="ClientNo" Settings-AutoFilterCondition="Contains">    </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Name="Names" FieldName="Names" Settings-AutoFilterCondition="Contains">    </dx:GridViewDataTextColumn>
                                 ...
                                 <dx:GridViewDataTextColumn Name="Units" FieldName="Units" Settings-AutoFilterCondition="Equals"  PropertiesTextEdit-DisplayFormatString="n">    </dx:GridViewDataTextColumn>
                                 <dx:GridViewDataTextColumn Name="Price" FieldName="Price" Settings-AutoFilterCondition="Equals" >    </dx:GridViewDataTextColumn>
                                  <dx:GridViewDataTextColumn Name="Settlement Amount" FieldName="SettlementAmount" Settings-AutoFilterCondition="Equals"  PropertiesTextEdit-DisplayFormatString="n">    </dx:GridViewDataTextColumn>
                                 <dx:GridViewDataTextColumn Name="Trade Charges" FieldName="TradeCharge" Settings-AutoFilterCondition="Equals"  PropertiesTextEdit-DisplayFormatString="n">    </dx:GridViewDataTextColumn>
                                 <dx:GridViewDataTextColumn Name="Asset Manager" FieldName="AssetManager" Settings-AutoFilterCondition="Contains">    </dx:GridViewDataTextColumn>
                                  <dx:GridViewDataTextColumn Name="Trade Status" FieldName="TradeStatus" Settings-AutoFilterCondition="Contains">    </dx:GridViewDataTextColumn>
                                   <dx:GridViewDataTextColumn Name="CapturedBy" FieldName="CapturedBy" Settings-AutoFilterCondition="Contains">    </dx:GridViewDataTextColumn>
                ...
                <tr>
                    <td colspan="7" style="height: 26px" align="center">
                        <dx:ASPxButton ID="ASPxButton15" runat="server" style="height: 23px" Text="Approve Selected" Theme="Glass">
                        </dx:ASPxButton>
                        &nbsp;
                        <dx:ASPxButton ID="ASPxButton16" runat="server" style="height: 23px" Text="Reject Selected" Theme="Glass">
                        </dx:ASPxButton>
                    </td>
                </tr>
                <tr>
                                            ...
                                            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                                <table style="width: 100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="1">
                                                            <dx:ASPxComboBox ID="cmbordertype" runat="server" EnableCallbackMode="True" ReadOnly="true" Theme="Glass" Width="250px">
                                                                <Items>
                                                        ...
                                                        <td colspan="1">
                                                            <dx:ASPxComboBox ID="cmbassetmanager" runat="server" EnableCallbackMode="True" ReadOnly="true" Theme="Glass" Width="250px">
                                                            </dx:ASPxComboBox>
                                                        </td>
                                                        <td colspan="1">&nbsp;</td>
                                                        <td colspan="1">&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="1" style="height: 26px">
                                                            <dx:ASPxComboBox ID="cmbparaCompany" runat="server" DropDownWidth="550" ReadOnly="true" Theme="Glass" Width="250px">
                                                            </dx:ASPxComboBox>
                                                        </td>
                                                        <td colspan="1" style="height: 26px; width: 149px;">
                                                            <dx:ASPxLabel ID="ASPxLabel11" runat="server" Font-Names="Cambria" Font-Size="Small" Text="No of Units" Theme="Glass">
                                                            </dx:ASPxLabel>
                                                        </td>
                                                        <td colspan="1" style="height: 26px">
                                                            <dx:ASPxTextBox ID="txtavailableshares" runat="server" DisplayFormatString="n" Height="19px" ReadOnly="true" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                                                            </dx:ASPxTextBox>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="1" style="height: 26px">
                                                            <dx:ASPxComboBox ID="cmbcurrency" runat="server" EnableCallbackMode="True" ReadOnly="true" Theme="Glass" Width="250px">
                                                            </dx:ASPxComboBox>
                                                        </td>
                                                        <td colspan="1" style="height: 26px">&nbsp;</td>
                                                        <td colspan="1" style="height: 26px">&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="1" style="height: 26px">
                                                            <dx:ASPxDateEdit ID="dtfrom" runat="server" AutoPostBack="True" ReadOnly="true" Width="250px">
                                                            </dx:ASPxDateEdit>
                                                        </td>
                                                        <td colspan="1" style="height: 26px; width: 149px;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="1" style="height: 26px">
                                                            <dx:ASPxTextBox ID="txttranscharge" runat="server" DisplayFormatString="n" Height="19px" ReadOnly="true" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                                                            </dx:ASPxTextBox>
                                                        </td>
                                                        <td colspan="1" style="height: 26px">&nbsp;</td>
                                                        <td colspan="1" style="height: 26px">&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="1" style="height: 26px">
                                                            <dx:ASPxTextBox ID="txtsettlementamount" runat="server" DisplayFormatString="n" Height="19px" ReadOnly="True" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                                                            </dx:ASPxTextBox>
                                                        </td>
                                                        <td colspan="1" style="height: 26px; width: 149px;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="1" style="height: 26px">
                                                            <dx:ASPxTextBox ID="txtexchangerate" runat="server" Height="19px" ReadOnly="True" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                                                            </dx:ASPxTextBox>
                                                        </td>
                                                        <td colspan="1" style="height: 26px; width: 149px;">
                                                            <dx:ASPxLabel ID="ASPxLabel4112" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Gross Amount" Theme="Glass">
                                                            </dx:ASPxLabel>
                                                        </td>
                                                        <td colspan="1" style="height: 26px">
                                                            <dx:ASPxTextBox ID="txtgross" runat="server" DisplayFormatString="n" Height="19px" ReadOnly="True" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                                                            </dx:ASPxTextBox>
                                                        </td>
                                                        <td colspan="1" style="height: 26px">&nbsp;</td>
                                                        <td colspan="1" style="height: 26px">&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="1" style="height: 26px; width: 149px;">&nbsp;</td>
                                                        <td colspan="1" style="height: 26px">&nbsp;</td>
                                                        <td colspan="1" style="height: 26px">&nbsp;</td>
                                                        <td colspan="1" style="height: 26px">&nbsp;</td>
                                                        <td colspan="1" style="height: 26px">&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        <td align="center" colspan="7" style="height: 26px">
                                                            <dx:ASPxButton ID="ASPxButton13" runat="server" style="height: 23px" Text="Approve" Theme="Glass">
                                                            </dx:ASPxButton>
                                                            &nbsp;<dx:ASPxButton ID="ASPxButton14" runat="server" style="height: 23px" Text="Reject" Theme="Glass">
                                                            </dx:ASPxButton>
                                                            &nbsp;&nbsp;</td>
                                                    </tr>
                                                </table>
                ...
                <tr>
                    <td colspan="7" style="height: 184px">
                        <asp:Panel ID="Panel4" runat="server" GroupingText="Authorized Equity Trades">
                ...
                <tr>
                    <td colspan="7">
                        <asp:Panel ID="Panel5" runat="server" GroupingText="Rejected Equity Trades">
