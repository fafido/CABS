<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="retrievepayments_interest.aspx.vb" Inherits="TransferSec_retrievepayments_interest" title="Interest Payment" %>
    ...
    <asp:Panel id="Panel1" runat="server" Width="840px" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <asp:Panel runat="server" ID="PanelType" Font-Names="Cambria" GroupingText="Confirm Delivery">
            ...
            <table style="width: 828px">
                ...
                <tr>
                    <td align="center">
                        <asp:Button ID="Button1" runat="server" BackColor="#023E5A" ForeColor="White" Height="28px" Text="Extract Payments For Interest" Width="215px" />
                    </td>
                </tr>
                <tr>
                    <td align="center">
