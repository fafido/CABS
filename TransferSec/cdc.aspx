<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="cdc.aspx.vb" Inherits="CDC" title="CDC Recon" %>
...
<table style="width:100%">
    ...
    <tr>
        <td>
                 ...
                 <dx:ASPxLabel ID="ASPxLabel1" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Recon&gt;&gt;CDC" Theme="PlasticBlue"></dx:ASPxLabel>
       
             
                 <asp:Panel runat="server" GroupingText="Upload CDC File">
<table  style="width:100%">
            <tr>
                <td colspan ="8">
                    <table style="width:100%">
                ...
                <tr>
                            ...
                            <td colspan="9">
                                <dx:ASPxGridView ID="ASPxGridView2"   runat="server" AutoGenerateColumns="True" KeyFieldName="ID" Settings-ShowTitlePanel="true" SettingsBehavior-ProcessSelectionChangedOnServer="true" SettingsText-Title="" Theme="Glass" Width="100%">
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="Asset Manager Holding" Name="CDC Holding" Caption="CDC Holding" Settings-AutoFilterCondition="Contains">
                                        </dx:GridViewDataTextColumn>
                        ...
                        <tr>
                            <td colspan="9">
                                <dx:ASPxGridView ID="ASPxGridView3" runat="server" AutoGenerateColumns="True" Settings-ShowTitlePanel="true" SettingsBehavior-ProcessSelectionChangedOnServer="true" SettingsText-Title="" Theme="Glass" Width="100%">
