<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AccountsCreations2.aspx.vb" Inherits="TransferSec_AccountsCreations2" title="Account Details Enquiry" %>
    ...
    <asp:Panel id="Panel1" runat="server" Width="840px" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width="810px">
           ...
           <tr>
            ...
            <tr>
                ...
                <td>
                    <dx:ASPxTextBox ID="txtIDNo" runat="server" BackColor="#E4E4E4" Theme="BlackGlass" Width="180px" MaxLength="50">
                    </dx:ASPxTextBox>
                </td>
                <td style="width: 83px">
                    &nbsp;</td>
        ...
        <table width="810px">
           ...
           <tr>
             ...
             <tr>
               <td colspan ="1">
                   <dx:ASPxLabel ID="lblCoust0" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Broker" Theme="Glass">
                   </dx:ASPxLabel>
                 </td>
               <td>
                   <dx:ASPxComboBox ID="cmbCustodian0" runat="server" Theme="BlackGlass" ValueType="System.String" Width="710px">
                   </dx:ASPxComboBox>
                 </td>
     ...
     <asp:Panel runat="server" ID="panelSave" Font-Names="Cambria" GroupingText="Attachments">
         <table>
             ...
             <tr>                 
              ...
              <tr>                 
                 <td colspan ="1">
                     <dx:ASPxCheckBox ID="Biometrics" runat="server" Text="Biometrics" Theme="Glass">
                     </dx:ASPxCheckBox>
                  </td>
                 <td colspan ="1"></td>
                 <td colspan ="1">
