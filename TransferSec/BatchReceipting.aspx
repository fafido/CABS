<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="BatchReceipting.aspx.vb" Inherits="TransferSec_BatchReceipting" title="Batch Receipting" %>
        ...
        <table width ="810px">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Batching&gt;&gt;Immobilization" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
...
<tr>
    ...
    <td colspan ="1">
        <dx:ASPxComboBox ID="cmbparaCompany" runat="server" Theme="DevEx" ValueType="System.String" Width="250px" TextFormatString = "{0}">
             <Columns>
                           <dx:ListBoxColumn FieldName="Short Name" Name="Custodian Name" />
                           <dx:ListBoxColumn FieldName="Full Company Name" Name="Custodian Code" />
                 </Columns>
        </dx:ASPxComboBox>
        </td>
    <td colspan ="1">
        <dx:ASPxLabel ID="ASPxLabel25" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Amount" Theme="Glass">
        </dx:ASPxLabel>
        </td>
    <td colspan ="1">
    ...
    <td colspan ="1"></td>
                    ...
                    <tr>
                        <td colspan="1" style="height: 23px">
                            <dx:ASPxLabel ID="ASPxLabel35" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Security Type" Theme="Glass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan="1" style="height: 23px">
                            <dx:ASPxComboBox ID="cmbsecuritytype" runat="server" TextFormatString="{0}" Theme="BlackGlass" ValueType="System.String" Width="250px" CallbackPageSize="15" EnableCallbackMode="True" DropDownStyle="DropDownList"  IncrementalFilteringMode="Contains"  AnimationType="Slide">
                    ...
                    <tr>
                            <td colspan ="1" style="height: 23px">
                                <dx:ASPxLabel ID="ASPxLabel34" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Batch No" Theme="Glass" Visible="False">
                                </dx:ASPxLabel>
                            </td>
                        <td colspan ="1" style="height: 23px">
                            <dx:ASPxTextBox ID="txtClientNo" runat="server" BackColor="#E4E4E4" ReadOnly="True" Theme="BlackGlass" Width="250px" Visible="False">
                            </dx:ASPxTextBox>
                            </td>
                        <td colspan ="1" style="height: 23px">
                            </td>
                    ...
                    <tr>
                        ...
                        <td colspan ="1" style="height: 23px">
                            <dx:ASPxTextBox ID="txtShareprice" runat="server" BackColor="#E4E4E4" Theme="BlackGlass" Visible="False" Width="250px">
                            </dx:ASPxTextBox>
                            </td>
                            ...
                            <td colspan="1" style="height: 23px">
                                <dx:ASPxTextBox ID="txtBatchValue" runat="server" BackColor="#E4E4E4" ReadOnly="True" Theme="BlackGlass" Visible="False" Width="250px">
                                </dx:ASPxTextBox>
                            </td>
                            <td colspan="1" style="height: 23px">&nbsp;</td>
                            <td colspan="1" style="height: 23px">&nbsp;</td>
                ...
                <table width="810px">
                    <tr>
                        ...
                        <td colspan ="6"></td>
                            ...
                            <td colspan ="1">
                                <dx:ASPxLabel ID="ASPxLabel6" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Pin No." Theme="Glass">
                                </dx:ASPxLabel>
                            </td>
                        <td colspan ="1">
                       ...
                       <tr>
                            ...
                            <td colspan ="1">
                                <dx:ASPxLabel ID="ASPxLabel8" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Shares" Theme="Glass">
                                </dx:ASPxLabel>
                            </td>
                        <td colspan ="1">
                    ...
                    <tr>
                            ...
                            <td colspan ="1">
                                <dx:ASPxLabel ID="ASPxLabel31" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Certificate" Theme="Glass">
                                </dx:ASPxLabel>
                            </td>
                        <td colspan ="1">
                            <dx:ASPxTextBox ID="txtcertno" runat="server" BackColor="#E4E4E4" Height="19px" Theme="BlackGlass" Width="250px">
                            </dx:ASPxTextBox>
                            </td>
                        <td colspan ="1">
                            ...
                            <td colspan ="7">
                                <asp:GridView ID="grdTranShareholder" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="id" EmptyDataText="No Relevant Data Found" ForeColor="Black" GridLines="Vertical" Height="16px" Width="99%">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Certificate_No" HeaderText="Cert No" />
