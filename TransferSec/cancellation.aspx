<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="cancellation.aspx.vb" Inherits="TransferSec_cancellation" title="Cancellation" %>
    ...
    <asp:Panel id="Panel1" runat="server" Width="100%" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width ="100%">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Transaction Batching&gt;&gt;EWR Cancellation" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
        ...
        CallbackPageSize="1000" Width="250px" Theme="Glass">
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxLabel ID="ASPxLabel65" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Cancellation Type" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxComboBox ID="ddcancellationtype" runat="server" AutoPostBack="True" Theme="Glass" Width="250px">
                        
                            <Items>
                                <dx:ListEditItem Text="Cancel EWR &amp; Deposit" Value="Cancel EWR &amp; Deposit" />
                                <dx:ListEditItem Text="Cancel EWR Only" Value="Cancel EWR Only" />
                            </Items>
                        </dx:ASPxComboBox>
                    </td>
                    <td colspan="1" style="height: 26px">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtdocumentname" runat="server" Height="19px" ReadOnly="True" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px" Text="EWR Cancellation Document">
                        </dx:ASPxTextBox>
                    </td>
                    <td colspan="1" style="height: 26px">
                ...
                <tr>
                    <td align="center" colspan="7">
                        <dx:ASPxButton ID="ASPxButton13" runat="server" Text="Cancel" Theme="BlackGlass" style="height: 23px">
                        </dx:ASPxButton>
                    </td>
                </tr>
            </table>
                        ...
                        <dx:ASPxGridView ID="ASPxGridView3" runat="server" KeyFieldName="id" Settings-ShowTitlePanel="true"  Theme="Glass" Width="100%">
                            ...
                            <Columns>
                                 ...
                                 <dx:GridViewDataColumn Caption="Commodity">
                                      ...
                                      <dx:GridViewDataColumn Caption="Cancelled Quantity"  >
                                                         <DataItemTemplate>
