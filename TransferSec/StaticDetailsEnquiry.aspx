<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="StaticDetailsEnquiry.aspx.vb" Inherits="Enquiries_StaticDetailsEnquiry" title="Static Details Enquiry" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel id="Panel1" runat="server" Width="840px" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width ="810px">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Authorizations&gt;&gt;Static Details Enquiry" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>

                   </td>
            </tr>
        </table>
        <asp:Panel runat="server" ID="Panel2" Font-Names="Cambria" GroupingText="Search Options">
            <table width="810px">
                    <tr>
                            <td colspan ="1" align="right">
                                <dx:ASPxLabel ID="ASPxLabel64" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Identification No." Theme="Glass">
                                </dx:ASPxLabel>
                            </td>
                        <td colspan ="1" width="301">
                            <dx:ASPxTextBox ID="txtClientNoSe0" runat="server" Theme="Glass" Width="300px">
                            </dx:ASPxTextBox>
                            </td>

                            <td colspan="1">
                                <dx:ASPxButton ID="ASPxButton4" runat="server" Text="&gt;&gt;" Theme="BlackGlass" Width="38px">
                                </dx:ASPxButton>
                            </td>
                            <td colspan="1">&nbsp;</td>
                            <td colspan="1">&nbsp;</td>
                    ...
                    <tr>
                        <td align="right" colspan="1">
                            <dx:ASPxLabel ID="ASPxLabel62" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Pin No." Theme="Glass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan="1" width="301">
                        ...
                        <td colspan="1">
                            <dx:ASPxButton ID="ASPxButton3" runat="server" Text="&gt;&gt;" Theme="BlackGlass" Width="38px">
                            </dx:ASPxButton>
                        </td>
                        <td colspan="1"></td>
                        <td colspan="1"></td>
                ...
                <tr>
                            <td colspan ="1" align="right">
                                <dx:ASPxLabel ID="ASPxLabel63" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Client Name." Theme="Glass">
                                </dx:ASPxLabel>
                            </td>
                        <td colspan ="1" width="301">
                ...
                <tr>
                        <td colspan ="1"></td>
                    <td colspan ="4">
                        <dx:ASPxListBox ID="cmbPendingAccounts" runat="server" AutoPostBack="True" Theme="Glass" ValueType="System.String" Width="600px">
                        </dx:ASPxListBox>
                        </td>
        ...
        <asp:Panel runat="server" Font-Names="Cambria" GroupingText="Client Verification Code " Visible="False">
            <table width ="810px">
                <tr>
                    <td colspan="1">
        ...
        <asp:panel id="Panel10" runat="server" GroupingText="Account Type" Font-Names="Cambria" Enabled="False">
        <table width="810px">
            <tr>
        ...
        <asp:panel id="Panel8" runat="server" GroupingText="Personal Details" Font-Names="Cambria" Enabled="False">
        <table width="810px">
            <tr>
                <td colspan ="1">
        ...
        <asp:panel id="Panel3" runat="server" GroupingText="Contact Details" Font-Names="Cambria" Enabled="False">
        <table width="810px">
        ...
        <asp:panel id="Panel11" runat="server" GroupingText="Controlled/Non-controlled" Font-Names="Cambria" Enabled="False">
        <table width="810px">
            <tr>
                    <td colspan ="8" align="center">
           ...
           <tr>
               ...
               <td valign="middle" colspan ="7" style="height: 47px">
                   <dx:ASPxTextBox ID="txtcust" runat="server" BackColor="#E4E4E4" Theme="BlackGlass" Width="250px">
                   </dx:ASPxTextBox>
               </td>
        ...
        <asp:panel id="Panel9" runat="server" GroupingText="Attributes" Font-Names="Cambria" Enabled="False">
        <table width="810px">
         <tr>
                <td colspan ="1">
          ...
          <asp:panel id="Panel12" runat="server" GroupingText="Dividend Payment Mandate" Font-Names="Cambria" Enabled="False">
        <table width="810px">
           <tr>
               <td colspan ="1">
        ...
        <asp:panel id="Panel4" runat="server" GroupingText="Settlement  Account Mandate" Font-Names="Cambria" Enabled="False">
        <table width="810px">
           <tr>
               <td colspan ="1">
        ...
        <asp:Panel runat="server" ID="panel5" GroupingText="." Visible="False">
