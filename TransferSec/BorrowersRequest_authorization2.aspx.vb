Partial Class TransferSec_BorrowersRequest_authorization2
    ...
    Public Sub getpending()
        Try
            ...
            cmd = New SqlCommand("select id from lendingpool where borroweraccept='1' and authorized='0'", cn)
    ...
    Public Sub saveupdate()
        cmd = New SqlCommand("update lendingpool set Authorized='1' where id='" + ASPxComboBox1.SelectedItem.Text + "'    update mast set locked='1', lock_reason='Lended Shares', lockquantity=(select quantity  from lendingpool where id='" + ASPxComboBox1.SelectedItem.Text + "') where CDS_Number=(select LenderCDSNo from LendingPool where id='" + ASPxComboBox1.SelectedItem.Text + "') and company=(select company from LendingPool where id='" + ASPxComboBox1.SelectedItem.Text + "')", cn)
