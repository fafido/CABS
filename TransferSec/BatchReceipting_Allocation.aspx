<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="BatchReceipting_Allocation.aspx.vb" Inherits="TransferSec_BatchReceipting_Allocation" title="Allocation" %>
...
<tr>
    ...
    <td colspan ="8" align="center">
        ...
        <dx:ASPxButton ID="ASPxButton5" runat="server" Text="receipt" Theme="BlackGlass" Visible="False">
         ...
         <asp:Panel runat="server" ID="Panel5" Font-Names="Cambria" GroupingText="Series Allocation" Font-Size="Medium">
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td colspan ="1">
                            <dx:ASPxButton ID="ASPxButton10" CausesValidation="False" runat="server" Text="&gt;&gt;" Theme="BlackGlass">
                            </dx:ASPxButton>
                            </td>
                        <td colspan ="1"></td>
                        <td colspan ="1"></td>
                    ...
                    <tr>
                        <td colspan="1">
                            <dx:ASPxLabel ID="ASPxLabel8" runat="server" Font-Names="Cambria" Font-Size="Small" Text="New Allocation Amount" Theme="Glass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan="1" style="width: 193px">
                            <dx:ASPxTextBox ID="txtredeemunits"  DisplayFormatString="n" runat="server"   Height="19px" Theme="BlackGlass" Width="250px">
                          <ValidationSettings>
                    ...
                    <tr>
                        <td colspan="1">
                            <dx:ASPxLabel ID="ASPxLabel39" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Certificate No" Theme="Glass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan="1" style="width: 193px">
                            <dx:ASPxTextBox ID="txtcertificate" runat="server" Height="19px" Theme="BlackGlass" Width="250px">
                                <ValidationSettings>
                                    <RequiredField IsRequired="true" />
                                </ValidationSettings>
                            </dx:ASPxTextBox>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            &nbsp;<dx:ASPxButton ID="ASPxButton16" CausesValidation="False" runat="server" Text="Refresh" Theme="BlackGlass">
                            </dx:ASPxButton>
                        </td>
                        <td colspan="1">&nbsp;</td>
                        <td colspan="1">&nbsp;</td>
                                ...
                                <asp:GridView ID="grdTranShareholder" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="id" EmptyDataText="No Relevant Data Found" ForeColor="#333333" GridLines="Vertical" Height="16px" Width="99%" Font-Size="Small">
                                    ...
                                    <Columns>
                                         ...
                                         <asp:BoundField DataField="company" HeaderText="Series" />
                                          <asp:BoundField DataField="cds_number" HeaderText="ClientNo" />
                                         <asp:BoundField DataField="Quantity" dataformatstring="{0:N}"  HeaderText="Amount" />  
