...
Partial Class TransferSec_WSDLATSConfirmation
    ...
    Public Sub GetOTCTrades()
        Try
            ...
            cmd = New SqlCommand("select company as [Counter], buyorderNum as [Buyer], quantity as [Quantity] , sellordernum as [Seller], price , tradeDate from otc_data_import", cn)
