<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="purchases.aspx.vb" Inherits="Enquiries_purchases" title="Purchases" %>
...
<tr>
    ...
    <td colspan="1" style="height: 18px"></td>
                    ...
                    <tr>
                        ...
                        <td colspan="1" style="height: 18px">
                            <dx:ASPxComboBox ID="cmbissuer" runat="server" Theme="BlackGlass" ValueType="System.String" Width="250px">
                            </dx:ASPxComboBox>
                        </td>
                        <td colspan="1" style="height: 18px">&nbsp;</td>
                        <td colspan="1" style="height: 18px">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td colspan="1" style="height: 18px">
                            <dx:ASPxDateEdit ID="txtmaturity" runat="server" width="250px">
                            </dx:ASPxDateEdit>
                        </td>
                        <td colspan="1" style="height: 18px">&nbsp;</td>
                        <td colspan="1" style="height: 18px">&nbsp;</td>
