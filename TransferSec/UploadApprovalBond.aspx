<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="UploadApprovalBond.aspx.vb" Inherits="UploadApprovalBond" title="Bond Upload Approval" %>
        ...
        <table width ="100%">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Authorization&gt;&gt;Recon Upload Approval (Bond)" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
                        ...
                        <table class="dxflInternalEditorTable">
                            <tr>
                                <td style="width: 178px">
                                    <dx:ASPxLabel ID="ASPxLabel60" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Asset Manager" Theme="Glass">
                                    </dx:ASPxLabel>
                                </td>
                                <td>
                                    <dx:ASPxComboBox ID="cmbassetmanager0" runat="server" DropDownStyle="DropDown" EnableTheming="True" IncrementalFilteringMode="StartsWith" Theme="Default" Width="250px" AutoPostBack="True">
                                </dx:ASPxComboBox>
                                </td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            ...
                            <tr>
                                <td style="width: 178px">
                                    <dx:ASPxLabel ID="ASPxLabel61" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Recon Date" Theme="Glass">
                                    </dx:ASPxLabel>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <dx:ASPxButton ID="ASPxButton7" runat="server" Text="View" Theme="Glass">
                                    </dx:ASPxButton>
                                </td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                         ...
                         <dx:ASPxGridView ID="grddocuments" runat="server" SettingsPager-Mode="ShowAllRecords" KeyFieldName="ID" Settings-ShowTitlePanel="true" Theme="Glass" Width="100%">
                             ...
                             <Columns>
                                 ...
                                 <dx:GridViewDataTextColumn FieldName="Account No" Name="Account No" Settings-AutoFilterCondition="Contains">
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="C-Trade Holding" Name="C-Trade Holding" Settings-AutoFilterCondition="Contains">
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="Asset Manager Holding" Name="Asset Manager Holding" Settings-AutoFilterCondition="Contains">
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="Variance" Name="Variance" Settings-AutoFilterCondition="Contains">
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="Status" Name="Status" Settings-AutoFilterCondition="Contains">
                                        </dx:GridViewDataTextColumn>
                                  <dx:GridViewDataTextColumn FieldName="CtradeValue" Name="CtradeValue" Settings-AutoFilterCondition="Contains">
                                        </dx:GridViewDataTextColumn>
                                           <dx:GridViewDataTextColumn FieldName="AssetManagerValue" Name="AssetManagerValue" Settings-AutoFilterCondition="Contains">
                                        </dx:GridViewDataTextColumn>
                                              <dx:GridViewDataTextColumn FieldName="ValueVariance" Name="ValueVariance" Settings-AutoFilterCondition="Contains">
                                        </dx:GridViewDataTextColumn>
                                                   <dx:GridViewDataTextColumn FieldName="ValueStatus" Name="ValueStatus" Settings-AutoFilterCondition="Contains">
                                        </dx:GridViewDataTextColumn>
