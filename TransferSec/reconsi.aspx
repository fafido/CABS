<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="reconsi.aspx.vb" Inherits="Orders" title="Comparing" %>
    ...
    <tr>
        <td style="width: 712px; height: 226px" valign="top">
            ...
            <tr>
             ...
             <asp:Panel runat="server" ID="panel4" GroupingText="upload to compare&gt;&gtCDC  Upload">
                ...
                <tr>
                        <td colspan ="1" style="height: 18px; width: 387px;">
                            <dx:ASPxGridView ID="ASPxGridView2" runat="server" KeyFieldName="Contract No." Settings-ShowTitlePanel="true" SettingsText-Title="Derivatives" Theme="Glass" Width="640px">
                                ...
                                <SettingsText Title="Mismatch Balances" />
                                <SettingsPopup>
                    ...
                    <td colspan ="5" style="height: 18px">
                        ...
                        <tr>
                            <td colspan="1">
                                <asp:Button ID="Button4" runat="server" Text="View in Custodial not in CSD" />
                                <br/>
                                <br/>
                                <asp:Button ID="Button3" runat="server" Text="View in CSD not in Custodial" />
                                <br/>
                                <br/>
                                <br/>
                                <br/>
