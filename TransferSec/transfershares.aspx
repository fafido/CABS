                ...
                <table width="810px">
                    ...
                    <tr>
                       ...
                       <tr>
                        ...
                        <td colspan ="2">
                            <dx:ASPxTextBox ID="txtcharge" runat="server" BackColor="#E4E4E4" Height="19px" ReadOnly="True" Theme="BlackGlass" Width="250px">
                            </dx:ASPxTextBox>
                            </td>
                        <td colspan ="1">
                            &nbsp;</td>
                       ...
                       <tr>
                           ...
                           <td colspan="1">
                               <dx:ASPxTextBox ID="txtavailableshares" runat="server" BackColor="#E4E4E4" Height="19px" ReadOnly="True" Theme="BlackGlass" Width="250px">
                               </dx:ASPxTextBox>
                           </td>
                           <td colspan="1">&nbsp;</td>
                           <td colspan="1">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td colspan="1">
                            <dx:ASPxTextBox ID="txtshares" runat="server" Enabled="false" ReadOnly="true" BackColor="#E4E4E4" Height="19px" Theme="BlackGlass" Width="250px">
                            </dx:ASPxTextBox>
                        </td>
                        <td colspan="1">
                            &nbsp;</td>
        ...
        <table width="810px">
               ...
               <tr>
                        <td colspan="1" style="width:208px">
                            <dx:ASPxLabel ID="ASPxLabel36" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Transferee Name" Theme="Glass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan="1">
