<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="release.aspx.vb" Inherits="TransferSec_release" title="Release" %>
    ...
    <asp:Panel id="Panel1" runat="server" Width="100%" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width ="100%">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Lending And Borrowing&gt;&gt;Release" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
        ...
        <table style="width:100%">
            ...
            <tr>
                ...
                <td colspan="1">
                    <dx:ASPxLabel ID="ASPxLabel88" runat="server" Font-Names="Cambria" Font-Size="Small" Text="EWR Charges" Theme="Glass" Visible="False">
                    </dx:ASPxLabel>
                </td>
                <td colspan="1">
                    <dx:ASPxTextBox ID="txtEWRaccumulated" runat="server" AutoPostBack="True" ReadOnly="True" Theme="BlackGlass" Visible="False" Width="250px">
                    </dx:ASPxTextBox>
                </td>
                <td colspan="1">&nbsp;</td>
                <td colspan="1">&nbsp;</td>
                    ...
                    <table class="dxflInternalEditorTable_Glass">
                        ...
                        <tr>
                            <td align="center" colspan="2">
                                <dx:ASPxButton ID="ASPxButton9" runat="server" Text="Submit Release" Theme="BlackGlass">
                                </dx:ASPxButton>
                                &nbsp; &nbsp;</td>
                        </tr>
                    </table>
