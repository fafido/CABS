<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="PledgeTransfer.aspx.vb" Inherits="Enquiries_PledgeTransfer" title="Pledge Transfer Form" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel id="Panel1" runat="server" Width="840px" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width ="810px">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Pledges&gt;&gt;Pledge Transfer" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
        ...
        <table style="width: 828px">
         ...
         <asp:Panel runat="server" ID="PanelRelease" Font-Names="Cambria" GroupingText="Transfer Details">
             <table>
                 <tr>
                     ...
                     <td colspan ="7"></td>
                        ...
                        <tr>
                            <td colspan ="1" style="width: 106px">
                                <dx:ASPxLabel ID="ASPxLabel65" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Transfer Reason" Theme="Glass">
                                </dx:ASPxLabel>
                            </td>
                            <td colspan ="7">
                                <dx:ASPxTextBox ID="txtPledgeReason" runat="server" BackColor="#E4E4E4" Height="100px" Theme="BlackGlass" Width="710px">
                                </dx:ASPxTextBox>
                            </td>
                        </tr>
                   <tr>
