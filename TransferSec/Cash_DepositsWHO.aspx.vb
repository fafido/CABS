...
Partial Class Enquiries_Cash_DepositsWHO
    ...
    Public Sub uploa()
        ...
        Else
            ...
            Try
                ...
                a.auditlog(Session("BrokerCode"), Session("Username"), "Submmited a Deposit of " + txtAmount.Text + "", txtClientNo.Text, cmbCounter.Text)
            Catch ex As Exception
    ...
    Public Sub GetCompany(holder As String)
        Try
            ...
            cmd = New SqlCommand("select * from WR where warehouse='" + Session("BrokerCode") + "' and  receiptno in (  select reference from cashtranscomb where CDS_NUMBER='" + holder + "' group by reference having sum(amount)<0) order by id desc", cn)
            adp = New SqlDataAdapter(cmd)
