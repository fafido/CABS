            ...
            <table width="100%">
                        ...
                        <dx:ASPxGridView ID="grddocuments" Width="100%" runat="server" KeyFieldName="id" Settings-ShowTitlePanel="true" Theme="Glass">
                            ...
                            <Columns>
                               ...
                               <dx:GridViewDataTextColumn Name="Client No" FieldName="ClientNo" Settings-AutoFilterCondition="Contains">    </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Name="Names" FieldName="ClientName" Settings-AutoFilterCondition="Contains">    </dx:GridViewDataTextColumn>
                ...
                <tr>
                    <td align="center" colspan="7">      <dx:ASPxButton ID="ASPxButton1" runat="server" style="height: 23px" Text="Approve Selected" Theme="Glass">
                        ...
                        </dx:ASPxButton>&nbsp;<dx:ASPxButton ID="ASPxButton17" runat="server" Width="170px" style="height: 23px" Text="Reject Selected CDS" Theme="Glass">
                        </dx:ASPxButton>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtavailableshares" ReadOnly="true" runat="server" DisplayFormatString="n" Height="19px" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox> 
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txttranscharge" ReadOnly="true" runat="server" DisplayFormatString="n" Height="19px" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                    <td colspan="1" style="height: 26px">&nbsp;</td>
                    <td colspan="1" style="height: 26px">&nbsp;</td>
                    <td colspan="1" style="height: 26px">&nbsp;</td>
                                                     ...
                                                     <tr>
                                                         ...
                                                         <td colspan="1" style="height: 26px; width: 149px;">      <dx:ASPxLabel ID="lblsettlementcurr" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Settlement Currency" Theme="Glass">
                                                             </dx:ASPxLabel></td>
                                                         <td colspan="1" style="height: 26px">
                                                     ...
                                                     <tr>
                                                         <td colspan="1" style="height: 26px"> <dx:ASPxLabel ID="ASPxLabel421" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Exchange Rate" Theme="Glass">
                                                             </dx:ASPxLabel></td>
                                                         <td colspan="1" style="height: 26px">
                                                         ...
                                                         <td colspan="1" style="height: 26px; width: 149px;"> <dx:ASPxLabel ID="ASPxLabel4112" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Gross Amount" Theme="Glass">
                                                             </dx:ASPxLabel></td>
                                                         <td colspan="1" style="height: 26px">
                                                             <dx:ASPxTextBox ID="txtgross" runat="server" Height="19px" DisplayFormatString="n" ReadOnly="True" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                                                             </dx:ASPxTextBox>
                                                         </td>
                                                         <td colspan="1" style="height: 26px">&nbsp;</td>
                                                         <td colspan="1" style="height: 26px">&nbsp;</td>
