<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="ApproveWithdrawalUT.aspx.vb" Inherits="TransferSec_ApproveWithdrawalUT" title="Approve Withdrawal" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel id="Panel1" runat="server" Width="100%" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width ="100%">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Authorizations&gt;&gt;Fund Redemption Approval" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
        ...
        <asp:Panel ID="Panel3" runat="server" Font-Names="Cambria" Font-Size="Medium" GroupingText="Redemption Approval">
            <table width="100%">
                <tr>
                                ...
                                <dx:GridViewDataColumn Caption="Units">
                                 ...
                                 <dx:GridViewDataColumn Caption="Amount">
                                  ...
                                  <dx:GridViewDataColumn Caption="Bank">
                                   ...
                                   <dx:GridViewDataColumn Caption="Bank Account">
                                    <DataItemTemplate>
