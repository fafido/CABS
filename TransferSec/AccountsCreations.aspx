       ...
       <table>
           <tr id="Panel10g" runat="server">
                ...
                <td style="font-family:Cambria; font-size:small" colspan="2">
                    ...
                    <asp:RadioButton ID="rdCorprate0" runat="server" AutoPostBack="True" GroupName="AccountType" Text="Pension Fund" />
                </td>
            </tr> 
           ...
           <tr id="Panel13a" runat="server">
                      ...
                      <td style="width: 212px">
                          <dx:ASPxComboBox ID="cmbIDType" runat="server" Theme="BlackGlass" Width="250px"  CallbackPageSize="15" EnableCallbackMode="True" DropDownStyle="DropDownList"  IncrementalFilteringMode="Contains"  AnimationType="Slide" AutoPostBack="True">
                          </dx:ASPxComboBox>
                      </td>
                      <td style="width: 208px">
                      ...
                      <td style="width: 212px">
                          <dx:ASPxTextBox ID="txtIDNo" runat="server" ToolTip="Valid format: 03-127576-N-03" BackColor="White" MaxLength="50" Theme="Glass" Width="250px">
                          </dx:ASPxTextBox>
                          <asp:RegularExpressionValidator ID="myIDcontrol" runat="server" ControlToValidate="txtIDNo" ValidationExpression="\d{2}[-]\d{6,7}[-][a-zA-Z][-]\d{2}" ErrorMessage="Please provide a valid id number, Valid format: 03-127576-N-03."
                                            Display="Dynamic" />
                      </td>
                  </tr>
           ...
           <tr id="Panel8f" runat="server" visible="false">
                    ...
                    <td style="width: 208px">
                        <dx:ASPxLabel ID="ASPxLabel34" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Classification" Theme="Glass">
                        </dx:ASPxLabel>
           ...
           <tr id="Panel8kc" runat="server" visible="false">
                    ...
                    <td style="width: 208px">
                         <dx:ASPxLabel ID="ASPxLabel36" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Bill Cash Account" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td style="width: 212px">
                        <table width="100%">
            ...
            <tr id="Panel8kcA" runat="server" visible="false">
                    <td style="width: 208px">
                        <dx:ASPxLabel ID="ASPxLabel37" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Investor Type" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td style="width: 212px">
          ...
          <asp:Panel ID="dfPanel2" runat="server" ScrollBars="Vertical" Visible="false">
           ...
           <tr id="Panel3bbbb" runat="server" visible="false">
               ...
               <td colspan="3">
                   <dx:ASPxGridView ID="grdAsertManagersClients" runat="server" KeyFieldName="ID" Theme="Glass" Width="470px">
                       <Columns>
                           <dx:GridViewDataColumn Visible="True" VisibleIndex="0">
                               <DataItemTemplate>
           ...
           <tr id="panelsaving2" runat="server" visible="false">
                        ...
                        <td style="width:208px" runat="server">
                                              ...
                                              <table  style="width: 100%">
                                                  <tr>
                                                    <td align="center" style="height: 57px">
                                                        <dx:ASPxLabel ID="ASPxLabel149" runat="server" Text="CDC Number already captured, proceed to Submit" Theme="iOS">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
