<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="AccountsUpdaterej.aspx.vb" Inherits="AccountsCreations" title="Rejected Accounts" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel id="Panel1" runat="server" Width="100%" Font-Names="Cambria" BackColor="White" GroupingText="Rejected Accounts">
        <table>
            <tr>
                <td colspan="4">
            ...
            <tr>
                <td style="width:208px">
                    <dx:ASPxLabel ID="lblRejection" runat="server" Text="Rejection Reason">
                    </dx:ASPxLabel>
                </td>
                <td colspan="3">
                    <dx:ASPxMemo ID="txtReasons" ReadOnly="true" BackColor="#E4E4E4" runat="server" Theme="BlackGlass" Width="250px">
                    </dx:ASPxMemo>
                </td>
            </tr>
          ...
          <asp:Panel ID="dfPanel2" runat="server" ScrollBars="Vertical" Visible="false">
           ...
           <tr id="Panel3bbbb_by" runat="server" visible="False">
                    <td style="width:208px">
            ...
            <tr id="Panel3bbbb_by2" runat="server" visible="False">
                <td style="width:208px">&nbsp;</td>
                <td colspan="3">
          ...
          <asp:Panel ID="dfPanel2CORP" runat="server" ScrollBars="Vertical" Visible="false">
                       ...
                       <thead>
                            <tr>
                                ...
                                <th align="left" style="width:100px">
                                 ...
                                 <th align="left" style="width:100px">
                                    <asp:Label ID="Label6" runat="server" Text="AccountName"></asp:Label>
                                </th>
                                  <th align="left" style="width:100px">
           ...
           <tr id="CORP8D" runat="server" visible="false">
            ...
            <tr id="CORP8D1" runat="server" visible="false">
                <td style="width:208px">&nbsp;</td>
                <td colspan="3">
           ...
           <tr id="CORP8D2" runat="server" visible="false">
               <td style="width:208px">
               </td>
               <td colspan="3">
