<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="AccountsUpdate.aspx.vb" Inherits="AccountsCreations" title="Accounts Update" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel id="Panel1" runat="server" Width="100%" Font-Names="Cambria" BackColor="White" GroupingText="Accounts Update">
        <table>
            <tr>
                <td colspan="4">
            ...
            <tr>
                <td style="width: 208px">
                    <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="Client Name/ID No./Account No. Search" Theme="Glass">
                    </dx:ASPxLabel>
                </td>
           ...
           <tr id="Panel13a" runat="server">
                      ...
                      <td style="width: 212px">
                          <dx:ASPxTextBox ID="txtIDNo" ReadOnly="false" runat="server" BackColor="White" MaxLength="50" Theme="Glass" Width="250px">
                          </dx:ASPxTextBox>
                      </td>
                  </tr>
           ...
           <tr id="Panel8b" runat="server" visible="false">
                    ...
                    <td style="width: 212px">
                        <dx:ASPxTextBox ID="txtCNIC" ReadOnly="false" runat="server" BackColor="White" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                </tr>
           ...
           <tr id="Panel8kc" runat="server" visible="false">
                    ...
                    <td style="width: 208px">
                         <dx:ASPxLabel ID="ASPxLabel124" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Bill Cash Account" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td style="width: 212px">
                        <table width="100%">
               ...
               <td colspan="3">
                   <dx:ASPxGridView ID="grdAsertManagersClients" runat="server" KeyFieldName="ID" Theme="Glass" Width="470px">
                       <Columns>
                           ...
                           <dx:GridViewDataColumn VisibleIndex="0">
                               <DataItemTemplate>
                                   <asp:LinkButton ID="SelectID2" runat="server" CommandArgument='<%# Eval("ID") %>' CommandName="Activate" OnClientClick="if ( !confirm('Confirm you want to proceed with action')) return false;" Text="Activate/ DeActivate">
                                        </asp:LinkButton>
                               </DataItemTemplate>
                           </dx:GridViewDataColumn>
                    ...
                    <td style="width: 212px">
                        <table width="100%">
                            <tr>
                                 ...
                                 <td>
                                    <dx:ASPxComboBox ID="cmbBillingCurrencyCORP" runat="server" Theme="BlackGlass" ValueType="System.String" CallbackPageSize="15" EnableCallbackMode="True" DropDownStyle="DropDownList"  IncrementalFilteringMode="Contains"  AnimationType="Slide">
                                    </dx:ASPxComboBox>
                                 </td>
                            </tr>
                        </table>
          ...
          <asp:Panel ID="dfPanel2CORP" runat="server" ScrollBars="Vertical" Visible="false">
           ...
           <tr id="CORP8D" runat="server" visible="false">
                    ...
                    <td style="width:208px">
                        <dx:ASPxLabel ID="ASPxLabel131" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Inter Company A/c" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                        <td style="width:212px">
        ...
        <tr id="Tr1" runat="server" visible="true">
            <td colspan="4">
                <dx:ASPxLabel ID="ASPxLabel150" runat="server" Font-Names="Cambria" Font-Size="Small" Font-Bold="true" Text="Pending Approval" Theme="PlasticBlue">
                </dx:ASPxLabel>
                <hr/>
            </td>
        </tr>
           <tr id="Panel9" runat="server">
                <td colspan="4">
                        <dx:ASPxGridView ID="ASPxGridView3" runat="server" AutoGenerateColumns="False"  KeyFieldName="id" Theme="Glass" Width="100%">
                        <Columns >
                             <dx:GridViewDataColumn Caption="" VisibleIndex="0">
                                    <DataItemTemplate>
                                        <asp:LinkButton ID="otpenabled2" runat="server" CommandArgument='<%# Eval("id") %>' CommandName="EnterOTP"  Text="Enter OTP">
                                                              </asp:LinkButton>
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
                             <dx:GridViewDataColumn Caption="" VisibleIndex="0">
                                    <DataItemTemplate>
                                        <asp:LinkButton ID="otpenabled" runat="server" CommandArgument='<%# Eval("id") %>' CommandName="Re-SendOTP"  Text="Re-Send OTP">
                                       </asp:LinkButton>
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn HeaderStyle-Font-Bold="true" Caption="Account No." CellStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel Text='<%# Eval("cds_number") %>' runat="server"></dx:ASPxLabel>
                                    </DataItemTemplate>
                            </dx:GridViewDataColumn>
                                <dx:GridViewDataColumn HeaderStyle-Font-Bold="true" Caption="Firstname">
                                    <DataItemTemplate>
                            ...
                            <dx:GridViewDataColumn HeaderStyle-Font-Bold="true" Caption="Account Type">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel Text='<%# Eval("myAccType") %>' runat="server"></dx:ASPxLabel>
                                    </DataItemTemplate>
                            </dx:GridViewDataColumn>
                               <dx:GridViewDataColumn HeaderStyle-Font-Bold="true" Caption="ID Number">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel Text='<%# Eval("CNIC") %>' runat="server"></dx:ASPxLabel>
                                    </DataItemTemplate>
                            </dx:GridViewDataColumn>
                             <dx:GridViewDataColumn HeaderStyle-Font-Bold="true" Caption="Email">
                                    <DataItemTemplate>
                                              ...
                                              <table  style="width: 100%">
                                                  <tr>
                                                    <td align="right" style="height: 57px">
                                                        <dx:ASPxLabel ID="ASPxLabel149" runat="server" Text="OTP" Theme="iOS">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <dx:ASPxButton ID="btnreject" Visible="false" runat="server" CausesValidation="False" Text="Reject" Theme="Glass">
