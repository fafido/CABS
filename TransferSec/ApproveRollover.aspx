<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="ApproveRollover.aspx.vb" Inherits="TransferSec_ApproveRollover" title="Approve Rollover" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel id="Panel1" runat="server" Width="100%" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width ="100%">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Authorization&gt;&gt;Money Market Rollover Approval" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
        ...
        <asp:Panel ID="Panel3" runat="server" Font-Names="Cambria" Font-Size="Medium" GroupingText="Money Market Redemption Approval">
            <table width="100%">
                <tr>
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataColumn Caption="Description">
                                 ...
                                 <dx:GridViewDataColumn Caption="Rollover Amount">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel runat="server" Text='<%# String.Format("{0:#,##0.00}", Eval("RolloverAmount")) %>'>
                                        </dx:ASPxLabel>
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtamount" runat="server" Height="19px" DisplayFormatString="n"  ReadOnly="True" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                       <ValidationSettings>
                                <RequiredField IsRequired="True" />
                            </ValidationSettings>
                             </dx:ASPxTextBox>
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtsettlementamount" runat="server" DisplayFormatString="n"  Height="19px" ReadOnly="True" Theme="BlackGlass" Width="250px">
                       <ValidationSettings>
                                <RequiredField IsRequired="True" />
                            </ValidationSettings>
                             </dx:ASPxTextBox>
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtfixedrate" runat="server" DisplayFormatString="n"  ReadOnly="True" Height="19px" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                       <ValidationSettings>
                                <RequiredField IsRequired="True" />
                            </ValidationSettings>
                             </dx:ASPxTextBox>
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txttax" runat="server" Height="19px" DisplayFormatString="n"  ReadOnly="True" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                      <ValidationSettings>
                                <RequiredField IsRequired="True" />
                            </ValidationSettings>
                              </dx:ASPxTextBox>
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtmaturityvalue" runat="server"  ReadOnly="True" Height="19px" DisplayFormatString="n" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                </tr>
                                                                  <tr>
                                                                      <td colspan="4" style="height: 26px; "><hr /></td>
                                                                  </tr>
                                                                  <tr>
                                                                      <td colspan="1" style="height: 26px; width: 231px;">
                                                                          <dx:ASPxLabel ID="ASPxLabel81" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Rollover Amount" Theme="Glass">
                                                                          </dx:ASPxLabel>
                                                                      </td>
                                                                      <td colspan="1" style="height: 26px">
                                                                          <dx:ASPxTextBox ID="txtcallbackamount" runat="server"  DisplayFormatString="n" Height="19px" ReadOnly="True" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                                                                          </dx:ASPxTextBox>
                                                                      </td>
                                                                      <td colspan="1" style="height: 26px">
                                                                          <dx:ASPxLabel ID="ASPxLabel82" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Callback Amount" Theme="Glass">
                                                                          </dx:ASPxLabel>
                                                                      </td>
                                                                      <td colspan="1" style="height: 26px">
                                                                          <dx:ASPxTextBox ID="txtcallbackinterest" runat="server" DisplayFormatString="n" Height="19px" ReadOnly="True" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                                                                          </dx:ASPxTextBox>
                                                                      </td>
                                                                  </tr>
                                                                  <tr>
                                                                      ...
                                                                      <td colspan="1" style="height: 26px">
                                                                          <dx:ASPxDateEdit ID="dtnewtradedate" runat="server" Width="250px" ReadOnly="True">
                                                                              <ValidationSettings>
                                                                                  <RequiredField IsRequired="True" />
                                                                              </ValidationSettings>
                                                                          </dx:ASPxDateEdit>
                                                                      ...
                                                                      <td colspan="1" style="height: 26px">
                                                                          <dx:ASPxTextBox ID="txtnewnumberofdays" runat="server" AutoPostBack="True" ReadOnly="True" Height="19px" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                                                                          </dx:ASPxTextBox>
                                                                      </td>
                                                                  </tr>
                                                                  <tr>
                                                                      ...
                                                                      <td colspan="1" style="height: 26px">
                                                                          <dx:ASPxDateEdit ID="dtnewmaturitydate" runat="server" Width="250px" ReadOnly="True">
                                                                              <ValidationSettings>
                                                                                  <RequiredField IsRequired="True" />
                                                                              </ValidationSettings>
                                                                          </dx:ASPxDateEdit>
                                                                      ...
                                                                      <td colspan="1" style="height: 26px">
                                                                          <dx:ASPxTextBox ID="txtnewinterest" runat="server" AutoPostBack="True" ReadOnly="True" DisplayFormatString="n" Height="19px" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                                                                              <ValidationSettings>
                                                                                  <RequiredField IsRequired="True" />
                                                                              </ValidationSettings>
                                                                          </dx:ASPxTextBox>
                                                                  ...
                                                                  <tr>
                                                                      <td colspan="1" style="height: 26px; width: 231px;">
                                                                          <dx:ASPxLabel ID="ASPxLabel83" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Current Value" Theme="Glass">
                                                                          </dx:ASPxLabel>
                                                                      </td>
                                                                      <td colspan="1" style="height: 26px">
                                                                          <dx:ASPxTextBox ID="txtcurrentamt" runat="server" DisplayFormatString="n" Height="19px" ReadOnly="True" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                                                                          </dx:ASPxTextBox>
                                                                      </td>
                                                                      <td colspan="1" style="height: 26px">
                                                                      ...
                                                                      <td colspan="1" style="height: 26px">
                                                                          <dx:ASPxTextBox ID="txtnewmaturityvalue" runat="server" ReadOnly="True" DisplayFormatString="n" Height="19px" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                                                                          </dx:ASPxTextBox>
                                                                      </td>
                                                                  </tr>
                <tr>
