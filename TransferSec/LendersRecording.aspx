<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="LendersRecording.aspx.vb" Inherits="Enquiries_LendersRecording" title="Lenders Record" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel id="Panel1" runat="server" Width="840px" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width ="810px">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Lending and Borrowing&gt;&gt;Lenders" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
        ...
        <table width="810px">
            <tr>
                    <td colspan ="1">
                        <dx:ASPxLabel ID="ASPxLabel54" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Account Name" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                <td colspan ="1">
         ...
         <asp:panel id="Panel2" runat="server" GroupingText="Units Held" Font-Names="Cambria">
             <table class="dxflInternalEditorTable_Glass">
                 <tr>
                     <td style="width: 83px"  >
                         &nbsp;</td>
                     <td>
                         <dx:ASPxGridView ID="grdportfolio" runat="server" Theme="BlackGlass" Width="367px">
                         </dx:ASPxGridView>
                     </td>
                 </tr>
             </table>
