<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="BatchReceipting_withdrawal.aspx.vb" Inherits="TransferSec_BatchReceipting_withdrawal" title="Batch Withdrawal" %>
        ...
        <table width ="100%">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Trustee Services&gt;&gt;Bond Redemption" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
        ...
        <asp:Panel ID="Panel3" runat="server" Font-Names="Cambria" GroupingText="Batch Details" Visible="False">
            <table width="810px">
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 23px">
                        <dx:ASPxTextBox ID="txtisin" runat="server" BackColor="#E4E4E4" Height="19px" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                    <td colspan="1" style="height: 23px"></td>
                    <td colspan="1" style="height: 23px"></td>
...
<tr>
    ...
    <td colspan ="8" align="center">
        ...
        <dx:ASPxButton ID="ASPxButton5" runat="server" Text="receipt" Theme="BlackGlass" Visible="False">
         ...
         <asp:Panel runat="server" ID="Panel5" Font-Names="Cambria" GroupingText="Bond Redemption" Font-Size="Medium">
                ...
                <table width="100%">
                    <tr>
                       ...
                       <tr>
                            ...
                            <td colspan ="1">
                                <dx:ASPxLabel ID="ASPxLabel37" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Bond Series" Theme="Glass">
                                </dx:ASPxLabel>
                            </td>
                        <td colspan ="1" style="width: 549px">
                    ...
                    <tr>
                        <td colspan="1">
                            <dx:ASPxLabel ID="ASPxLabel38" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Available Amount" Theme="Glass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan="1" style="width: 549px">
                    ...
                    <tr>
                        <td colspan="1">
                            <dx:ASPxLabel ID="ASPxLabel8" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Redemption Amount" Theme="Glass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan="1" style="width: 549px">
                            <dx:ASPxTextBox ID="txtredeemunits" runat="server" BackColor="#E4E4E4" Height="19px" Theme="BlackGlass" Width="250px">
                            </dx:ASPxTextBox>
                        </td>
                        <td colspan="1">
                    ...
                    <tr>
                        ...
                        <td colspan="1" style="width: 549px">
                            <dx:ASPxTextBox ID="txtbank" runat="server" BackColor="#E4E4E4" Height="19px" Theme="BlackGlass" Width="250px">
                            </dx:ASPxTextBox>
                        </td>
                        <td colspan="1">&nbsp;</td>
                        <td colspan="1">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td colspan="1" style="width: 549px">
                            <dx:ASPxTextBox ID="txtbankaccount" runat="server" BackColor="#E4E4E4" Height="19px" Theme="BlackGlass" Width="250px">
                            </dx:ASPxTextBox>
                        </td>
                        <td colspan="1">&nbsp;</td>
                        <td colspan="1">&nbsp;</td>
    ...
    <td colspan ="7" align="left" style="height: 18px">
        <asp:GridView ID="grdTranShareholder" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="id" EmptyDataText="No Relevant Data Found" Font-Size="Small" ForeColor="#333333" GridLines="Vertical" Height="16px" Width="99%">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="cds_number" HeaderText="ClientNo" />
                <asp:BoundField DataField="Quantity" dataformatstring="{0:N}" HeaderText="Redeemed Amount" />
