<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="Cash_Deposits_part.aspx.vb" Inherits="Enquiries_Cash_Deposits_part" title="Cash Deposits Participant" %>
        ...
        <table width ="810px">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Billing&gt;&gt;Cash Deposits" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
...
<tr>
    ...
    <td colspan="1"></td>
                    ...
                    <tr>
    <td colspan="1">
            <dx:ASPxLabel ID="ASPxLabel10" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Counter" Theme="Glass" Visible="False">
            </dx:ASPxLabel>
            </td>
    <td colspan="1">
        <dx:ASPxComboBox ID="cmbCounter" runat="server" Theme="BlackGlass" ValueType="System.String" Width="250px" Visible="False">
        </dx:ASPxComboBox>
                        </td>
    <td colspan="1"></td>
    <td colspan="1"></td>
