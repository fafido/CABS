<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="withdrawalapproval.aspx.vb" Inherits="TransferSec_withdrawalapproval" title="Withdrawal" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel id="Panel1" runat="server" Width="100%" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width ="100%">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Authorization&gt;&gt;Withdrawal  Approval" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
        ...
        <asp:Panel ID="Panel3" runat="server" Font-Names="Cambria" Font-Size="Medium" GroupingText="Pending Withdrawals">
            <table width="100%">
                <tr>
                    <td colspan="7">
                        <dx:ASPxGridView ID="ASPxGridView5" SettingsBehavior-AllowDragDrop="true"  runat="server" KeyFieldName="ReceiptNo" Settings-ShowTitlePanel="true" Theme="Glass" Width="100%">
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataColumn FieldName="Quant" Name="Quantity"  Caption="Quantity"/>
        ...
        CallbackPageSize="30" Width="250px" Theme="Glass">
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxLabel ID="ASPxLabel39" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Withdrawal ID" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1" style="height: 26px">
                ...
                <tr>
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxLabel ID="ASPxLabel42" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Transaction Charge" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txttransactioncharges" runat="server" Height="19px" ReadOnly="True" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                    <td colspan="1" style="height: 26px">
                ...
                <tr>
                    <td colspan="1" style="height: 20px">
                        <dx:ASPxLabel ID="ASPxLabel43" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Other Charges" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
...
&nbsp;
        ...
        <asp:Panel ID="Panel9" runat="server" Enabled="true" Font-Names="Cambria" Font-Size="Medium" GroupingText="All Withdrawals">
            <table width="100%">
                <tr>
                    <td align="center">
                        <dx:ASPxGridView ID="ASPxGridView3" runat="server" KeyFieldName="id" Settings-ShowTitlePanel="true"  Theme="Glass" Width="100%">
                            ...
                            <Columns>
                                 ...
                                 <dx:GridViewDataColumn Caption="Commodity">
                                      ...
                                      <dx:GridViewDataColumn Caption="Withdrawn Quantity"  >
                                                         <DataItemTemplate>
        ...
        <asp:Panel ID="Panel10" runat="server" Enabled="true" Font-Names="Cambria" Font-Size="Medium" GroupingText="Rejected Withdrawals">
            <table width="100%">
                <tr>
                    <td align="center">
