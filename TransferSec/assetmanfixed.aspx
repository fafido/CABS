<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="assetmanfixed.aspx.vb" Inherits="Assetmanfixed" title="Comparing" %>
...
<table style="width:100%">
    ...
    <tr>
        <td>
                 ...
                 <dx:ASPxLabel ID="ASPxLabel1" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Recon&gt;&gt;Asset Manager Fixed Income" Theme="PlasticBlue"></dx:ASPxLabel>
       
             
                 <asp:Panel runat="server" GroupingText="Upload Asset Manager File (Fixed Income)">
<table  style="width:100%">
            <tr>
                <td colspan ="8">
                    <table style="width:100%">
                ...
                <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <dx:ASPxDateEdit ID="dtdateview" runat="server" Height="23px" Width="250px">
                                </dx:ASPxDateEdit>
                            </td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            ...
                            <td>
                                <dx:ASPxComboBox ID="cmbtype" runat="server" EnableTheming="True" Theme="Default" Width="250px">
                                    <Items>
                                       ...
                                       <%-- <dx:ListEditItem Text="Exceptions (Cost of Investment + Accrued Interest)" Value="Exceptions (Cost of Investment + Accrued Interest)" />--%>
                                      <%--  <dx:ListEditItem Text="Not Found" Value="Not Found" />--%>
                                    </Items>
                                </dx:ASPxComboBox>
                            </td>
                            <td>&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                &nbsp;<dx:ASPxButton ID="btnupload1" runat="server" Text="Export" style="height: 25px">
                                </dx:ASPxButton>
                            ...
                            <td colspan="9">
                                <dx:ASPxGridView ID="ASPxGridView2" runat="server"  AutoGenerateColumns="True" KeyFieldName="ID" Settings-ShowTitlePanel="true" SettingsBehavior-ProcessSelectionChangedOnServer="true" SettingsText-Title="" Theme="Glass" Width="100%">
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="C-Trade Cost" Name="C-Trade Cost" PropertiesTextEdit-DisplayFormatString="n" Settings-AutoFilterCondition="Contains">
                                            <Settings AutoFilterCondition="Contains" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="Asset Manager Cost" Name="Asset Manager Cost" PropertiesTextEdit-DisplayFormatString="n" Settings-AutoFilterCondition="Contains">
                                            <Settings AutoFilterCondition="Contains" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="Cost Variance" Name="Cost Variance" PropertiesTextEdit-DisplayFormatString="n" Settings-AutoFilterCondition="Contains">
                                            <Settings AutoFilterCondition="Contains" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="Cost Status" Name="Cost Status" Settings-AutoFilterCondition="Contains">
                                            <Settings AutoFilterCondition="Contains" />
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="AssetManagerValue" Name="AssetManagerValue" PropertiesTextEdit-DisplayFormatString="n" Settings-AutoFilterCondition="Contains">
                                            <Settings AutoFilterCondition="Contains" />
                                        </dx:GridViewDataTextColumn>
                        ...
                        <tr>
                            <td colspan="9">
                                <dx:ASPxGridView ID="ASPxGridView3" runat="server" AutoGenerateColumns="True" KeyFieldName="ID" Settings-ShowTitlePanel="true" SettingsBehavior-ProcessSelectionChangedOnServer="true" SettingsText-Title="" Theme="Glass" Width="100%">
                                    <Settings ShowFilterRow="True" />
                                    <SettingsText Title="Authorized" />
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="Value Status" Name="Value Status" Settings-AutoFilterCondition="Contains">
                                         ...
                                         <dx:GridViewDataTextColumn FieldName="Comments" Name="Comments" Settings-AutoFilterCondition="Contains">
                                            <Settings AutoFilterCondition="Contains" />
                                        </dx:GridViewDataTextColumn>
                                    </Columns>
                                </dx:ASPxGridView>
