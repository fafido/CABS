<%@ Page Title="" Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="AddCertificates.aspx.vb" Inherits="TransferSec_Add_Certificates" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <td colspan ="1">
        <dx:ASPxLabel ID="ASPxLabel7" runat="server" Font-Names="Cambria" Font-Size="Small" Text="CDS Number" Theme="Glass">
        </dx:ASPxLabel>
        </td>
    <td>
        <dx:ASPxTextBox ID="ASPxTextBox2" runat="server" Theme="BlackGlass" Width="287px" BackColor="#E4E4E4" Height="19px" ReadOnly="true">
        </dx:ASPxTextBox>
        </td>
