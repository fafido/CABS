<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="ApproveAllocation.aspx.vb" Inherits="TransferSec_ApproveAllocation" title="Approve Allocation" %>
        ...
        <table width ="100%">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Authorizations&gt;&gt;Bond Allocation Approval" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataColumn Caption="Series">
                                    <DataItemTemplate>
                                     ...
                                     <dx:GridViewDataColumn Caption="Certificate">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel runat="server" Text='<%# Eval("Certificate") %>'>
                                        </dx:ASPxLabel>
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
