<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="foreclosureFIN.aspx.vb" Inherits="TransferSec_foreclosureFIN" title="Foreclosure" %>
    ...
    <asp:Panel id="Panel1" runat="server" Width="100%" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table style="width: 100%">
            <tr>
                ...
                <td colspan ="1">
                    <dx:ASPxTextBox ID="txtSurname" ReadOnly="true" runat="server"  Theme="BlackGlass" Width="250px">
                    </dx:ASPxTextBox>
                </td>
                <td colspan ="1">
                    &nbsp;</td>
            ...
            <tr>
                ...
                <td colspan ="1">
                    <dx:ASPxTextBox ID="txtCreditLimit" ReadOnly="true" runat="server"  Theme="BlackGlass" Width="250px" Visible="False">
                    </dx:ASPxTextBox>
                    </td>
                <td colspan ="1" style="width: 122px" ></td>
                <td colspan ="1"></td>
                <td colspan ="1"></td>
                <td colspan ="1"></td>
                <td colspan ="1"></td>
        ...
        <table style="width:100%">
            <tr>
                ...
                <td colspan ="1">
                    <dx:ASPxComboBox ID="cmbCompany" runat="server" ReadOnly="true" Theme="BlackGlass" ValueType="System.String" Width="250px" AutoPostBack="True">
                    </dx:ASPxComboBox>
                </td>
                <td colspan ="1">
                    ...
                    <table class="dxflInternalEditorTable_Glass">
                        <tr>
                            <td align="left" style="width:115px" >
                                <dx:ASPxLabel ID="ASPxLabel85" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Foreclosure Reason" Theme="Glass">
                                </dx:ASPxLabel>
                            </td>
                            <td align="left">
                                <dx:ASPxTextBox ID="txtforeclosuredetail" ReadOnly="true" runat="server" AutoPostBack="True"  Theme="BlackGlass" Width="550px">
                                </dx:ASPxTextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" style="width:115px">
                                <dx:ASPxLabel ID="ASPxLabel87" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Beneficiary" Theme="Glass">
                                </dx:ASPxLabel>
                            </td>
                            <td align="left">
                                <dx:ASPxTextBox ID="txtaccount" runat="server" AutoPostBack="True" ReadOnly="true" Theme="BlackGlass" Width="550px">
                                </dx:ASPxTextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="left">
                                <dx:ASPxTextBox ID="txtforeclosuretype" ReadOnly="true" runat="server" AutoPostBack="True"  Theme="BlackGlass" Width="550px">
                                </dx:ASPxTextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="center" colspan="2">
                                <dx:ASPxButton ID="ASPxButton9" runat="server" Text="Accept ForeClosure" Theme="BlackGlass">
                                </dx:ASPxButton>
                                &nbsp;<dx:ASPxButton ID="ASPxButton10" runat="server" Text="Decline ForeClosure" Theme="BlackGlass">
                                </dx:ASPxButton>
                                &nbsp; &nbsp;</td>
                        </tr>
                    </table>
