Partial Class Enquiries_CashAllocation
    ...
    Protected Sub ASPxButton3_Click(sender As Object, e As EventArgs) Handles ASPxButton3.Click
        Try
            ...
            If chkCounter.Checked = True Then
                cmd = New SqlCommand("insert into CashTrans ([Description],TransType, Amount, DateCreated, TransStatus , cds_Number, PAID, Reference) VALUES   ('" + txtdesc.Text + "','NEW DEPOSIT','" & txtAmount.Text & "',GETDATE(),'1','" + txtClientNo.Text + "',NULL, '" + cmbCounter.Value.ToString + "')", cn)
            Else
                cmd = New SqlCommand("insert into CashTrans ([Description],TransType, Amount, DateCreated, TransStatus , cds_Number, PAID, Reference) VALUES   ('" + txtdesc.Text + "','NEW DEPOSIT','" & txtAmount.Text & "',GETDATE(),'1','" + txtClientNo.Text + "',NULL, NULL)", cn)
            End If
