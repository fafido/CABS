<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="UT_Allocation.aspx.vb" Inherits="TransferSec_UT_Allocation" title="Fund Allocation" %>
        ...
        <table width ="100%">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Trustee Services&gt;&gt;Unit Trust Fund Allocation" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td colspan="1" style="height: 27px">
                            <dx:ASPxLabel ID="ASPxLabel8" runat="server" Font-Names="Cambria" Font-Size="Small" Text="New Allocation Units" Theme="Glass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan="1" style="width: 193px; height: 27px;">
                            <dx:ASPxTextBox ID="txtredeemunits"  DisplayFormatString="n" runat="server"   Height="19px" Theme="BlackGlass" Width="250px" ReadOnly="True">
                            </dx:ASPxTextBox>
                        </td>
                        <td colspan="1" style="height: 27px">
