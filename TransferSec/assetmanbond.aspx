<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="assetmanbond.aspx.vb" Inherits="Assetmanbond" title="Comparing" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <dx:ASPxComboBox ID="cmbtype" runat="server" EnableTheming="True" Theme="Default" Width="250px">
                                    <Items>
                                        <dx:ListEditItem Text="Exceptions" Value="Exceptions" />
                            ...
                            <td colspan="9">
                                <dx:ASPxGridView ID="ASPxGridView2_auth" runat="server" AutoGenerateColumns="True" KeyFieldName="ID" Settings-ShowTitlePanel="true" SettingsBehavior-ProcessSelectionChangedOnServer="true" SettingsText-Title="" Theme="Glass" Width="100%">
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="C-Trade Value" Name="C-Trade Value" Settings-AutoFilterCondition="Contains">
                                            <Settings AutoFilterCondition="Contains" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="Asset Manager Value" Name="Asset Manager Value" Settings-AutoFilterCondition="Contains">
                                            <Settings AutoFilterCondition="Contains" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="Value Variance" Name="Value Variance" Settings-AutoFilterCondition="Contains">
                                            <Settings AutoFilterCondition="Contains" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="Value Status" Name="Value Status" Settings-AutoFilterCondition="Contains">
                                            <Settings AutoFilterCondition="Contains" />
