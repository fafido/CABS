<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="ApproveMergeWR.aspx.vb" Inherits="TransferSec_ApproveMergeWR" title="Approve Merge EWR" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel id="Panel1" runat="server" Width="840px" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width="810px">
                    ...
                    <asp:GridView ID="grdAvailableWRs" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="id" EmptyDataText="No Relevant Data Found" ForeColor="#333333" GridLines="None" Height="16px" Width="99%">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Quantity" HeaderText="Quantity" />
                             <asp:BoundField DataField="NewParentWRNo" HeaderText="Reference" />
            ...
            <tr>
                <td colspan="5">
                    <asp:TextBox ID="txtRemarks" runat="server" Width="926px"></asp:TextBox>
                </td>
            </tr>
        ...
        <asp:Panel ID="Panel9" runat="server" Enabled="True" Font-Names="Cambria" Font-Size="Medium" GroupingText="Finish">
            <table width="810px">
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <dx:ASPxButton ID="ASPxButton13" runat="server" style="height: 23px" Text="Reject" Theme="RedWine">
                        </dx:ASPxButton>
                    </td>
                    <td colspan="1">&nbsp;</td>
                    <td colspan="1">&nbsp;</td>
