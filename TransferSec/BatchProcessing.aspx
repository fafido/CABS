<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="BatchProcessing.aspx.vb" Inherits="TransferSec_BatchProcessing" title="Batch Processing" %>
    ...
    <asp:Panel id="Panel1" runat="server" Width="840px" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width ="810px">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Batching&gt;&gt;Batch Processing" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
        ...
        <table width="810px">
            <tr>
             ...
             <tr>
                <td colspan ="1" align="right">
                    <dx:ASPxLabel ID="ASPxLabel3" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Saved Batches" Theme="Glass">
                    </dx:ASPxLabel>
                </td>
                <td colspan ="1" width="301">
                    <dx:ASPxComboBox ID="cmbSavedBatches" runat="server" Theme="BlackGlass" ValueType="System.String" Width="300px">
                    </dx:ASPxComboBox>
                </td>
                <td colspan ="1">
         ...
         <asp:Panel runat="server" ID="Panel5" Font-Names="Cambria" GroupingText="Primary Batch Details" Font-Size="Medium">
                ...
                <table width="810px">
                    ...
                    <tr>
                        ...
                        <td colspan ="1">
                            <dx:ASPxTextBox ID="txtCertNo" runat="server" BackColor="#E4E4E4" ReadOnly="True" Theme="BlackGlass" Width="250px">
                            </dx:ASPxTextBox>
                            </td>
                        <td colspan ="1">
...
<tr>
    ...
    <td colspan ="8" align="center">
        ...
        <asp:Panel runat="server" ID="Panel6" Font-Names="Cambria" GroupingText="Secondary Batch Details" Font-Size="Medium">
                ...
                <table width="810px">
                    ...
                    <tr>
                            <td colspan ="1">
                                <dx:ASPxLabel ID="ASPxLabel32" runat="server" Font-Names="Cambria" Font-Size="Small" Text="CDS No." Theme="Glass">
                                </dx:ASPxLabel>
                            </td>
                        <td colspan ="1">
                            <dx:ASPxTextBox ID="txtCdsNoSearch" runat="server" BackColor="#E4E4E4" ReadOnly="True" Theme="BlackGlass" Width="250px">
                            </dx:ASPxTextBox>
                            </td>
                        <td colspan ="1">
                    ...
                    <tr>
                            <td colspan ="1">
                                <dx:ASPxLabel ID="ASPxLabel33" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Surname" Theme="Glass">
                                </dx:ASPxLabel>
                            </td>
                        <td colspan ="1">
                            <dx:ASPxTextBox ID="txtSurnameSearch" runat="server" BackColor="#E4E4E4" ReadOnly="True" Theme="BlackGlass" Width="250px">
                            </dx:ASPxTextBox>
                            </td>
                        <td colspan ="1">
                    ...
                    <tr>
                       ...
                       <tr>
                            <td colspan ="1">
                                <dx:ASPxLabel ID="ASPxLabel23" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Shares" Theme="Glass">
                                </dx:ASPxLabel>
                            </td>
                        <td colspan ="1">
                            <dx:ASPxTextBox ID="txtSurnameSearch0" runat="server" BackColor="#E4E4E4" ReadOnly="True" Theme="BlackGlass" Width="250px">
                            </dx:ASPxTextBox>
                            </td>
                           <td colspan ="1">
                    ...
                    <tr>
                            <td colspan ="1">
                                &nbsp;</td>
                        <td colspan ="7">
                            <dx:ASPxGridView ID="grdBatchedRecords0" runat="server" Theme="Office2003Olive" Width="600px">
                            </dx:ASPxGridView>
                            </td>
