<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="AccountsCreations_corpB.aspx.vb" Inherits="TransferSec_AccountsCreations_corpB" title="New Broker/Corporate Account" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel id="Panel1" runat="server" Width="840px" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width ="810px">
          ...
          <asp:panel id="Panel10" runat="server" GroupingText="Account Type" Font-Names="Cambria" Visible="False">
        <table width="810px">
            <tr>
        ...
        <asp:Panel ID="Panel13" runat="server" Font-Names="Cambria" GroupingText="Identification Verification">
              <table width="810px">
                  ...
                  <tr>
                      ...
                      <td colspan="1">
                          <dx:ASPxComboBox ID="cmbIDType" runat="server" Theme="BlackGlass" Width="200px">
                              <Items>
                      ...
                      <td colspan="1">
                          <dx:ASPxLabel ID="ASPxLabel30" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Number" Theme="Glass">
                          </dx:ASPxLabel>
                      </td>
                      <td colspan="1">
                  ...
                  <tr>
                      <td colspan="1" style="width: 97px">
                          &nbsp;</td>
                      <td colspan="1">
                          <dx:ASPxComboBox ID="cmbIDType0" runat="server" Theme="BlackGlass" ValueType="System.String" Width="200px" Visible="False">
                          </dx:ASPxComboBox>
                      </td>
                      <td colspan="1">
                          &nbsp;</td>
        ...
        <asp:Panel ID="Panel8" runat="server" Font-Names="Cambria" Visible="False">
            <table width="810px">
                <tr>
                    <td colspan="1" style="width: 123px">
                        <dx:ASPxLabel ID="ASPxLabel25" runat="server" Font-Names="Cambria" Font-Size="Small" Text="CDS No" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td>
                ...
                <tr>
                    <td colspan="1" style="width: 123px">
                        <dx:ASPxLabel ID="ASPxLabel29" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Title" Theme="Glass" Visible="False">
                        </dx:ASPxLabel>
                    </td>
                    <td>
                        <dx:ASPxComboBox ID="cmbTitle" runat="server" Theme="BlackGlass" Visible="False" Width="250px" CallbackPageSize="15" EnableCallbackMode="True" DropDownStyle="DropDownList"  IncrementalFilteringMode="Contains"  AnimationType="Slide">
                            <Items>
                ...
                <tr>
                    ...
                    <td>
                        &nbsp;</td>
                    <td colspan="1">
                        <dx:ASPxLabel ID="ASPxLabel33" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Gender" Theme="Glass" Visible="False">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1">
                        <asp:RadioButton ID="rdMale" runat="server" AutoPostBack="True" GroupName="Gender" Text="Male" Visible="False" />
                        <asp:RadioButton ID="rdFemale" runat="server" AutoPostBack="True" GroupName="Gender" Text="Female" Visible="False" />
                        <asp:RadioButton ID="rdNa" runat="server" AutoPostBack="True" GroupName="Gender" Text="N/A" Visible="False" />
                    </td>
                    <td colspan="1"></td>
                    <td colspan="1"></td>
                    <td colspan="1"></td>
        ...
        <table width="810px">
           ...
           <tr>
            ...
            <tr>
                ...
                <tr>
                    <td colspan ="1" style="height: 23px; width: 114px;">
                ...
                <td colspan ="1" style="height: 23px">
                    ...
                    <dx:ASPxComboBox ID="cmbCountry" runat="server" Theme="BlackGlass" ValueType="System.String" Width="250px" PopupVerticalAlign="TopSides" CallbackPageSize="15" EnableCallbackMode="True" DropDownStyle="DropDownList"  IncrementalFilteringMode="Contains"  AnimationType="Slide">
                    </dx:ASPxComboBox>
                    ...
                    <td colspan ="1" style="height: 23px">
                        ...
                        <dx:ASPxComboBox ID="cmbCity" runat="server" Theme="BlackGlass" ValueType="System.String" Width="250px" Visible="False">
                        </dx:ASPxComboBox>
        ...
        <table width="810px">
            <tr>
                    <td colspan ="8" align="center">
                        <asp:RadioButton ID="rdControlled" runat="server" AutoPostBack="True" GroupName="Controlling" Text="Controlled" Checked="True" Enabled="False" />
        ...
        <table width="810px">
         <tr>
            ...
            <tr>
                ...
                <td colspan ="1">
                    <dx:ASPxComboBox ID="cmbIndustry" runat="server" Theme="BlackGlass" ValueType="System.String" Width="250px" AutoPostBack="True" CallbackPageSize="15" EnableCallbackMode="True" DropDownStyle="DropDownList"  IncrementalFilteringMode="Contains"  AnimationType="Slide">
                    </dx:ASPxComboBox>
                </td>
                <td colspan ="1">
        ...
        <table width="810px">
           <tr>
               <td>
                   ...
                   <asp:Panel ID="panelSave" runat="server" Font-Names="Cambria" GroupingText="Attachments" Visible="False">
                       <table>
                           <tr>
                               <td colspan="8">
                           ...
                           <tr>
                               <td align="center" colspan="8" style="height: 24px">
                                   <dx:ASPxGridView ID="ASPxGridView1" runat="server" Theme="RedWine" Width="470px">
                                   </dx:ASPxGridView>
                               </td>
                           </tr>
                           <tr>
            ...
            <table>
                ...
                <tr>
                        <td colspan ="8" align ="center">
                            ...
                            &nbsp;<dx:ASPxButton ID="ASPxButton9" runat="server" Text="Add Company Representatives" Theme="BlackGlass" Visible="False" Height="21px" Width="187px">
                            </dx:ASPxButton>
                        </td>
        ...
        <asp:Panel ID="panelsaving0" runat="server" GroupingText="Company Representatives" Visible="False">
            <table>
                <tr>
                    <td align="center" colspan="8" style="height: 17px; width: 812px;">
                        <asp:Panel ID="Panel14" runat="server" Font-Names="Cambria" GroupingText="Details">
                            <table width="810px">
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td align="left" colspan="2">
                                        <dx:ASPxComboBox ID="cmbJnationality0" runat="server" Theme="BlackGlass" ValueType="System.String" Width="250px" CallbackPageSize="15" EnableCallbackMode="True" DropDownStyle="DropDownList"  IncrementalFilteringMode="Contains"  AnimationType="Slide">
                                        </dx:ASPxComboBox>
                                    </td>
                                    <td colspan="1"></td>
                                    <td colspan="1">&nbsp;</td>
