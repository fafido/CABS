Partial Class Enquiries_purchases
    ...
    Protected Sub ASPxButton3_Click(sender As Object, e As EventArgs) Handles ASPxButton3.Click
        ...
        cmd = New SqlCommand("insert into trans_instruments (instrument, issuer, period, principal, face_value, maturity_date, purpose, units, client_no, date_added, update_status, price) values ('" + cmbinstrument.SelectedItem.Text + "', '" + cmbissuer.SelectedItem.Text + "','" + txtperiod.Text + "', '" + txtprincipal.Text + "','" + txtfacevalue.Text + "','" + txtmaturity.Text + "','" + txtpurpose.Text + "','" + txtunits.Text + "','" + txtClientNo.Text + "',getdate(),0,'" + txtprice.Text + "')", cn)
