<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="Transferapproval.aspx.vb" Inherits="TransferSec_Transferapproval" title="Transfer Approval" %>
    ...
    <asp:Panel id="Panel1" runat="server" Width="100%" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width ="100%">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Authorization&gt;&gt;Transfer  Approval" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
                    ...
                    <td colspan="7">
                        <dx:ASPxGridView ID="ASPxGridView5" runat="server" KeyFieldName="ReceiptNo" Settings-ShowTitlePanel="true" Theme="Glass" Width="100%">
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataColumn FieldName="Quant" Name="Quantity" />
        ...
        CallbackPageSize="30" Width="250px" Theme="Glass">
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 25px">
                        <dx:ASPxLabel ID="ASPxLabel39" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Transfer ID" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1" style="height: 25px">
                ...
                <tr>
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxLabel ID="ASPxLabel42" runat="server" Font-Names="Cambria" Font-Size="Small" Text="EWR Transaction Charge" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtcharge" runat="server" Height="19px" ReadOnly="True" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxLabel ID="ASPxLabel45" runat="server" Font-Names="Cambria" Font-Size="Small" Text="EWR Accumulated Charges" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1" style="height: 26px">
                    ...
                    <td colspan="2">
                        <table class="dxflInternalEditorTable">
                            <tr>
                                ...
                                <td>
                                    <dx:ASPxCheckBox ID="ASPxCheckBox1" runat="server" Text="Waive Charge" Theme="Glass">
                                    </dx:ASPxCheckBox>
                                </td>
                            </tr>
                        </table>
