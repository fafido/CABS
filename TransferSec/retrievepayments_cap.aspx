<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="retrievepayments_cap.aspx.vb" Inherits="TransferSec_retrievepayments_cap" title="Capital Redemption" %>
    ...
    <asp:Panel id="Panel1" runat="server" Width="840px" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <asp:Panel runat="server" ID="PanelType" Font-Names="Cambria" GroupingText="Confirm Delivery">
            ...
            <table style="width: 828px">
                ...
                <tr>
                    <td align="center">
                        <asp:Button ID="Button1" runat="server" BackColor="#023E5A" ForeColor="White" Height="28px" Text="Extract Payments For Capital Redemption" Width="299px" />
                    </td>
                </tr>
                <tr>
                    <td align="center">
