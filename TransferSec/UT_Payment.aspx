<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="UT_Payment.aspx.vb" Inherits="TransferSec_UT_Payment" title="Fund Payment" %>
        ...
        <table width ="100%">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Trustee Services&gt;&gt;Unit Trust Fund Income Payment" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>

                   </td>
            </tr>
        </table>

          <asp:panel id="Panel2" runat="server" GroupingText="Fund Allocation" Font-Names="Cambria" Visible="False">
        <table width="100%">
            <tr>
...
<tr>
    ...
    <td colspan ="8" align="center">
        ...
        <dx:ASPxButton ID="ASPxButton5" runat="server" Text="receipt" Theme="BlackGlass" Visible="False">
         ...
         <asp:Panel runat="server" ID="Panel5" Font-Names="Cambria" GroupingText="Fund Allocation" Font-Size="Medium">
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td colspan="1">
                            <dx:ASPxLabel ID="ASPxLabel43" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Payment Detail" Theme="Glass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan="1" style="width: 193px">
                            <dx:ASPxComboBox ID="cmbpaymentdetails" runat="server" AutoPostBack="True" Theme="Glass" ValueType="System.String" Width="250px">
                            </dx:ASPxComboBox>
                        </td>
                        <td colspan="1">&nbsp;</td>
                        <td colspan="1">&nbsp;</td>
                    ...
                    <tr>
                        <td colspan="1">
                            <dx:ASPxLabel ID="ASPxLabel38" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Available Units" Theme="Glass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan="1" style="width: 193px">
                    ...
                    <tr>
                        <td colspan="1" style="height: 27px">
                            <dx:ASPxLabel ID="ASPxLabel41" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Bank Account" Theme="Glass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan="1" style="width: 193px; height: 27px;">
                            <dx:ASPxTextBox ID="txtbankAccount" runat="server"  Height="19px" ReadOnly="True" Theme="BlackGlass" Width="250px">
                            </dx:ASPxTextBox>
                        </td>
                        <td colspan="1" style="height: 27px">
                    ...
                    <tr>
                        <td colspan="1" style="height: 27px">
                            <dx:ASPxLabel ID="ASPxLabel42" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Bank" Theme="Glass">
                            </dx:ASPxLabel>
                        </td>
                        <td colspan="1" style="width: 193px; height: 27px;">
                            <dx:ASPxTextBox ID="txtbank" runat="server" DisplayFormatString="n" Height="19px" ReadOnly="True" Theme="BlackGlass" Width="250px">
                            </dx:ASPxTextBox>
                        </td>
                        <td colspan="1" style="height: 27px">&nbsp;</td>
                        <td colspan="1" style="height: 27px">&nbsp;</td>
                    ...
                    <tr>
                        <td colspan="1">&nbsp;</td>
                        <td colspan="2">
                            <dx:ASPxButton ID="ASPxButton12" runat="server" Text="Pay Client" Theme="BlackGlass">
                            </dx:ASPxButton>
                            &nbsp;
                            ...
                            <td colspan ="7">
                                <asp:GridView ID="grdTranShareholder" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="id" EmptyDataText="No Relevant Data Found" ForeColor="#333333" GridLines="Vertical" Height="16px" Width="99%" Font-Size="Small">
                                    ...
                                    <Columns>
                                         ...
                                         <asp:BoundField DataField="Quantity" dataformatstring="{0:N}"  HeaderText="Units" />  
