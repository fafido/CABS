    ...
    <asp:Panel id="Panel1" runat="server" Width="100%" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width ="100%">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Transaction Batching&gt;&gt;Withdrawal" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
        ...
        CallbackPageSize="1000" Width="250px" Theme="Glass">
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxLabel ID="ASPxLabel39" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Total Remaining Charges" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1" style="height: 26px">
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxLabel ID="ASPxLabel61" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Total Account Charges" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="1" style="height: 26px">
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtdocumentname" runat="server" Height="19px" ReadOnly="True" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px" Text="Withdrawal Document">
                        </dx:ASPxTextBox>
                    </td>
                    <td colspan="1" style="height: 26px">
                ...
                <tr>
                    <td align="center" colspan="7">
                        <dx:ASPxButton ID="ASPxButton13" runat="server" Text="Withdraw" Theme="BlackGlass" style="height: 23px">
                        </dx:ASPxButton>
                    </td>
                </tr>
            </table>
