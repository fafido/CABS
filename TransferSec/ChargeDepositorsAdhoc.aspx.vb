Partial Class ChargeDepositorsAdhoc
    ...
    Protected Sub ASPxButton2_Click(sender As Object, e As EventArgs) Handles ASPxButton2.Click
        Try
            ...
            cmd = New SqlCommand("select cds_number+' '+surname+' '+forenames as namess from Accounts_Clients where cds_number+' '+surname+' '+forenames like '%" & txtClientNameSearch.Text & "%'", cn)
    ...
    Protected Sub ASPxButton3_Click(sender As Object, e As EventArgs) Handles ASPxButton3.Click
        ...
        If Not IsNumeric(txtAmount.Text) Then
            ...
            Exit Sub
        End If
        Dim AccountType As String = "DEPOSITOR"
