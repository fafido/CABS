    ...
    <asp:Panel id="Panel1" runat="server" Width="100%" Font-Names="Cambria" BackColor="White" GroupingText="Pending Verification Accounts">
       <table>
           ...
           <tr id="Panel8f" runat="server" visible="false">
                    <td style="width: 208px">
                        <dx:ASPxLabel ID="ASPxLabel53" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Billing Profile" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td style="width: 212px">
                        <dx:ASPxTextBox ID="cmbBillingProfile" runat="server" BackColor="#E4E4E4" ReadOnly="True" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                    <td style="width: 208px">
                         <dx:ASPxLabel ID="ASPxLabel68" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Bill Cash Account" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td style="width: 212px">
                        <table width="100%">
                            <tr>
                                 <td>
                                    <asp:CheckBox ID="chkBillCashAccount" runat="server" Enabled="false" AutoPostBack ="false"/>
                                 </td>
                                 <td>
                                 ...
                                 <td>
                                     <dx:ASPxTextBox ID="cmbBillingCurrency" runat="server" BackColor="#E4E4E4" ReadOnly="True" Theme="BlackGlass" Width="155px">
                                        </dx:ASPxTextBox>
                                 </td>
                            </tr>
                        </table>
           ...
           <tr id="Panel8kc" runat="server" visible="false">
                    ...
                    <td style="width: 208px">
                        <dx:ASPxLabel ID="ASPxLabel65" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Classification" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td style="width: 212px">
                        <dx:ASPxTextBox ID="cmbClassification" runat="server" BackColor="#E4E4E4" ReadOnly="True" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
           </tr>
            <tr id="Panel8kcA" runat="server" visible="false">
                    <td style="width: 208px">
                        <dx:ASPxLabel ID="ASPxLabel60" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Investor Type" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td style="width: 212px">
                        <dx:ASPxTextBox ID="cmbInvestorType" runat="server" BackColor="#E4E4E4" ReadOnly="True" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
            </tr>
           <tr id="Panel8kb" runat="server" visible="false">
                <td colspan="4">
                    <dx:ASPxLabel ID="ASPxLabel57" runat="server" Font-Names="Cambria" Font-Size="Small" Font-Bold="true" Text="Fund" Theme="Glass">
                    </dx:ASPxLabel>
                   <hr/>
                </td>
            </tr>
           <tr id="Panel8kbb" runat="server" visible="false">
              <td style="width: 208px">
                    <dx:ASPxLabel ID="ASPxLabel58" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Selected Fund" Theme="Glass">
                    </dx:ASPxLabel>
                </td>
                <td style="width: 212px">
                    <dx:ASPxTextBox ID="txtUnitTrustFund" runat="server" BackColor="#E4E4E4" ReadOnly="True" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                </td>
           </tr>
                    ...
                    <td style="width:208px"></td>
                        ...
                        <Columns >
                            ...
                            <dx:GridViewDataColumn HeaderStyle-Font-Bold="true" Caption="AccountName">
                               ...
                               <dx:GridViewDataColumn Caption="Current Status" HeaderStyle-Font-Bold="true">
                               <DataItemTemplate>
                                   <dx:ASPxLabel runat="server" Text='<%# Eval("Status1") %>'>
                                   </dx:ASPxLabel>
                               </DataItemTemplate>
                           </dx:GridViewDataColumn>
                               <dx:GridViewDataColumn Caption="Deletion" HeaderStyle-Font-Bold="true">
                               <DataItemTemplate>
                                   <dx:ASPxLabel runat="server" Text='<%# Eval("MarkedForDeletion1") %>'>
                                   </dx:ASPxLabel>
                               </DataItemTemplate>
                           </dx:GridViewDataColumn>
                               <dx:GridViewDataColumn Caption="Activation" HeaderStyle-Font-Bold="true">
                               <DataItemTemplate>
                                   <dx:ASPxLabel runat="server" Text='<%# Eval("UpdateStatus1") %>'>
                                   </dx:ASPxLabel>
                               </DataItemTemplate>
                           </dx:GridViewDataColumn>
           ...
           <tr id="Panel3aa" runat="server" visible="false">
               <td style="width:208px">
                   <dx:ASPxLabel ID="ASPxLabel46" runat="server" Font-Names="Cambria" Font-Size="Small" Text="CDC Number" Theme="Glass">
                   </dx:ASPxLabel>
               </td>
               <td style="width:212px">
           ...
           <tr id="Panel4e" runat="server" visible="false">
                <td style="width:208px">
                    <dx:ASPxLabel ID="ASPxLabel47" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Bank Type" Theme="Glass">
                    </dx:ASPxLabel>
                </td>
                <td style="width:212px">
                    <dx:ASPxTextBox ID="cmbBankCat" runat="server" BackColor="#E4E4E4" ReadOnly="True" Theme="BlackGlass" Width="250px">
                    </dx:ASPxTextBox>
                </td>
                <td style="width:208px">
           ...
           <tr id="PanelCORP2ac" runat="server" visible="false">
                    <td style="width: 208px">
                        <dx:ASPxLabel ID="ASPxLabel55" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Billing Profile" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td style="width: 212px">
                        <dx:ASPxTextBox ID="cmbBillingProfileCORP" runat="server" BackColor="#E4E4E4" ReadOnly="True" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                    <td style="width: 208px">
                         <dx:ASPxLabel ID="ASPxLabel69" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Bill Cash Account" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td style="width: 212px">
                        <table width="100%">
                            <tr>
                                 <td>
                                    <asp:CheckBox ID="chkBillCashAccountCORP" runat="server" Enabled="false" AutoPostBack ="false"/>
                                 </td>
                                 <td>
                                     <dx:ASPxLabel ID="ASPxLabel70" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Currency" Theme="Glass">
                                    </dx:ASPxLabel>
                                 </td>
                                 <td>
                                     <dx:ASPxTextBox ID="cmbBillingCurrencyCORP" runat="server" BackColor="#E4E4E4" ReadOnly="True" Theme="BlackGlass" Width="168px">
                                        </dx:ASPxTextBox>
                                 </td>
                            </tr>
                        </table>
           ...
           <tr id="PanelCORP2a" runat="server" visible="false">
                    <td style="width: 208px">
                        <dx:ASPxLabel ID="ASPxLabel66" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Classification" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td style="width: 212px">
                        <dx:ASPxTextBox ID="cmbClassificationCORP" runat="server" BackColor="#E4E4E4" ReadOnly="True" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
           </tr>
           ...
           <tr id="PanelCORP7a" runat="server" visible="false">
                <td colspan="4">
                    <dx:ASPxLabel ID="ASPxLabel61" runat="server" Font-Names="Cambria" Font-Size="Small" Font-Bold="true" Text="Fund" Theme="Glass">
                    </dx:ASPxLabel>
                   <hr/>
                </td>
            </tr>
           <tr id="PanelCORP7ab" runat="server" visible="false">
              <td style="width: 208px">
                    <dx:ASPxLabel ID="ASPxLabel63" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Selected Fund" Theme="Glass">
                    </dx:ASPxLabel>
                </td>
                <td style="width: 212px">
                    <dx:ASPxTextBox ID="txtUnitTrustFundCORP" runat="server" BackColor="#E4E4E4" ReadOnly="True" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                </td>
           </tr>
           <tr id="PanelCORP7b" runat="server" visible="false">
                <td colspan="4">
                    <dx:ASPxLabel ID="ASPxLabel45" runat="server" Font-Names="Cambria" Font-Size="Small" Font-Bold="true" Text="Asset Manager/s" Theme="Glass">
                    </dx:ASPxLabel>
                   <hr/>
                </td>
            </tr>
           <tr id="PanelCORP7c" runat="server" visible="false">
                    <td style="width:208px"></td>
                        <td colspan="3">
                        ...
                        <Columns >
                            ...
                            <dx:GridViewDataColumn HeaderStyle-Font-Bold="true" Caption="Account">
                               ...
                               <dx:GridViewDataColumn Caption="Deletion Status" HeaderStyle-Font-Bold="true">
                               <DataItemTemplate>
                                   <dx:ASPxLabel runat="server" Text='<%# Eval("MarkedForDeletion1") %>'>
                                   </dx:ASPxLabel>
                               </DataItemTemplate>
           ...
           <tr id="PanelCORP7d" runat="server" visible="false">
               <td style="width:208px">
           ...
           <tr id="PanelCORP11a" runat="server" visible="false">
                <td style="width:208px">
                    <dx:ASPxLabel ID="ASPxLabel48" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Bank Type" Theme="Glass">
                    </dx:ASPxLabel>
                </td>
                <td style="width:212px">
                    <dx:ASPxTextBox ID="cmbBankCatCORP" runat="server" BackColor="#E4E4E4" ReadOnly="True" Theme="BlackGlass" Width="250px">
                    </dx:ASPxTextBox>
                </td>
            </tr>
                  ...
                  <SettingsPager Mode="ShowAllRecords"  ></SettingsPager>
                       <Columns>
                           ...
                           <dx:GridViewDataColumn HeaderStyle-Font-Bold="true" Caption="Status">
                               <DataItemTemplate>
                                   <dx:ASPxLabel Text='<%# Eval("MarkedForDeletion1") %>' runat="server"></dx:ASPxLabel>
                               </DataItemTemplate>
                           </dx:GridViewDataColumn>
                       </Columns>
                   </dx:ASPxGridView>
