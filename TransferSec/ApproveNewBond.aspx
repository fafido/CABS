                ...
                <tr>
                    <td>
                        <table class="dxflInternalEditorTable_Glass">
                            <tr>
                                <td colspan="5">
                                    <dx:ASPxGridView ID="ASPxGridView2" runat="server" AutoGenerateColumns="true" Caption="Pending Bonds" KeyFieldName="ID" Theme="Glass" Width="100%">
                                        ...
                                        <Columns>
                                            ...
                                            <dx:GridViewDataTextColumn FieldName="FaceValue" Name="FaceValue" PropertiesTextEdit-DisplayFormatString="n" Settings-AutoFilterCondition="Equals">
                                            </dx:GridViewDataTextColumn>
                            ...
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td style="width: 152px">
                                    <dx:ASPxLabel ID="ASPxLabel71" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Bank" Theme="Glass">
                                    </dx:ASPxLabel>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td valign="Top" style="width: 152px">
                                    <dx:ASPxLabel ID="ASPxLabel72" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Origination" Theme="Glass">
                                    </dx:ASPxLabel>
                                </td>
                                <td valign="Top">
                                    <dx:ASPxTextBox ID="txttype" runat="server" Height="23px" Theme="Glass" Width="250px">
                                        <ValidationSettings>
                                            <RequiredField IsRequired="True" />
                                        </ValidationSettings>
                                    </dx:ASPxTextBox>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    &nbsp;<dx:ASPxButton ID="btnSaveTB2" runat="server" Text="Reject Bond" Theme="BlackGlass" Width="180px">
                                    </dx:ASPxButton>
            ...
            <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td align="left" style="height: 31px">
                            <dx:ASPxComboBox ID="cmboption" runat="server" Height="23px" Width="250px">
                                <Items>
