                 ...
                 <tr>
                     <td align="left">
                         ...
                         <dx:ASPxGridView ID="grddocuments" runat="server" KeyFieldName="ID" Settings-ShowTitlePanel="true" Theme="Glass" Width="100%">
                            ...
                            <SettingsPager PageSizeItemSettings-ShowAllItem="true" PageSize="100" Visible="True">
                            </SettingsPager>
                            <Settings ShowFilterRow="True" />
                             ...
                             <Columns>
                                 ...
                                 <dx:GridViewDataTextColumn FieldName="Account No" Name="Account No" Settings-AutoFilterCondition="Contains">
                                  ...
                                  <dx:GridViewDataTextColumn FieldName="CtradeValue" Name="CtradeValue" PropertiesTextEdit-DisplayFormatString="n" Settings-AutoFilterCondition="Contains">
                                        </dx:GridViewDataTextColumn>
                                           <dx:GridViewDataTextColumn FieldName="AssetManagerValue" Name="AssetManagerValue" PropertiesTextEdit-DisplayFormatString="n" Settings-AutoFilterCondition="Contains">
                                              ...
                                              <dx:GridViewDataTextColumn FieldName="ValueVariance" Name="ValueVariance" PropertiesTextEdit-DisplayFormatString="n" Settings-AutoFilterCondition="Contains">
                                        </dx:GridViewDataTextColumn>
                                 ...
                                 <dx:GridViewDataTextColumn FieldName="ReconDate" Name="ReconDate" Settings-AutoFilterCondition="Contains">
                                        </dx:GridViewDataTextColumn>
