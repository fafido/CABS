...
Partial Class TransferSec_UTPrice
    ...
    Public Sub getpending()
        ...
        cmd = New SqlCommand("select Funding_Code as [Series], Funding_Name as [Fund Name], Issuer,Format([Value],'#,0.00') as [Fund Value], format(TotalUnits,'#,0.00') as [Units],format([Value]/TotalUnits,'#,0.00') as CurrentPrice from UT_Price", cn)
