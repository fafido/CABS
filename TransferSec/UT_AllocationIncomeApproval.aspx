<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="UT_AllocationIncomeApproval.aspx.vb" Inherits="TransferSec_UT_AllocationIncomeApproval" title="Fund Income Allocation Approval" %>
        ...
        <table width ="100%">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Trustee Services&gt;&gt;Unit Trust Fund Income Allocation Approval" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            &nbsp;
                            <dx:ASPxButton ID="ASPxButton15" runat="server" Text="Reject" Theme="BlackGlass" Visible="False">
                            </dx:ASPxButton>
