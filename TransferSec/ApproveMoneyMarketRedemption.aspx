<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="ApproveMoneyMarketRedemption.aspx.vb" Inherits="TransferSec_ApproveMoneyMarketRedemption" title="Approve Money Market Redemption" %>
        ...
        <table width ="100%">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Authorization&gt;&gt;Money Market Redemption Approval" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
        ...
        <asp:Panel ID="Panel3" runat="server" Font-Names="Cambria" Font-Size="Medium" GroupingText="Money Market Redemption Approval">
            <table width="100%">
                        ...
                        <dx:ASPxGridView ID="grddocuments" Width="100%" runat="server" KeyFieldName="id" Settings-ShowTitlePanel="true" Theme="Glass">
                            ...
                            <%--    <dx:GridViewDataColumn Caption="" VisibleIndex="0">
                                ...
                                <dx:GridViewDataColumn Caption="Description">
                                 ...
                                 <dx:GridViewDataColumn Caption="Redemption Amount">
                                    <DataItemTemplate>
                                        <dx:ASPxLabel runat="server" Text='<%# String.Format("{0:#,##0.00}", Eval("CallbackAmount")) %>'>
                                        </dx:ASPxLabel>
                                    </DataItemTemplate>
                                </dx:GridViewDataColumn>
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtbnk" runat="server" Height="19px" ReadOnly="True" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                        </dx:ASPxTextBox>
                    </td>
                    <td colspan="1" style="height: 26px">
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 26px">
                        <dx:ASPxTextBox ID="txtmaturityvalue" runat="server"  ReadOnly="True" Height="19px" DisplayFormatString="n" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                                                                  ...
                                                                  <tr>
                                                                      <td colspan="1" style="height: 26px; width: 231px;">
                                                                          <dx:ASPxLabel ID="ASPxLabel81" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Redeemed Amount" Theme="Glass">
                                                                          </dx:ASPxLabel>
                                                                      </td>
                                                                      <td colspan="1" style="height: 26px">
                                                                      ...
                                                                      <td colspan="1" style="height: 26px">
                                                                          <dx:ASPxLabel ID="ASPxLabel82" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Redeemed Interest" Theme="Glass">
                                                                          </dx:ASPxLabel>
                                                                      </td>
                                                                      <td colspan="1" style="height: 26px">
                                                                  ...
                                                                  <tr>
                                                                      ...
                                                                      <td colspan="1" style="height: 26px">
                                                                          <dx:ASPxLabel ID="ASPxLabel84" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Redemption Date" Theme="Glass">
                                                                          </dx:ASPxLabel>
                                                                      </td>
                                                                      <td colspan="1" style="height: 26px">
                                                                          <dx:ASPxTextBox ID="txtredemptiondate" runat="server" Height="19px" ReadOnly="True" style="margin-bottom: 0px" Theme="BlackGlass" Width="250px">
                                                                          </dx:ASPxTextBox>
                                                                      </td>
                                                                  </tr>
                <tr>
