...
<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="Enq_Vault.aspx.vb" Inherits="TransferSec_Enq_Vault" title="Vault Enquiry" %>
                ...
                <tr><td> 
                    <table class="dxflInternalEditorTable_Glass">
                        ...
                        <tr>
                            ...
                            <td>
                                <dx:ASPxDateEdit ID="dtfrom" runat="server" DisplayFormatString="dd-MM-yyyy"  Width="250px">
                                    <ValidationSettings>
