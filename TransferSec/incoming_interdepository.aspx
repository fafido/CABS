<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="incoming_interdepository.aspx.vb" Inherits="TransferSec_incoming_interdepository" title="Interdepositories" %>
        ...
        <table width ="810px">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Interdepository&gt;&gt;Incoming Interdepository" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
             ...
             <table width="810px">
                 <tr>
                     <td colspan="1" style="width: 161px">
                         <dx:ASPxLabel ID="ASPxLabel10" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Depository" Theme="Glass">
                         </dx:ASPxLabel>
                     </td>
                     <td colspan="6">
                         <dx:ASPxComboBox ID="ASPxComboBox1" runat="server" Height="21px" ValueType="System.String" Width="251px">
                         </dx:ASPxComboBox>
                     </td>
                 </tr>
                 <tr>
                 ...
                 <tr>
                     ...
                     <td colspan="2">
                         <asp:ListBox ID="ListBox1" runat="server" Width="438px" AutoPostBack="True"></asp:ListBox>
                     </td>
                     <td colspan="1">&nbsp;</td>
                     <td colspan="1">&nbsp;</td>
                     <td colspan="1">&nbsp;</td>
           ...
           <tr>
            ...
            <tr>
                    <td colspan ="1" style="width: 163px">
                        &nbsp;</td>
                <td colspan ="2">
                    <asp:ListBox ID="ListBox2" runat="server" Width="438px" AutoPostBack="True"></asp:ListBox>
                    </td>
