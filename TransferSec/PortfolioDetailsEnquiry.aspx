<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="PortfolioDetailsEnquiry.aspx.vb" Inherits="Enquiries_PortfolioDetailsEnquiry" title="Portfolio Details Enquiry" %>
...
<tr>
    ...
    <td align="center">
        ...
        <dx:ASPxComboBox ID="cmbCompanySelect" runat="server" Height="22px" ValueType="System.String" Width="250px">
        </dx:ASPxComboBox>
        <br />
