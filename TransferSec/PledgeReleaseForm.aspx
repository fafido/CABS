<%@ Page Language="VB" MasterPageFile="~/CDSUser.master" AutoEventWireup="false" CodeFile="PledgeReleaseForm.aspx.vb" Inherits="Enquiries_PledgeReleaseForm" title="Pledge Release Form" %>
...
<asp:Content id="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel id="Panel1" runat="server" Width="840px" Font-Names="Arial" Font-Size="Medium" BackColor="White">
        ...
        <table width ="810px">
            <tr>
                   <td style ="text-align :left;" align="left">
                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Pledges&gt;&gt;Pledge Release" Font-Names="Cambria" Font-Size="Small" Theme="PlasticBlue"></dx:ASPxLabel>
        ...
        <asp:Panel ID="Panel12" runat="server" Font-Names="Cambria" GroupingText="Pledge Options" Visible="False">
            <table width="810px">
                <tr>
        ...
        <table style="width: 828px">
            <tr>
                    <td colspan="8" align="center" style="height: 26px">
         ...
         <asp:Panel runat="server" ID="PanelRelease" Font-Names="Cambria" GroupingText="Release Details">
             <table>
                 <tr>
                     ...
                     <td></td>
                        ...
                        <tr>
                            <td colspan ="1" style="width: 106px">
                                <dx:ASPxLabel ID="ASPxLabel65" runat="server" Font-Names="Cambria" Font-Size="Small" Text="Reason" Theme="Glass">
                                </dx:ASPxLabel>
                            </td>
                            <td>
                   ...
                   <tr>
                    ...
                    <td colspan ="2" align="center">
                        <br />
                        <dx:ASPxButton ID="ASPxButton10" runat="server" Text="save" Theme="BlackGlass">
                        </dx:ASPxButton>
                        </td>
